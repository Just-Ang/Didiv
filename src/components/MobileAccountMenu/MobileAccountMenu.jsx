...
export const MobileAccountMenu = () => {
  ...
  return (
    <Wrapper>
      ...
      {open && (
        <Menu>
          <MenuButton to="/account/profile" onClick={() => setOpen(false)}>
            Особисті дані
          </MenuButton>

          <MenuButton to="/account/orders" onClick={() => setOpen(false)}>
            Замовлення
          </MenuButton>

          <MenuButton to="/account/password" onClick={() => setOpen(false)}>
            Змінити пароль
          </MenuButton>
