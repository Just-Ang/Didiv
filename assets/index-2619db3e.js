...
`,Hw=_.span`
  ...
  white-space: nowrap;
`,Gw=Mw({name:"favorites",initialState:{items:[]},reducers:{toggleFavorite:(e,t)=>{const n=t.payload;e.items.find(i=>i.id===n.id)?e.items=e.items.filter(i=>i.id!==n.id):e.items.push(n)},clearFavorite:e=>{e.items=[]}}}),{toggleFavorite:ui,clearFavorite:T3}=Gw.actions,O3=Gw.reducer,qw=()=>{const e=In(),[t,n]=x.useState([]),r=Xe(l=>l.favorites.items),i=Xe(l=>l.cart.items);x.useEffect(()=>{const l=new Date,s=new Date;s.setDate(l.getDate()-7);const u=s.toISOString();fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[createdAt][$gte]=${u}`).then(d=>d.json()).then(d=>n(d.data)).catch(d=>console.error("Помилка завантаження нових товарів:",d))},[]);const o=(l,s)=>{s.stopPropagation();const u=r.some(d=>d.id===l.id);e(ui(l)),u?Y.warning(`${l.name} видалено з обраного`):Y.info(`${l.name} додано в обране`)},a=[...t].sort(()=>Math.random()-.5).slice(0,3);return!t||t.length===0?null:f.jsxs(Mj,{children:[f.jsx($r,{}),f.jsx($j,{children:"Нові товари"}),f.jsxs(Ij,{children:[a.map(l=>{var w;const s=r.some(h=>h.id===l.id),u=i.find(h=>h.id===l.id),c=(u?u.quantity:0)>=(l.stock||0),y=l.new_price&&l.new_price<l.price,p=y?l.new_price:l.price,m=y?Math.round((l.price-l.new_price)/l.price*100):0,g=(h,v)=>{if(v.stopPropagation(),c){Y.error("Товар уже у кошику");return}e(vo({...h,quantity:1})),Y.success(`${h.name} додано в кошик!`)};return f.jsxs(Dj,{children:[f.jsxs(Lj,{to:`/product/${l.id}`,children:[f.jsx(Rj,{children:"Новинка"}),f.jsx("img",{src:((w=l.images)==null?void 0:w[0].url)||oo,alt:l.name,onError:h=>{h.currentTarget.onerror=null,h.currentTarget.src=oo}}),f.jsx("div",{className:"overlay"})]}),f.jsxs(Aj,{children:[f.jsx(Fj,{children:l.name}),f.jsxs(zj,{children:[f.jsx(Bw,{children:f.jsxs(Vw,{children:[f.jsxs(Uw,{$discount:y,children:[p.toLocaleString()," грн"]}),y&&f.jsxs(Ww,{children:[l.price.toLocaleString()," грн"]}),y&&f.jsxs(Hw,{children:["-",m,"%"]})]})}),f.jsxs(Nw,{children:[f.jsx(eu,{onClick:h=>g(l,h),children:f.jsx(go,{size:24,color:u?"var(--orange-color)":"black",strokeWidth:2})}),f.jsx(eu,{onClick:h=>o(l,h),children:f.jsx(Ya,{size:24,fill:s?"#ff4d4f":"none",color:s?"#ff4d4f":"#000000",strokeWidth:s?1:2})})]})]})]})]},l.id)}),f.jsx(Nj,{to:"/catalog/new",children:f.jsxs(Bj,{children:[f.jsx("p",{children:"Усі новинки"}),f.jsx(Vj,{children:f.jsx(Bu,{size:24})})]})})]})]})};function J(){return J=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},J.apply(this,arguments)}function j3(e){if(e.sheet)return e.sheet;for(var t=0;t<document.styleSheets.length;t++)if(document.styleSheets[t].ownerNode===e)return document.styleSheets[t]}function M3(e){var t=document.createElement("style");return t.setAttribute("data-emotion",e.key),e.nonce!==void 0&&t.setAttribute("nonce",e.nonce),t.appendChild(document.createTextNode("")),t.setAttribute("data-s",""),t}var $3=function(){function e(n){var r=this;this._insertTag=function(i){var o;r.tags.length===0?r.insertionPoint?o=r.insertionPoint.nextSibling:r.prepend?o=r.container.firstChild:o=r.before:o=r.tags[r.tags.length-1].nextSibling,r.container.insertBefore(i,o),r.tags.push(i)},this.isSpeedy=n.speedy===void 0?!0:n.speedy,this.tags=[],this.ctr=0,this.nonce=n.nonce,this.key=n.key,this.container=n.container,this.prepend=n.prepend,this.insertionPoint=n.insertionPoint,this.before=null}var t=e.prototype;return t.hydrate=function(r){r.forEach(this._insertTag)},t.insert=function(r){this.ctr%(this.isSpeedy?65e3:1)===0&&this._insertTag(M3(this));var i=this.tags[this.tags.length-1];if(this.isSpeedy){var o=j3(i);try{o.insertRule(r,o.cssRules.length)}catch{}}else i.appendChild(document.createTextNode(r));this.ctr++},t.flush=function(){this.tags.forEach(function(r){return r.parentNode&&r.parentNode.removeChild(r)}),this.tags=[],this.ctr=0},e}(),at="-ms-",tu="-moz-",ce="-webkit-",Yw="comm",xm="rule",bm="decl",I3="@import",Xw="@keyframes",D3="@layer",L3=Math.abs,Zu=String.fromCharCode,R3=Object.assign;function A3(e,t){return et(e,0)^45?(((t<<2^et(e,0))<<2^et(e,1))<<2^et(e,2))<<2^et(e,3):0}function Kw(e){return e.trim()}function F3(e,t){return(e=t.exec(e))?e[0]:e}function de(e,t,n){return e.replace(t,n)}function Ip(e,t){return e.indexOf(t)}function et(e,t){return e.charCodeAt(t)|0}function Ra(e,t,n){return e.slice(t,n)}function Sn(e){return e.length}function wm(e){return e.length}function ks(e,t){return t.push(e),e}function z3(e,t){return e.map(t).join("")}var Ju=1,ao=1,Qw=0,Ot=0,Le=0,yo="";function ec(e,t,n,r,i,o,a){return{value:e,root:t,parent:n,type:r,props:i,children:o,line:Ju,column:ao,length:a,return:""}}function Lo(e,t){return R3(ec("",null,null,"",null,null,0),e,{length:-e.length},t)}function N3(){return Le}function B3(){return Le=Ot>0?et(yo,--Ot):0,ao--,Le===10&&(ao=1,Ju--),Le}function Ft(){return Le=Ot<Qw?et(yo,Ot++):0,ao++,Le===10&&(ao=1,Ju++),Le}function Tn(){return et(yo,Ot)}function ol(){return Ot}function Za(e,t){return Ra(yo,e,t)}function Aa(e){switch(e){case 0:case 9:case 10:case 13:case 32:return 5;case 33:case 43:case 44:case 47:case 62:case 64:case 126:case 59:case 123:case 125:return 4;case 58:return 3;case 34:case 39:case 40:case 91:return 2;case 41:case 93:return 1}return 0}function Zw(e){return Ju=ao=1,Qw=Sn(yo=e),Ot=0,[]}function Jw(e){return yo="",e}function al(e){return Kw(Za(Ot-1,Dp(e===91?e+2:e===40?e+1:e)))}function V3(e){for(;(Le=Tn())&&Le<33;)Ft();return Aa(e)>2||Aa(Le)>3?"":" "}function U3(e,t){for(;--t&&Ft()&&!(Le<48||Le>102||Le>57&&Le<65||Le>70&&Le<97););return Za(e,ol()+(t<6&&Tn()==32&&Ft()==32))}function Dp(e){for(;Ft();)switch(Le){case e:return Ot;case 34:case 39:e!==34&&e!==39&&Dp(Le);break;case 40:e===41&&Dp(e);break;case 92:Ft();break}return Ot}function W3(e,t){for(;Ft()&&e+Le!==47+10;)if(e+Le===42+42&&Tn()===47)break;return"/*"+Za(t,Ot-1)+"*"+Zu(e===47?e:Ft())}function H3(e){for(;!Aa(Tn());)Ft();return Za(e,Ot)}function G3(e){return Jw(sl("",null,null,null,[""],e=Zw(e),0,[0],e))}function sl(e,t,n,r,i,o,a,l,s){for(var u=0,d=0,c=a,y=0,p=0,m=0,g=1,w=1,h=1,v=0,b="",S=i,E=o,T=r,k=b;w;)switch(m=v,v=Ft()){case 40:if(m!=108&&et(k,c-1)==58){Ip(k+=de(al(v),"&","&\f"),"&\f")!=-1&&(h=-1);break}case 34:case 39:case 91:k+=al(v);break;case 9:case 10:case 13:case 32:k+=V3(m);break;case 92:k+=U3(ol()-1,7);continue;case 47:switch(Tn()){case 42:case 47:ks(q3(W3(Ft(),ol()),t,n),s);break;default:k+="/"}break;case 123*g:l[u++]=Sn(k)*h;case 125*g:case 59:case 0:switch(v){case 0:case 125:w=0;case 59+d:h==-1&&(k=de(k,/\f/g,"")),p>0&&Sn(k)-c&&ks(p>32?uv(k+";",r,n,c-1):uv(de(k," ","")+";",r,n,c-2),s);break;case 59:k+=";";default:if(ks(T=lv(k,t,n,u,d,i,l,b,S=[],E=[],c),o),v===123)if(d===0)sl(k,t,T,T,S,o,c,l,E);else switch(y===99&&et(k,3)===110?100:y){case 100:case 108:case 109:case 115:sl(e,T,T,r&&ks(lv(e,T,T,0,0,i,l,b,i,S=[],c),E),i,E,c,l,r?S:E);break;default:sl(k,T,T,T,[""],E,0,l,E)}}u=d=p=0,g=h=1,b=k="",c=a;break;case 58:c=1+Sn(k),p=m;default:if(g<1){if(v==123)--g;else if(v==125&&g++==0&&B3()==125)continue}switch(k+=Zu(v),v*g){case 38:h=d>0?1:(k+="\f",-1);break;case 44:l[u++]=(Sn(k)-1)*h,h=1;break;case 64:Tn()===45&&(k+=al(Ft())),y=Tn(),d=c=Sn(b=k+=H3(ol())),v++;break;case 45:m===45&&Sn(k)==2&&(g=0)}}return o}function lv(e,t,n,r,i,o,a,l,s,u,d){for(var c=i-1,y=i===0?o:[""],p=wm(y),m=0,g=0,w=0;m<r;++m)for(var h=0,v=Ra(e,c+1,c=L3(g=a[m])),b=e;h<p;++h)(b=Kw(g>0?y[h]+" "+v:de(v,/&\f/g,y[h])))&&(s[w++]=b);return ec(e,t,n,i===0?xm:l,s,u,d)}function q3(e,t,n){return ec(e,t,n,Yw,Zu(N3()),Ra(e,2,-2),0)}function uv(e,t,n,r){return ec(e,t,n,bm,Ra(e,0,r),Ra(e,r+1,-1),r)}function Ui(e,t){for(var n="",r=wm(e),i=0;i<r;i++)n+=t(e[i],i,e,t)||"";return n}function Y3(e,t,n,r){switch(e.type){case D3:if(e.children.length)break;case I3:case bm:return e.return=e.return||e.value;case Yw:return"";case Xw:return e.return=e.value+"{"+Ui(e.children,r)+"}";case xm:e.value=e.props.join(",")}return Sn(n=Ui(e.children,r))?e.return=e.value+"{"+n+"}":""}function X3(e){var t=wm(e);return function(n,r,i,o){for(var a="",l=0;l<t;l++)a+=e[l](n,r,i,o)||"";return a}}function K3(e){return function(t){t.root||(t=t.return)&&e(t)}}function Q3(e){var t=Object.create(null);return function(n){return t[n]===void 0&&(t[n]=e(n)),t[n]}}var Z3=function(t,n,r){for(var i=0,o=0;i=o,o=Tn(),i===38&&o===12&&(n[r]=1),!Aa(o);)Ft();return Za(t,Ot)},J3=function(t,n){var r=-1,i=44;do switch(Aa(i)){case 0:i===38&&Tn()===12&&(n[r]=1),t[r]+=Z3(Ot-1,n,r);break;case 2:t[r]+=al(i);break;case 4:if(i===44){t[++r]=Tn()===58?"&\f":"",n[r]=t[r].length;break}default:t[r]+=Zu(i)}while(i=Ft());return t},e5=function(t,n){return Jw(J3(Zw(t),n))},cv=new WeakMap,t5=function(t){if(!(t.type!=="rule"||!t.parent||t.length<1)){for(var n=t.value,r=t.parent,i=t.column===r.column&&t.line===r.line;r.type!=="rule";)if(r=r.parent,!r)return;if(!(t.props.length===1&&n.charCodeAt(0)!==58&&!cv.get(r))&&!i){cv.set(t,!0);for(var o=[],a=e5(n,o),l=r.props,s=0,u=0;s<a.length;s++)for(var d=0;d<l.length;d++,u++)t.props[u]=o[s]?a[s].replace(/&\f/g,l[d]):l[d]+" "+a[s]}}},n5=function(t){if(t.type==="decl"){var n=t.value;n.charCodeAt(0)===108&&n.charCodeAt(2)===98&&(t.return="",t.value="")}};function eS(e,t){switch(A3(e,t)){case 5103:return ce+"print-"+e+e;case 5737:case 4201:case 3177:case 3433:case 1641:case 4457:case 2921:case 5572:case 6356:case 5844:case 3191:case 6645:case 3005:case 6391:case 5879:case 5623:case 6135:case 4599:case 4855:case 4215:case 6389:case 5109:case 5365:case 5621:case 3829:return ce+e+e;case 5349:case 4246:case 4810:case 6968:case 2756:return ce+e+tu+e+at+e+e;case 6828:case 4268:return ce+e+at+e+e;case 6165:return ce+e+at+"flex-"+e+e;case 5187:return ce+e+de(e,/(\w+).+(:[^]+)/,ce+"box-$1$2"+at+"flex-$1$2")+e;case 5443:return ce+e+at+"flex-item-"+de(e,/flex-|-self/,"")+e;case 4675:return ce+e+at+"flex-line-pack"+de(e,/align-content|flex-|-self/,"")+e;case 5548:return ce+e+at+de(e,"shrink","negative")+e;case 5292:return ce+e+at+de(e,"basis","preferred-size")+e;case 6060:return ce+"box-"+de(e,"-grow","")+ce+e+at+de(e,"grow","positive")+e;case 4554:return ce+de(e,/([^-])(transform)/g,"$1"+ce+"$2")+e;case 6187:return de(de(de(e,/(zoom-|grab)/,ce+"$1"),/(image-set)/,ce+"$1"),e,"")+e;case 5495:case 3959:return de(e,/(image-set\([^]*)/,ce+"$1$`$1");case 4968:return de(de(e,/(.+:)(flex-)?(.*)/,ce+"box-pack:$3"+at+"flex-pack:$3"),/s.+-b[^;]+/,"justify")+ce+e+e;case 4095:case 3583:case 4068:case 2532:return de(e,/(.+)-inline(.+)/,ce+"$1$2")+e;case 8116:case 7059:case 5753:case 5535:case 5445:case 5701:case 4933:case 4677:case 5533:case 5789:case 5021:case 4765:if(Sn(e)-1-t>6)switch(et(e,t+1)){case 109:if(et(e,t+4)!==45)break;case 102:return de(e,/(.+:)(.+)-([^]+)/,"$1"+ce+"$2-$3$1"+tu+(et(e,t+3)==108?"$3":"$2-$3"))+e;case 115:return~Ip(e,"stretch")?eS(de(e,"stretch","fill-available"),t)+e:e}break;case 4949:if(et(e,t+1)!==115)break;case 6444:switch(et(e,Sn(e)-3-(~Ip(e,"!important")&&10))){case 107:return de(e,":",":"+ce)+e;case 101:return de(e,/(.+:)([^;!]+)(;|!.+)?/,"$1"+ce+(et(e,14)===45?"inline-":"")+"box$3$1"+ce+"$2$3$1"+at+"$2box$3")+e}break;case 5936:switch(et(e,t+11)){case 114:return ce+e+at+de(e,/[svh]\w+-[tblr]{2}/,"tb")+e;case 108:return ce+e+at+de(e,/[svh]\w+-[tblr]{2}/,"tb-rl")+e;case 45:return ce+e+at+de(e,/[svh]\w+-[tblr]{2}/,"lr")+e}return ce+e+at+e+e}return e}var r5=function(t,n,r,i){if(t.length>-1&&!t.return)switch(t.type){case bm:t.return=eS(t.value,t.length);break;case Xw:return Ui([Lo(t,{value:de(t.value,"@","@"+ce)})],i);case xm:if(t.length)return z3(t.props,function(o){switch(F3(o,/(::plac\w+|:read-\w+)/)){case":read-only":case":read-write":return Ui([Lo(t,{props:[de(o,/:(read-\w+)/,":"+tu+"$1")]})],i);case"::placeholder":return Ui([Lo(t,{props:[de(o,/:(plac\w+)/,":"+ce+"input-$1")]}),Lo(t,{props:[de(o,/:(plac\w+)/,":"+tu+"$1")]}),Lo(t,{props:[de(o,/:(plac\w+)/,at+"input-$1")]})],i)}return""})}},i5=[r5],o5=function(t){var n=t.key;if(n==="css"){var r=document.querySelectorAll("style[data-emotion]:not([data-s])");Array.prototype.forEach.call(r,function(g){var w=g.getAttribute("data-emotion");w.indexOf(" ")!==-1&&(document.head.appendChild(g),g.setAttribute("data-s",""))})}var i=t.stylisPlugins||i5,o={},a,l=[];a=t.container||document.head,Array.prototype.forEach.call(document.querySelectorAll('style[data-emotion^="'+n+' "]'),function(g){for(var w=g.getAttribute("data-emotion").split(" "),h=1;h<w.length;h++)o[w[h]]=!0;l.push(g)});var s,u=[t5,n5];{var d,c=[Y3,K3(function(g){d.insert(g)})],y=X3(u.concat(i,c)),p=function(w){return Ui(G3(w),y)};s=function(w,h,v,b){d=v,p(w?w+"{"+h.styles+"}":h.styles),b&&(m.inserted[h.name]=!0)}}var m={key:n,sheet:new $3({key:n,container:a,nonce:t.nonce,speedy:t.speedy,prepend:t.prepend,insertionPoint:t.insertionPoint}),nonce:t.nonce,inserted:o,registered:{},insert:s};return m.sheet.hydrate(l),m},tS={exports:{}},ge={};/** @license React v16.13.1
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Om=uM,xo=60103,gS=60106;le.Fragment=60107;le.StrictMode=60108;le.Profiler=60114;var vS=60109,yS=60110,xS=60112;le.Suspense=60113;var bS=60115,wS=60116;if(typeof Symbol=="function"&&Symbol.for){var tn=Symbol.for;xo=tn("react.element"),gS=tn("react.portal"),le.Fragment=tn("react.fragment"),le.StrictMode=tn("react.strict_mode"),le.Profiler=tn("react.profiler"),vS=tn("react.provider"),yS=tn("react.context"),xS=tn("react.forward_ref"),le.Suspense=tn("react.suspense"),bS=tn("react.memo"),wS=tn("react.lazy")}var vv=typeof Symbol=="function"&&Symbol.iterator;function cM(e){return e===null||typeof e!="object"?null:(e=vv&&e[vv]||e["@@iterator"],typeof e=="function"?e:null)}function ts(e){for(var t="https://reactjs.org/docs/error-decoder.html?invariant="+e,n=1;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var SS={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},_S={};function bo(e,t,n){this.props=e,this.context=t,this.refs=_S,this.updater=n||SS}bo.prototype.isReactComponent={};bo.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error(ts(85));this.updater.enqueueSetState(this,e,t,"setState")};bo.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function CS(){}CS.prototype=bo.prototype;function jm(e,t,n){this.props=e,this.context=t,this.refs=_S,this.updater=n||SS}var Mm=jm.prototype=new CS;Mm.constructor=jm;Om(Mm,bo.prototype);Mm.isPureReactComponent=!0;var $m={current:null},ES=Object.prototype.hasOwnProperty,kS={key:!0,ref:!0,__self:!0,__source:!0};function PS(e,t,n){var r,i={},o=null,a=null;if(t!=null)for(r in t.ref!==void 0&&(a=t.ref),t.key!==void 0&&(o=""+t.key),t)ES.call(t,r)&&!kS.hasOwnProperty(r)&&(i[r]=t[r]);var l=arguments.length-2;if(l===1)i.children=n;else if(1<l){for(var s=Array(l),u=0;u<l;u++)s[u]=arguments[u+2];i.children=s}if(e&&e.defaultProps)for(r in l=e.defaultProps,l)i[r]===void 0&&(i[r]=l[r]);return{$$typeof:xo,type:e,key:o,ref:a,props:i,_owner:$m.current}}function dM(e,t){return{$$typeof:xo,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function Im(e){return typeof e=="object"&&e!==null&&e.$$typeof===xo}function fM(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var yv=/\/+/g;function jd(e,t){return typeof e=="object"&&e!==null&&e.key!=null?fM(""+e.key):t.toString(36)}function ll(e,t,n,r,i){var o=typeof e;(o==="undefined"||o==="boolean")&&(e=null);var a=!1;if(e===null)a=!0;else switch(o){case"string":case"number":a=!0;break;case"object":switch(e.$$typeof){case xo:case gS:a=!0}}if(a)return a=e,i=i(a),e=r===""?"."+jd(a,0):r,Array.isArray(i)?(n="",e!=null&&(n=e.replace(yv,"$&/")+"/"),ll(i,t,n,"",function(u){return u})):i!=null&&(Im(i)&&(i=dM(i,n+(!i.key||a&&a.key===i.key?"":(""+i.key).replace(yv,"$&/")+"/")+e)),t.push(i)),1;if(a=0,r=r===""?".":r+":",Array.isArray(e))for(var l=0;l<e.length;l++){o=e[l];var s=r+jd(o,l);a+=ll(o,t,n,s,i)}else if(s=cM(e),typeof s=="function")for(e=s.call(e),l=0;!(o=e.next()).done;)o=o.value,s=r+jd(o,l++),a+=ll(o,t,n,s,i);else if(o==="object")throw t=""+e,Error(ts(31,t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t));return a}function Ps(e,t,n){if(e==null)return e;var r=[],i=0;return ll(e,r,"","",function(o){return t.call(n,o,i++)}),r}function pM(e){if(e._status===-1){var t=e._result;t=t(),e._status=0,e._result=t,t.then(function(n){e._status===0&&(n=n.default,e._status=1,e._result=n)},function(n){e._status===0&&(e._status=2,e._result=n)})}if(e._status===1)return e._result;throw e._result}var TS={current:null};function tr(){var e=TS.current;if(e===null)throw Error(ts(321));return e}var hM={ReactCurrentDispatcher:TS,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:$m,IsSomeRendererActing:{current:!1},assign:Om};le.Children={map:Ps,forEach:function(e,t,n){Ps(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return Ps(e,function(){t++}),t},toArray:function(e){return Ps(e,function(t){return t})||[]},only:function(e){if(!Im(e))throw Error(ts(143));return e}};le.Component=bo;le.PureComponent=jm;le.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=hM;le.cloneElement=function(e,t,n){if(e==null)throw Error(ts(267,e));var r=Om({},e.props),i=e.key,o=e.ref,a=e._owner;if(t!=null){if(t.ref!==void 0&&(o=t.ref,a=$m.current),t.key!==void 0&&(i=""+t.key),e.type&&e.type.defaultProps)var l=e.type.defaultProps;for(s in t)ES.call(t,s)&&!kS.hasOwnProperty(s)&&(r[s]=t[s]===void 0&&l!==void 0?l[s]:t[s])}var s=arguments.length-2;if(s===1)r.children=n;else if(1<s){l=Array(s);for(var u=0;u<s;u++)l[u]=arguments[u+2];r.children=l}return{$$typeof:xo,type:e.type,key:i,ref:o,props:r,_owner:a}};le.createContext=function(e,t){return t===void 0&&(t=null),e={$$typeof:yS,_calculateChangedBits:t,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null},e.Provider={$$typeof:vS,_context:e},e.Consumer=e};le.createElement=PS;le.createFactory=function(e){var t=PS.bind(null,e);return t.type=e,t};le.createRef=function(){return{current:null}};le.forwardRef=function(e){return{$$typeof:xS,render:e}};le.isValidElement=Im;le.lazy=function(e){return{$$typeof:wS,_payload:{_status:-1,_result:e},_init:pM}};le.memo=function(e,t){return{$$typeof:bS,type:e,compare:t===void 0?null:t}};le.useCallback=function(e,t){return tr().useCallback(e,t)};le.useContext=function(e,t){return tr().useContext(e,t)};le.useDebugValue=function(){};le.useEffect=function(e,t){return tr().useEffect(e,t)};le.useImperativeHandle=function(e,t,n){return tr().useImperativeHandle(e,t,n)};le.useLayoutEffect=function(e,t){return tr().useLayoutEffect(e,t)};le.useMemo=function(e,t){return tr().useMemo(e,t)};le.useReducer=function(e,t,n){return tr().useReducer(e,t,n)};le.useRef=function(e){return tr().useRef(e)};le.useState=function(e){return tr().useState(e)};le.version="17.0.2";mS.exports=le;var mM=mS.exports;/** @license React v17.0.2
 * react-jsx-runtime.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gM=mM,OS=60103;es.Fragment=60107;if(typeof Symbol=="function"&&Symbol.for){var xv=Symbol.for;OS=xv("react.element"),es.Fragment=xv("react.fragment")}var vM=gM.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,yM=Object.prototype.hasOwnProperty,xM={key:!0,ref:!0,__self:!0,__source:!0};function jS(e,t,n){var r,i={},o=null,a=null;n!==void 0&&(o=""+n),t.key!==void 0&&(o=""+t.key),t.ref!==void 0&&(a=t.ref);for(r in t)yM.call(t,r)&&!xM.hasOwnProperty(r)&&(i[r]=t[r]);if(e&&e.defaultProps)for(r in t=e.defaultProps,t)i[r]===void 0&&(i[r]=t[r]);return{$$typeof:OS,type:e,key:o,ref:a,props:i,_owner:vM.current}}es.jsx=jS;es.jsxs=jS;hS.exports=es;var Mt=hS.exports,MS={exports:{}};/*!
	Copyright (c) 2018 Jed Watson.
	Licensed under the MIT License (MIT), see
	http://jedwatson.github.io/classnames
*/(function(e){(function(){var t={}.hasOwnProperty;function n(){for(var o="",a=0;a<arguments.length;a++){var l=arguments[a];l&&(o=i(o,r(l)))}return o}function r(o){if(typeof o=="string"||typeof o=="number")return o;if(typeof o!="object")return"";if(Array.isArray(o))return n.apply(null,o);if(o.toString!==Object.prototype.toString&&!o.toString.toString().includes("[native code]"))return o.toString();var a="";for(var l in o)t.call(o,l)&&o[l]&&(a=i(a,l));return a}function i(o,a){return a?o?o+" "+a:o+a:o}e.exports?(n.default=n,e.exports=n):window.classNames=n})()})(MS);var $t=MS.exports;const bM={"lds-circle":"_lds-circle_qlxhy_1"},wM=Object.freeze(Object.defineProperty({__proto__:null,default:bM},Symbol.toStringTag,{value:"Module"})),SM=jt(wM);var $S=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(dc,"__esModule",{value:!0});dc.Circle=void 0;const _M=Mt,CM=$S($t),EM=$S(SM);function kM({color:e="#7f58af",size:t=64,className:n,style:r,...i}){return(0,_M.jsx)("div",{className:(0,CM.default)(EM.default["lds-circle"],n),style:{background:e,width:t,height:t,...r},...i})}dc.Circle=kM;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Circle=void 0;var t=dc;Object.defineProperty(e,"Circle",{enumerable:!0,get:function(){return t.Circle}})})(pS);var IS={},fc={};const PM={"lds-default":"_lds-default_wt1n8_1"},TM=Object.freeze(Object.defineProperty({__proto__:null,default:PM},Symbol.toStringTag,{value:"Module"})),OM=jt(TM);var DS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(fc,"__esModule",{value:!0});fc.Default=void 0;const bv=Mt,jM=DS($t),MM=DS(OM);function $M({color:e="#7f58af",size:t=80,className:n,style:r,...i}){const o=[...Array(12)].map((a,l)=>(0,bv.jsx)("div",{style:{background:`${e}`,width:t*.075,height:t*.075}},l));return(0,bv.jsx)("div",{className:(0,jM.default)(MM.default["lds-default"],n),style:{height:t,width:t,...r},...i,children:o})}fc.Default=$M;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Default=void 0;var t=fc;Object.defineProperty(e,"Default",{enumerable:!0,get:function(){return t.Default}})})(IS);var LS={},pc={};const IM={"lds-dual-ring":"_lds-dual-ring_pbai0_1","lds-dual-ring-after":"_lds-dual-ring-after_pbai0_6"},DM=Object.freeze(Object.defineProperty({__proto__:null,default:IM},Symbol.toStringTag,{value:"Module"})),LM=jt(DM);var RS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(pc,"__esModule",{value:!0});pc.DualRing=void 0;const wv=Mt,Sv=RS($t),_v=RS(LM);function RM({color:e="#7f58af",size:t=80,className:n,style:r,...i}){return(0,wv.jsx)("div",{className:(0,Sv.default)(_v.default["lds-dual-ring"],n),style:{width:t,height:t,...r},...i,children:(0,wv.jsx)("div",{className:(0,Sv.default)(_v.default["lds-dual-ring-after"]),style:{borderColor:`${e} transparent`,borderWidth:t*.1,width:t*.7-6,height:t*.7-6}})})}pc.DualRing=RM;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.DualRing=void 0;var t=pc;Object.defineProperty(e,"DualRing",{enumerable:!0,get:function(){return t.DualRing}})})(LS);var AS={},hc={};const AM={"lds-ellipsis":"_lds-ellipsis_1fzd3_1","lds-ellipsis1":"_lds-ellipsis1_1fzd3_1","lds-ellipsis2":"_lds-ellipsis2_1fzd3_1","lds-ellipsis3":"_lds-ellipsis3_1fzd3_1"},FM=Object.freeze(Object.defineProperty({__proto__:null,default:AM},Symbol.toStringTag,{value:"Module"})),zM=jt(FM);var FS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(hc,"__esModule",{value:!0});hc.Ellipsis=void 0;const Cv=Mt,NM=FS($t),BM=FS(zM);function VM({color:e="#7f58af",size:t=80,className:n,style:r,...i}){const o=[...Array(4)].map((a,l)=>(0,Cv.jsx)("div",{style:{background:`${e}`}},l));return(0,Cv.jsx)("div",{className:(0,NM.default)(BM.default["lds-ellipsis"],n),style:{...r,width:t,height:t},...i,children:o})}hc.Ellipsis=VM;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Ellipsis=void 0;var t=hc;Object.defineProperty(e,"Ellipsis",{enumerable:!0,get:function(){return t.Ellipsis}})})(AS);var zS={},mc={};const UM={"lds-facebook":"_lds-facebook_1ts9g_1"},WM=Object.freeze(Object.defineProperty({__proto__:null,default:UM},Symbol.toStringTag,{value:"Module"})),HM=jt(WM);var NS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(mc,"__esModule",{value:!0});mc.Facebook=void 0;const Ev=Mt,GM=NS($t),qM=NS(HM);function YM({color:e="#7f58af",size:t=80,className:n,style:r,...i}){const o=[...Array(3)].map((a,l)=>(0,Ev.jsx)("div",{style:{background:`${e}`}},l));return(0,Ev.jsx)("div",{className:(0,GM.default)(qM.default["lds-facebook"],n),style:{width:t,height:t,...r},...i,children:o})}mc.Facebook=YM;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Facebook=void 0;var t=mc;Object.defineProperty(e,"Facebook",{enumerable:!0,get:function(){return t.Facebook}})})(zS);var BS={},gc={};const XM={"lds-grid":"_lds-grid_1ftub_1"},KM=Object.freeze(Object.defineProperty({__proto__:null,default:XM},Symbol.toStringTag,{value:"Module"})),QM=jt(KM);var VS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(gc,"__esModule",{value:!0});gc.Grid=void 0;const kv=Mt,ZM=VS($t),JM=VS(QM);function e$({color:e="#7f58af",size:t=80,className:n,style:r,...i}){const o=[...Array(9)].map((a,l)=>(0,kv.jsx)("div",{style:{background:`${e}`}},l));return(0,kv.jsx)("div",{className:(0,ZM.default)(JM.default["lds-grid"],n),style:{width:t,height:t,...r},...i,children:o})}gc.Grid=e$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Grid=void 0;var t=gc;Object.defineProperty(e,"Grid",{enumerable:!0,get:function(){return t.Grid}})})(BS);var US={},vc={};const t$={"lds-heart":"_lds-heart_e4yfg_1","div-after":"_div-after_e4yfg_18","div-before":"_div-before_e4yfg_19"},n$=Object.freeze(Object.defineProperty({__proto__:null,default:t$},Symbol.toStringTag,{value:"Module"})),r$=jt(n$);var WS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(vc,"__esModule",{value:!0});vc.Heart=void 0;const Ts=Mt,Md=WS($t),$d=WS(r$);function i$({color:e="#7f58af",size:t=80,className:n,style:r,...i}){return(0,Ts.jsx)("div",{className:(0,Md.default)($d.default["lds-heart"],n),style:{width:t,height:t,...r},...i,children:(0,Ts.jsxs)("div",{style:{background:e,width:t*.4,height:t*.4,left:t*.3,top:t*.3},children:[(0,Ts.jsx)("div",{className:(0,Md.default)($d.default["div-before"]),style:{background:e,width:t*.4,height:t*.4,left:-t*.3}}),(0,Ts.jsx)("div",{className:(0,Md.default)($d.default["div-after"]),style:{background:e,width:t*.4,height:t*.4,top:-t*.3}})]})})}vc.Heart=i$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Heart=void 0;var t=vc;Object.defineProperty(e,"Heart",{enumerable:!0,get:function(){return t.Heart}})})(US);var HS={},yc={};const o$={"lds-hourglass":"_lds-hourglass_mn3qi_1","lds-hourglass-after":"_lds-hourglass-after_mn3qi_7"},a$=Object.freeze(Object.defineProperty({__proto__:null,default:o$},Symbol.toStringTag,{value:"Module"})),s$=jt(a$);var GS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(yc,"__esModule",{value:!0});yc.Hourglass=void 0;const Pv=Mt,Tv=GS($t),Ov=GS(s$);function l$({color:e="#7f58af",size:t=32,className:n,style:r}){return(0,Pv.jsx)("div",{className:(0,Tv.default)(Ov.default["lds-hourglass"],n),style:{...r},children:(0,Pv.jsx)("div",{className:(0,Tv.default)(Ov.default["lds-hourglass-after"]),style:{background:e,borderWidth:t,borderHeight:t}})})}yc.Hourglass=l$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Hourglass=void 0;var t=yc;Object.defineProperty(e,"Hourglass",{enumerable:!0,get:function(){return t.Hourglass}})})(HS);var qS={},xc={};const YS="_center_1rufi_10",XS="_spin_1rufi_1",u$={"lds-orbitals":"_lds-orbitals_1rufi_1",center:YS,"outer-spin":"_outer-spin_1rufi_19","inner-spin":"_inner-spin_1rufi_20","inner-arc":"_inner-arc_1rufi_25","inner-arc_start-a":"_inner-arc_start-a_1rufi_32","inner-arc_end-a":"_inner-arc_end-a_1rufi_36","inner-moon-a":"_inner-moon-a_1rufi_40","inner-moon-b":"_inner-moon-b_1rufi_49","inner-arc_start-b":"_inner-arc_start-b_1rufi_58","inner-arc_end-b":"_inner-arc_end-b_1rufi_62","outer-arc":"_outer-arc_1rufi_66","outer-arc_start-a":"_outer-arc_start-a_1rufi_73","outer-arc_end-a":"_outer-arc_end-a_1rufi_77","outer-moon-a":"_outer-moon-a_1rufi_81","outer-moon-b":"_outer-moon-b_1rufi_90","outer-arc_start-b":"_outer-arc_start-b_1rufi_99","outer-arc_end-b":"_outer-arc_end-b_1rufi_103",spin:XS},c$=Object.freeze(Object.defineProperty({__proto__:null,center:YS,default:u$,spin:XS},Symbol.toStringTag,{value:"Module"})),d$=jt(c$);var KS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(xc,"__esModule",{value:!0});xc.Orbitals=void 0;const ot=Mt,ft=KS($t),_e=KS(d$);function f$({color:e="#7f58af",className:t,style:n}){return(0,ot.jsxs)("div",{className:(0,ft.default)(_e.default["lds-orbitals"],t),style:{...n},children:[(0,ot.jsx)("div",{className:_e.default.center,style:{background:e}}),(0,ot.jsxs)("div",{className:(0,ft.default)(_e.default["inner-spin"]),children:[(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["inner-arc"],_e.default["inner-arc_start-a"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["inner-arc"],_e.default["inner-arc_end-a"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["inner-arc"],_e.default["inner-arc_start-b"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["inner-arc"],_e.default["inner-arc_end-b"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["inner-moon-a"]),style:{background:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["inner-moon-b"]),style:{background:e}})]}),(0,ot.jsxs)("div",{className:(0,ft.default)(_e.default["outer-spin"]),children:[(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["outer-arc"],_e.default["outer-arc_start-a"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["outer-arc"],_e.default["outer-arc_end-a"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["outer-arc"],_e.default["outer-arc_start-b"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["outer-arc"],_e.default["outer-arc_end-b"]),style:{borderColor:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["outer-moon-a"]),style:{background:e}}),(0,ot.jsx)("div",{className:(0,ft.default)(_e.default["outer-moon-b"]),style:{background:e}})]})]})}xc.Orbitals=f$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Orbitals=void 0;var t=xc;Object.defineProperty(e,"Orbitals",{enumerable:!0,get:function(){return t.Orbitals}})})(qS);var QS={},bc={};const p$={"lds-ring":"_lds-ring_xgxdp_1"},h$=Object.freeze(Object.defineProperty({__proto__:null,default:p$},Symbol.toStringTag,{value:"Module"})),m$=jt(h$);var ZS=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(bc,"__esModule",{value:!0});bc.Ring=void 0;const jv=Mt,g$=ZS($t),v$=ZS(m$);function y$({color:e="#7f58af",size:t=80,className:n,style:r}){const i=[...Array(4)].map((o,a)=>(0,jv.jsx)("div",{style:{borderColor:`${e} transparent transparent transparent`,width:t*.8,height:t*.8,margin:t*.1,borderWidth:t*.1}},a));return(0,jv.jsx)("div",{className:(0,g$.default)(v$.default["lds-ring"],n),style:{width:t,height:t,...r},children:i})}bc.Ring=y$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Ring=void 0;var t=bc;Object.defineProperty(e,"Ring",{enumerable:!0,get:function(){return t.Ring}})})(QS);var JS={},wc={};const x$={"lds-ripple":"_lds-ripple_1lgcf_1"},b$=Object.freeze(Object.defineProperty({__proto__:null,default:x$},Symbol.toStringTag,{value:"Module"})),w$=jt(b$);var e2=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(wc,"__esModule",{value:!0});wc.Ripple=void 0;const Mv=Mt,S$=e2($t),_$=e2(w$);function C$({color:e="#7f58af",size:t=80,className:n,style:r}){const i=[...Array(2)].map((o,a)=>(0,Mv.jsx)("div",{style:{borderColor:`${e}`,borderWidth:t*.05}},a));return(0,Mv.jsx)("div",{className:(0,S$.default)(_$.default["lds-ripple"],n),style:{width:t,height:t,...r},children:i})}wc.Ripple=C$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Ripple=void 0;var t=wc;Object.defineProperty(e,"Ripple",{enumerable:!0,get:function(){return t.Ripple}})})(JS);var t2={},Sc={};const E$={"lds-roller":"_lds-roller_ks1ij_1","div-after":"_div-after_ks1ij_11"},k$=Object.freeze(Object.defineProperty({__proto__:null,default:E$},Symbol.toStringTag,{value:"Module"})),P$=jt(k$);var n2=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(Sc,"__esModule",{value:!0});Sc.Roller=void 0;const Id=Mt,$v=n2($t),Iv=n2(P$);function T$({color:e="#7f58af",className:t,style:n}){const r=[...Array(8)].map((i,o)=>(0,Id.jsx)("div",{children:(0,Id.jsx)("div",{className:(0,$v.default)(Iv.default["div-after"]),style:{background:e}})},o));return(0,Id.jsx)("div",{className:(0,$v.default)(Iv.default["lds-roller"],t),style:{...n},children:r})}Sc.Roller=T$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Roller=void 0;var t=Sc;Object.defineProperty(e,"Roller",{enumerable:!0,get:function(){return t.Roller}})})(t2);var r2={},_c={};const O$={"lds-spinner":"_lds-spinner_flf3t_1","div-after":"_div-after_flf3t_12"},j$=Object.freeze(Object.defineProperty({__proto__:null,default:O$},Symbol.toStringTag,{value:"Module"})),M$=jt(j$);var i2=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(_c,"__esModule",{value:!0});_c.Spinner=void 0;const Dd=Mt,Dv=i2($t),Lv=i2(M$);function $$({color:e="#7f58af",className:t,style:n}){const r=[...Array(12)].map((i,o)=>(0,Dd.jsx)("div",{children:(0,Dd.jsx)("div",{className:(0,Dv.default)(Lv.default["div-after"]),style:{background:e}})},o));return(0,Dd.jsx)("div",{className:(0,Dv.default)(Lv.default["lds-spinner"],t),style:{...n},children:r})}_c.Spinner=$$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Spinner=void 0;var t=_c;Object.defineProperty(e,"Spinner",{enumerable:!0,get:function(){return t.Spinner}})})(r2);var o2={},Cc={};const a2="_left_v9vlb_30",s2="_right_v9vlb_33",l2="_anim_v9vlb_37",I$={"lds-ouroboro":"_lds-ouroboro_v9vlb_1",left:a2,right:s2,anim:l2,"lds-ouroboro-rotate":"_lds-ouroboro-rotate_v9vlb_1"},D$=Object.freeze(Object.defineProperty({__proto__:null,anim:l2,default:I$,left:a2,right:s2},Symbol.toStringTag,{value:"Module"})),L$=jt(D$);var u2=te&&te.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(Cc,"__esModule",{value:!0});Cc.Ouroboro=void 0;const Ro=Mt,Ao=u2($t),Fo=u2(L$);function R$({color:e="#7f58af",style:t,className:n}){return(0,Ro.jsxs)("div",{className:(0,Ao.default)(Fo.default["lds-ouroboro"],n),style:{...t},children:[(0,Ro.jsx)("span",{className:(0,Ao.default)(Fo.default.left),children:(0,Ro.jsx)("span",{className:(0,Ao.default)(Fo.default.anim),style:{background:e}})}),(0,Ro.jsx)("span",{className:(0,Ao.default)(Fo.default.right),children:(0,Ro.jsx)("span",{className:(0,Ao.default)(Fo.default.anim),style:{background:e}})})]})}Cc.Ouroboro=R$;(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Ouroboro=void 0;var t=Cc;Object.defineProperty(e,"Ouroboro",{enumerable:!0,get:function(){return t.Ouroboro}})})(o2);(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.Ouroboro=e.Spinner=e.Roller=e.Ripple=e.Ring=e.Orbitals=e.Hourglass=e.Heart=e.Grid=e.Facebook=e.Ellipsis=e.DualRing=e.Default=e.Circle=void 0;const t=pS;Object.defineProperty(e,"Circle",{enumerable:!0,get:function(){return t.Circle}});const n=IS;Object.defineProperty(e,"Default",{enumerable:!0,get:function(){return n.Default}});const r=LS;Object.defineProperty(e,"DualRing",{enumerable:!0,get:function(){return r.DualRing}});const i=AS;Object.defineProperty(e,"Ellipsis",{enumerable:!0,get:function(){return i.Ellipsis}});const o=zS;Object.defineProperty(e,"Facebook",{enumerable:!0,get:function(){return o.Facebook}});const a=BS;Object.defineProperty(e,"Grid",{enumerable:!0,get:function(){return a.Grid}});const l=US;Object.defineProperty(e,"Heart",{enumerable:!0,get:function(){return l.Heart}});const s=HS;Object.defineProperty(e,"Hourglass",{enumerable:!0,get:function(){return s.Hourglass}});const u=qS;Object.defineProperty(e,"Orbitals",{enumerable:!0,get:function(){return u.Orbitals}});const d=QS;Object.defineProperty(e,"Ring",{enumerable:!0,get:function(){return d.Ring}});const c=JS;Object.defineProperty(e,"Ripple",{enumerable:!0,get:function(){return c.Ripple}});const y=t2;Object.defineProperty(e,"Roller",{enumerable:!0,get:function(){return y.Roller}});const p=r2;Object.defineProperty(e,"Spinner",{enumerable:!0,get:function(){return p.Spinner}});const m=o2;Object.defineProperty(e,"Ouroboro",{enumerable:!0,get:function(){return m.Ouroboro}})})(fS);const A$=()=>f.jsx(iM,{children:f.jsx(fS.Default,{color:"#6d433da8"})});const F$="/Didiv/assets/Ancient_Kyiv-2153f7e6.ttf",z$=FT`
:root {
  /* colors */
  --black-color: #1d0f0a;
...
`,Wd=_.div`
  font-size: 14px;
  color: #888;
`,O2=()=>f.jsxs(jD,{children:[f.jsxs(Vd,{children:[f.jsx(Ud,{children:"3000+"}),f.jsx(Wd,{children:"Перевірених деталей"})]}),f.jsxs(Vd,{children:[f.jsx(Ud,{children:"6 років"}),f.jsx(Wd,{children:"Досвіду на ринку"})]}),f.jsxs(Vd,{children:[f.jsx(Ud,{children:"100%"}),f.jsx(Wd,{children:"Контроль якості"})]})]}),MD=Ae.div`
...
`;Ae.img`
  ...
  height: 40px;
  object-fit: cover;
`;const ID=()=>f.jsx(MD,{children:f.jsxs($D,{children:[f.jsx(OD,{}),f.jsx(qw,{}),f.jsx(G$,{}),f.jsx(O2,{})]})}),DD=_.div`
...
`,I2="carousel",D2="controller",Y6="navigation",X6="no-scroll",Fm="portal",K6="root",L2="toolbar",e1="zoom",Hd="loading",Gd="error",qd="complete",Q6="placeholder",Z6=e=>`active-slide-${e}`,J6="fullsize",zm="flex_center",eL="no_scroll",R2="no_scroll_padding",Nm="slide",A2="slide_wrapper",tL="slide_wrapper_interactive",Br="prev",Vr="next",t1="swipe",so="close",F2="onPointerDown",z2="onPointerMove",N2="onPointerUp",B2="onPointerLeave",V2="onPointerCancel",Bm="onKeyDown",nL="onKeyUp",Vm="onWheel",rL="Escape",iL="ArrowLeft",oL="ArrowRight",aL="button",Vp="icon",U2="contain",n1="cover",W2="Unknown action type",H2="yarl__";function jn(...e){return e.filter(Boolean).join(" ")}function ae(e){return`${H2}${e}`}function _t(e){return`--${H2}${e}`}function ns(e,t){return`${e}${t?`_${t}`:""}`}function Um(e){return t=>ns(e,t)}function lo(e,t){var n;return(n=e==null?void 0:e[t])!==null&&n!==void 0?n:t}function sL(e,t,n){return lo(e,"{index} of {total}").replace(/\{index}/g,`${Ym(n,t.length)+1}`).replace(/\{total}/g,`${t.length}`)}function Wm(...e){return()=>{e.forEach(t=>{t()})}}function nr(e,t,n){return()=>{const r=x.useContext(n);if(!r)throw new Error(`${e} must be used within a ${t}.Provider`);return r}}function Hm(){return typeof window<"u"}function Gm(e,t=0){const n=10**t;return Math.round((e+Number.EPSILON)*n)/n}function So(e){return e.type===void 0||e.type==="image"}function qm(e,t){return e.imageFit===n1||e.imageFit!==U2&&t===n1}function Ec(e){return typeof e=="string"?Number.parseInt(e,10):e}function su(e){if(typeof e=="number")return{pixel:e};if(typeof e=="string"){const t=Ec(e);return e.endsWith("%")?{percent:t}:{pixel:t}}return{pixel:0}}function lL(e,t){const n=su(t),r=n.percent!==void 0?e.width/100*n.percent:n.pixel;return{width:Math.max(e.width-2*r,0),height:Math.max(e.height-2*r,0)}}function uL(){return(Hm()?window==null?void 0:window.devicePixelRatio:void 0)||1}function Ym(e,t){return t>0?(e%t+t)%t:0}function G2(e){return e.length>0}function q2(e,t){return e[Ym(t,e.length)]}function Up(e,t){return G2(e)?q2(e,t):void 0}function cL(e){return So(e)?e.src:void 0}function dL(e,t,n){if(!n)return e;const{buttons:r,...i}=e,o=r.findIndex(l=>l===t),a=x.isValidElement(n)?x.cloneElement(n,{key:t},null):n;if(o>=0){const l=[...r];return l.splice(o,1,a),{buttons:l,...i}}return{buttons:[a,...r],...i}}function fL(e,t,n=0){return Math.min(e.preload,Math.max(e.finite?t.length-1:Math.floor(t.length/2),n))}const pL=Number(x.version.split(".")[0])>=19;function hL(e){return{inert:pL?e:e?"":void 0}}function mL(e){e.scrollTop}const Wp={open:!1,close:()=>{},index:0,slides:[],render:{},plugins:[],toolbar:{buttons:[so]},labels:{},animation:{fade:250,swipe:500,easing:{fade:"ease",swipe:"ease-out",navigation:"ease-in-out"}},carousel:{finite:!1,preload:2,padding:"16px",spacing:"30%",imageFit:U2,imageProps:{}},controller:{ref:null,focus:!0,aria:!1,touchAction:"none",closeOnPullUp:!1,closeOnPullDown:!1,closeOnBackdropClick:!1,preventDefaultWheelX:!0,preventDefaultWheelY:!1,disableSwipeNavigation:!1},portal:{},noScroll:{disabled:!1},on:{},styles:{},className:""};function Ir(e,t){return{name:e,component:t}}function He(e,t){return{module:e,children:t}}function Y2(e,t,n){return e.module.name===t?n(e):e.children?[He(e.module,e.children.flatMap(r=>{var i;return(i=Y2(r,t,n))!==null&&i!==void 0?i:[]}))]:[e]}function xi(e,t,n){return e.flatMap(r=>{var i;return(i=Y2(r,t,n))!==null&&i!==void 0?i:[]})}function gL(e,t=[],n=[]){let r=e;const i=p=>{const m=[...r];for(;m.length>0;){const g=m.pop();if((g==null?void 0:g.module.name)===p)return!0;g!=null&&g.children&&m.push(...g.children)}return!1},o=(p,m)=>{if(p===""){r=[He(m,r)];return}r=xi(r,p,g=>[He(m,[g])])},a=(p,m)=>{r=xi(r,p,g=>[He(g.module,[He(m,g.children)])])},l=(p,m,g)=>{r=xi(r,p,w=>{var h;return[He(w.module,[...g?[He(m)]:[],...(h=w.children)!==null&&h!==void 0?h:[],...g?[]:[He(m)]])]})},s=(p,m,g)=>{r=xi(r,p,w=>[...g?[He(m)]:[],w,...g?[]:[He(m)]])},u=p=>{a(D2,p)},d=(p,m)=>{r=xi(r,p,g=>[He(m,g.children)])},c=p=>{r=xi(r,p,m=>m.children)},y=p=>{n.push(p)};return t.forEach(p=>{p({contains:i,addParent:o,append:a,addChild:l,addSibling:s,addModule:u,replace:d,remove:c,augment:y})}),{config:r,augmentation:p=>n.reduce((m,g)=>g(m),p)}}const X2=x.createContext(null),K2=nr("useA11yContext","A11yContext",X2);function vL({children:e}){const[t,n]=x.useState(!1),[r,i]=x.useState(!1),o=x.useMemo(()=>({focusWithin:t,trackFocusWithin:(l,s)=>{const u=d=>c=>{var y;c.currentTarget.contains(c.relatedTarget)||n(d),(y=d?l:s)===null||y===void 0||y(c)};return{onFocus:u(!0),onBlur:u(!1)}},autoPlaying:r,setAutoPlaying:i}),[t,r]);return x.createElement(X2.Provider,{value:o},e)}const Q2=x.createContext(null),kc=nr("useDocument","DocumentContext",Q2);function yL({nodeRef:e,children:t}){const n=x.useMemo(()=>{const r=o=>{var a;return((a=o||e.current)===null||a===void 0?void 0:a.ownerDocument)||document};return{getOwnerDocument:r,getOwnerWindow:o=>{var a;return((a=r(o))===null||a===void 0?void 0:a.defaultView)||window}}},[e]);return x.createElement(Q2.Provider,{value:n},t)}const Z2=x.createContext(null),Pc=nr("useEvents","EventsContext",Z2);function xL({children:e}){const[t]=x.useState({});x.useEffect(()=>()=>{Object.keys(t).forEach(r=>delete t[r])},[t]);const n=x.useMemo(()=>{const r=(a,l)=>{var s;(s=t[a])===null||s===void 0||s.splice(0,t[a].length,...t[a].filter(u=>u!==l))};return{publish:(...[a,l])=>{var s;(s=t[a])===null||s===void 0||s.forEach(u=>u(l))},subscribe:(a,l)=>(t[a]||(t[a]=[]),t[a].push(l),()=>r(a,l)),unsubscribe:r}},[t]);return x.createElement(Z2.Provider,{value:n},e)}const J2=x.createContext(null),Jt=nr("useLightboxProps","LightboxPropsContext",J2);function bL({children:e,...t}){return x.createElement(J2.Provider,{value:t},e)}const e_=x.createContext(null),Dr=nr("useLightboxState","LightboxStateContext",e_),t_=x.createContext(null),wL=nr("useLightboxDispatch","LightboxDispatchContext",t_);function SL(e,t){switch(t.type){case"swipe":{const{slides:n}=e,r=(t==null?void 0:t.increment)||0,i=e.globalIndex+r,o=Ym(i,n.length),a=Up(n,o),l=r||t.duration!==void 0?{increment:r,duration:t.duration,easing:t.easing}:void 0;return{slides:n,currentIndex:o,globalIndex:i,currentSlide:a,animation:l}}case"update":return t.slides!==e.slides||t.index!==e.currentIndex?{slides:t.slides,currentIndex:t.index,globalIndex:t.index,currentSlide:Up(t.slides,t.index)}:e;default:throw new Error(W2)}}function _L({slides:e,index:t,children:n}){const[r,i]=x.useReducer(SL,{slides:e,currentIndex:t,globalIndex:t,currentSlide:Up(e,t)}),[o,a]=x.useState(e),[l,s]=x.useState(t);(e!==o||t!==l)&&(a(e),s(t),i({type:"update",slides:e,index:t}));const u=x.useMemo(()=>({...r,state:r,dispatch:i}),[r,i]);return x.createElement(t_.Provider,{value:i},x.createElement(e_.Provider,{value:u},n))}const n_=x.createContext(null),Tc=nr("useTimeouts","TimeoutsContext",n_);function CL({children:e}){const[t]=x.useState([]);x.useEffect(()=>()=>{t.forEach(r=>window.clearTimeout(r)),t.splice(0,t.length)},[t]);const n=x.useMemo(()=>{const r=a=>{t.splice(0,t.length,...t.filter(l=>l!==a))};return{setTimeout:(a,l)=>{const s=window.setTimeout(()=>{r(s),a()},l);return t.push(s),s},clearTimeout:a=>{a!==void 0&&(r(a),window.clearTimeout(a))}}},[t]);return x.createElement(n_.Provider,{value:n},e)}const Xm=x.forwardRef(function({label:t,className:n,icon:r,renderIcon:i,onClick:o,style:a,...l},s){const{styles:u,labels:d}=Jt(),c=lo(d,t);return x.createElement("button",{ref:s,type:"button",title:c,"aria-label":c,className:jn(ae(aL),n),onClick:o,style:{...a,...u.button},...l},i?i():x.createElement(r,{className:ae(Vp),style:u.icon}))});function EL(e,t){const n=r=>x.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"24",height:"24","aria-hidden":"true",focusable:"false",...r},t);return n.displayName=e,n}function ci(e,t){return EL(e,x.createElement("g",{fill:"currentColor"},x.createElement("path",{d:"M0 0h24v24H0z",fill:"none"}),t))}const kL=ci("Close",x.createElement("path",{d:"M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"})),PL=ci("Previous",x.createElement("path",{d:"M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"})),TL=ci("Next",x.createElement("path",{d:"M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"})),OL=ci("Loading",x.createElement(x.Fragment,null,Array.from({length:8}).map((e,t,n)=>x.createElement("line",{key:t,x1:"12",y1:"6.5",x2:"12",y2:"1.8",strokeLinecap:"round",strokeWidth:"2.6",stroke:"currentColor",strokeOpacity:1/n.length*(t+1),transform:`rotate(${360/n.length*t}, 12, 12)`})))),jL=ci("Error",x.createElement("path",{d:"M21.9,21.9l-8.49-8.49l0,0L3.59,3.59l0,0L2.1,2.1L0.69,3.51L3,5.83V19c0,1.1,0.9,2,2,2h13.17l2.31,2.31L21.9,21.9z M5,18 l3.5-4.5l2.5,3.01L12.17,15l3,3H5z M21,18.17L5.83,3H19c1.1,0,2,0.9,2,2V18.17z"})),Mn=Hm()?x.useLayoutEffect:x.useEffect;function Km(){const[e,t]=x.useState(!1);return x.useEffect(()=>{var n,r;const i=(n=window.matchMedia)===null||n===void 0?void 0:n.call(window,"(prefers-reduced-motion: reduce)");t(i==null?void 0:i.matches);const o=a=>t(a.matches);return(r=i==null?void 0:i.addEventListener)===null||r===void 0||r.call(i,"change",o),()=>{var a;return(a=i==null?void 0:i.removeEventListener)===null||a===void 0?void 0:a.call(i,"change",o)}},[]),e}function ML(e){let t=0,n=0,r=0;const o=window.getComputedStyle(e).transform.match(/matrix.*\((.+)\)/);if(o){const a=o[1].split(",").map(Ec);a.length===6?(t=a[4],n=a[5]):a.length===16&&(t=a[12],n=a[13],r=a[14])}return{x:t,y:n,z:r}}function r1(e,t){const n=x.useRef(void 0),r=x.useRef(void 0),i=Km();return Mn(()=>{var o,a,l;if(e.current&&n.current!==void 0&&!i){const{keyframes:s,duration:u,easing:d,onfinish:c}=t(n.current,e.current.getBoundingClientRect(),ML(e.current))||{};if(s&&u){(o=r.current)===null||o===void 0||o.cancel(),r.current=void 0;try{r.current=(l=(a=e.current).animate)===null||l===void 0?void 0:l.call(a,s,{duration:u,easing:d})}catch(y){console.error(y)}r.current&&(r.current.onfinish=()=>{r.current=void 0,c==null||c()})}}n.current=void 0}),{prepareAnimation:o=>{n.current=o},isAnimationPlaying:()=>{var o;return((o=r.current)===null||o===void 0?void 0:o.playState)==="running"}}}function r_(){const e=x.useRef(null),t=x.useRef(void 0),[n,r]=x.useState();return{setContainerRef:x.useCallback(o=>{e.current=o,t.current&&(t.current.disconnect(),t.current=void 0);const a=()=>{if(o){const l=window.getComputedStyle(o),s=u=>parseFloat(u)||0;r({width:Math.round(o.clientWidth-s(l.paddingLeft)-s(l.paddingRight)),height:Math.round(o.clientHeight-s(l.paddingTop)-s(l.paddingBottom))})}else r(void 0)};a(),o&&typeof ResizeObserver<"u"&&(t.current=new ResizeObserver(a),t.current.observe(o))},[]),containerRef:e,containerRect:n}}function cl(){const e=x.useRef(void 0),{setTimeout:t,clearTimeout:n}=Tc();return x.useCallback((r,i)=>{n(e.current),e.current=t(r,i>0?i:0)},[t,n])}function he(e){const t=x.useRef(e);return Mn(()=>{t.current=e}),x.useCallback((...n)=>{var r;return(r=t.current)===null||r===void 0?void 0:r.call(t,...n)},[])}function i1(e,t){typeof e=="function"?e(t):e&&(e.current=t)}function Hp(e,t){return x.useMemo(()=>e==null&&t==null?null:n=>{i1(e,n),i1(t,n)},[e,t])}function $L(e,t=!1){const n=x.useRef(!1);Mn(()=>{t&&n.current&&(n.current=!1,e())},[t,e]);const r=x.useCallback(()=>{n.current=!0},[]),i=x.useCallback(()=>{n.current=!1},[]);return{onFocus:r,onBlur:i}}function Qm(){const[e,t]=x.useState(!1);return Mn(()=>{t(window.getComputedStyle(window.document.documentElement).direction==="rtl")},[]),e}function IL(){const[e]=x.useState({}),t=x.useCallback((i,o)=>{var a;(a=e[i])===null||a===void 0||a.forEach(l=>{o.isPropagationStopped()||l(o)})},[e]),n=x.useMemo(()=>({onPointerDown:i=>t(F2,i),onPointerMove:i=>t(z2,i),onPointerUp:i=>t(N2,i),onPointerLeave:i=>t(B2,i),onPointerCancel:i=>t(V2,i),onKeyDown:i=>t(Bm,i),onKeyUp:i=>t(nL,i),onWheel:i=>t(Vm,i)}),[t]),r=x.useCallback((i,o)=>(e[i]||(e[i]=[]),e[i].unshift(o),()=>{const a=e[i];a&&a.splice(0,a.length,...a.filter(l=>l!==o))}),[e]);return{registerSensors:n,subscribeSensors:r}}function o1(e,t){const n=x.useRef(0),r=cl(),i=he((...o)=>{n.current=Date.now(),e(o)});return x.useCallback((...o)=>{r(()=>{i(o)},t-(Date.now()-n.current))},[t,i,r])}const Yd=Um("slide"),Xd=Um("slide_image");function lu({slide:e,offset:t,render:n,rect:r,imageFit:i,imageProps:o,onClick:a,onLoad:l,onError:s,style:u}){var d,c,y,p,m,g,w,h;const[v,b]=x.useState(Hd),{publish:S}=Pc(),{setTimeout:E}=Tc(),T=x.useRef(null);x.useEffect(()=>{t===0&&S(Z6(v))},[t,v,S]);const k=he(N=>{("decode"in N?N.decode():Promise.resolve()).catch(()=>{}).then(()=>{N.parentNode&&(b(qd),E(()=>{l==null||l(N)},0))})}),C=x.useCallback(N=>{T.current=N,N!=null&&N.complete&&k(N)},[k]),M=x.useCallback(N=>{k(N.currentTarget)},[k]),$=he(()=>{b(Gd),s==null||s()}),D=qm(e,i),R=(N,U)=>Number.isFinite(N)?N:U,j=R(Math.max(...((c=(d=e.srcSet)===null||d===void 0?void 0:d.map(N=>N.width))!==null&&c!==void 0?c:[]).concat(e.width?[e.width]:[]).filter(Boolean)),((y=T.current)===null||y===void 0?void 0:y.naturalWidth)||0),F=R(Math.max(...((m=(p=e.srcSet)===null||p===void 0?void 0:p.map(N=>N.height))!==null&&m!==void 0?m:[]).concat(e.height?[e.height]:[]).filter(Boolean)),((g=T.current)===null||g===void 0?void 0:g.naturalHeight)||0),A=j&&F?{maxWidth:`min(${j}px, 100%)`,maxHeight:`min(${F}px, 100%)`}:{maxWidth:"100%",maxHeight:"100%"},L=(w=e.srcSet)===null||w===void 0?void 0:w.slice().sort((N,U)=>N.width-U.width).map(N=>`${N.src} ${N.width}w`).join(", "),O=()=>r&&!D&&e.width&&e.height?r.height/e.height*e.width:Number.MAX_VALUE,P=L&&r&&Hm()?`${Math.round(Math.min(O(),r.width))}px`:void 0,{style:I,className:z,...B}=(typeof o=="function"?o(e):o)||{};return x.createElement(x.Fragment,null,x.createElement("img",{ref:C,onLoad:M,onError:$,onClick:a,draggable:!1,className:jn(ae(Xd()),D&&ae(Xd("cover")),v!==qd&&ae(Xd("loading")),z),style:{...A,...u,...I},...B,alt:(h=e.alt)!==null&&h!==void 0?h:"",sizes:P,srcSet:L,src:e.src}),v!==qd&&x.createElement("div",{className:ae(Yd(Q6))},v===Hd&&(n!=null&&n.iconLoading?n.iconLoading():x.createElement(OL,{className:jn(ae(Vp),ae(Yd(Hd)))})),v===Gd&&(n!=null&&n.iconError?n.iconError():x.createElement(jL,{className:jn(ae(Vp),ae(Yd(Gd)))}))))}const DL=x.forwardRef(function({className:t,children:n,onFocus:r,onBlur:i,...o},a){const l=x.useRef(null),{trackFocusWithin:s}=K2();return x.createElement(yL,{nodeRef:l},x.createElement("div",{ref:Hp(a,l),className:jn(ae("root"),t),...s(r,i),...o},n))});var st;(function(e){e[e.NONE=0]="NONE",e[e.SWIPE=1]="SWIPE",e[e.PULL=2]="PULL",e[e.ANIMATION=3]="ANIMATION"})(st||(st={}));function i_(e,t,n,r,i){x.useEffect(()=>i?()=>{}:Wm(e(F2,t),e(z2,n),e(N2,r),e(B2,r),e(V2,r)),[e,t,n,r,i])}var rn;(function(e){e[e.NONE=0]="NONE",e[e.SWIPE=1]="SWIPE",e[e.PULL=2]="PULL"})(rn||(rn={}));const Kd=30;function LL({disableSwipeNavigation:e,closeOnBackdropClick:t},n,r,i,o,a,l,s,u,d,c,y,p,m,g,w){const h=x.useRef(0),v=x.useRef([]),b=x.useRef(void 0),S=x.useRef(0),E=x.useRef(rn.NONE),T=x.useCallback(j=>{b.current===j.pointerId&&(b.current=void 0,E.current=rn.NONE);const F=v.current;F.splice(0,F.length,...F.filter(A=>A.pointerId!==j.pointerId))},[]),k=x.useCallback(j=>{T(j),j.persist(),v.current.push(j)},[T]),C=x.useCallback(j=>v.current.find(({pointerId:F})=>j.pointerId===F),[]),M=he(j=>{k(j)}),$=(j,F)=>c&&j>F||d&&j<-F,D=he(j=>{const F=C(j);if(F)if(b.current===j.pointerId){const A=Date.now()-S.current,L=h.current;E.current===rn.SWIPE?Math.abs(L)>.3*i||Math.abs(L)>5&&A<o?s(L,A):u(L):E.current===rn.PULL&&($(L,2*Kd)?m(L,A):g(L)),h.current=0,E.current=rn.NONE}else{const{target:A}=j;t&&A instanceof HTMLElement&&A===F.target&&(A.classList.contains(ae(Nm))||A.classList.contains(ae(A2)))&&w()}T(j)}),R=he(j=>{const F=C(j);if(F){const A=b.current===j.pointerId;if(j.buttons===0){A&&h.current!==0?D(j):T(F);return}const L=j.clientX-F.clientX,O=j.clientY-F.clientY;if(b.current===void 0){const P=I=>{k(j),b.current=j.pointerId,S.current=Date.now(),E.current=I};Math.abs(L)>Math.abs(O)&&Math.abs(L)>Kd&&r(L)?e||(P(rn.SWIPE),a()):Math.abs(O)>Math.abs(L)&&$(O,Kd)&&(P(rn.PULL),y())}else A&&(E.current===rn.SWIPE?(h.current=L,l(L)):E.current===rn.PULL&&(h.current=O,p(O)))}});i_(n,M,R,D)}function RL({preventDefaultWheelX:e,preventDefaultWheelY:t}){const n=x.useRef(null),r=he(i=>{const o=Math.abs(i.deltaX)>Math.abs(i.deltaY);(o&&e||!o&&t||i.ctrlKey)&&i.preventDefault()});return x.useCallback(i=>{var o;i?i.addEventListener("wheel",r,{passive:!1}):(o=n.current)===null||o===void 0||o.removeEventListener("wheel",r),n.current=i},[r])}function AL(e,t,n,r,i,o,a,l,s){const u=x.useRef(0),d=x.useRef(0),c=x.useRef(void 0),y=x.useRef(void 0),p=x.useRef(0),m=x.useRef(void 0),g=x.useRef(0),{setTimeout:w,clearTimeout:h}=Tc(),v=x.useCallback(()=>{c.current&&(h(c.current),c.current=void 0)},[h]),b=x.useCallback(()=>{y.current&&(h(y.current),y.current=void 0)},[h]),S=he(()=>{e!==st.SWIPE&&(u.current=0,g.current=0,v(),b())});x.useEffect(S,[e,S]);const E=he(k=>{y.current=void 0,u.current===k&&s(u.current)}),T=he(k=>{if(k.ctrlKey||Math.abs(k.deltaY)>Math.abs(k.deltaX))return;const C=M=>{p.current=M,h(m.current),m.current=M>0?w(()=>{p.current=0,m.current=void 0},300):void 0};if(e===st.NONE){if(Math.abs(k.deltaX)<=1.2*Math.abs(p.current)){C(k.deltaX);return}if(!n(-k.deltaX))return;if(d.current+=k.deltaX,v(),Math.abs(d.current)>30)d.current=0,C(0),g.current=Date.now(),o();else{const M=d.current;c.current=w(()=>{c.current=void 0,M===d.current&&(d.current=0)},i)}}else if(e===st.SWIPE){let M=u.current-k.deltaX;if(M=Math.min(Math.abs(M),r)*Math.sign(M),u.current=M,a(M),b(),Math.abs(M)>.2*r){C(k.deltaX),l(M,Date.now()-g.current);return}y.current=w(()=>E(M),2*i)}else C(k.deltaX)});x.useEffect(()=>t(Vm,T),[t,T])}const a1=Um("container"),o_=x.createContext(null),rr=nr("useController","ControllerContext",o_);function FL({children:e,...t}){var n;const{carousel:r,animation:i,controller:o,on:a,styles:l,render:s}=t,{closeOnPullUp:u,closeOnPullDown:d,preventDefaultWheelX:c,preventDefaultWheelY:y}=o,[p,m]=x.useState(),g=Dr(),w=wL(),[h,v]=x.useState(st.NONE),b=x.useRef(0),S=x.useRef(0),E=x.useRef(1),{registerSensors:T,subscribeSensors:k}=IL(),{subscribe:C,publish:M}=Pc(),$=cl(),D=cl(),R=cl(),{containerRef:j,setContainerRef:F,containerRect:A}=r_(),L=Hp(RL({preventDefaultWheelX:c,preventDefaultWheelY:y}),F),O=x.useRef(null),P=Hp(O,void 0),{getOwnerDocument:I}=kc(),z=Qm(),B=q=>(z?-1:1)*(typeof q=="number"?q:1),N=he(()=>{var q;return(q=j.current)===null||q===void 0?void 0:q.focus()}),U=he(()=>t),G=he(()=>g),W=x.useCallback(q=>M(Br,q),[M]),X=x.useCallback(q=>M(Vr,q),[M]),ee=x.useCallback(()=>M(so),[M]),pe=q=>!(r.finite&&(B(q)>0&&g.currentIndex===0||B(q)<0&&g.currentIndex===g.slides.length-1)),we=q=>{var Se;b.current=q,(Se=j.current)===null||Se===void 0||Se.style.setProperty(_t("swipe_offset"),`${Math.round(q)}px`)},ie=q=>{var Se,dt;S.current=q,E.current=(()=>{const Eo=(()=>d&&q>0?q:u&&q<0?-q:0)();return Math.min(Math.max(Gm(1-Eo/60*(1-.5),2),.5),1)})(),(Se=j.current)===null||Se===void 0||Se.style.setProperty(_t("pull_offset"),`${Math.round(q)}px`),(dt=j.current)===null||dt===void 0||dt.style.setProperty(_t("pull_opacity"),`${E.current}`)},{prepareAnimation:Ie}=r1(O,(q,Se,dt)=>{if(O.current&&A)return{keyframes:[{transform:`translate(0, ${q.rect.y-Se.y+dt.y}px)`,opacity:q.opacity},{transform:"translate(0, 0)",opacity:1}],duration:q.duration,easing:i.easing.fade}}),Ue=(q,Se)=>{if(u||d){ie(q);let dt=0;O.current&&(dt=i.fade*(Se?2:1),Ie({rect:O.current.getBoundingClientRect(),opacity:E.current,duration:dt})),R(()=>{ie(0),v(st.NONE)},dt),v(st.ANIMATION),Se||ee()}},{prepareAnimation:We,isAnimationPlaying:di}=r1(O,(q,Se,dt)=>{var vn;if(O.current&&A&&(!((vn=g.animation)===null||vn===void 0)&&vn.duration)){const Wt=su(r.spacing),Eo=(Wt.percent?Wt.percent*A.width/100:Wt.pixel)||0;return{keyframes:[{transform:`translate(${B(g.globalIndex-q.index)*(A.width+Eo)+q.rect.x-Se.x+dt.x}px, 0)`},{transform:"translate(0, 0)"}],duration:g.animation.duration,easing:g.animation.easing}}}),wt=he(q=>{var Se,dt;const vn=q.offset||0,Wt=vn?i.swipe:(Se=i.navigation)!==null&&Se!==void 0?Se:i.swipe,Eo=!vn&&!di()?i.easing.navigation:i.easing.swipe;let{direction:is}=q;const os=(dt=q.count)!==null&&dt!==void 0?dt:1;let zc=st.ANIMATION,yn=Wt*os;if(!is){const ko=A==null?void 0:A.width,pg=q.duration||0,Bc=ko?Wt/ko*Math.abs(vn):Wt;os!==0?(pg<Bc?yn=yn/Bc*Math.max(pg,Bc/5):ko&&(yn=Wt/ko*(ko-Math.abs(vn))),is=B(vn)>0?Br:Vr):yn=Wt/2}let Nc=0;is===Br?pe(B(1))?Nc=-os:(zc=st.NONE,yn=Wt):is===Vr&&(pe(B(-1))?Nc=os:(zc=st.NONE,yn=Wt)),yn=Math.round(yn),D(()=>{we(0),v(st.NONE)},yn),O.current&&We({rect:O.current.getBoundingClientRect(),index:g.globalIndex}),v(zc),M(t1,{type:"swipe",increment:Nc,duration:yn,easing:Eo})});x.useEffect(()=>{var q,Se;!((q=g.animation)===null||q===void 0)&&q.increment&&(!((Se=g.animation)===null||Se===void 0)&&Se.duration)&&$(()=>w({type:"swipe",increment:0}),g.animation.duration)},[g.animation,w,$]);const _o=[k,pe,(A==null?void 0:A.width)||0,i.swipe,()=>v(st.SWIPE),q=>we(q),(q,Se)=>wt({offset:q,duration:Se,count:1}),q=>wt({offset:q,count:0})],rs=[()=>{d&&v(st.PULL)},q=>ie(q),q=>Ue(q),q=>Ue(q,!0)];LL(o,..._o,u,d,...rs,ee),AL(h,..._o);const Co=he(()=>{o.focus&&I().querySelector(`.${ae(Fm)} .${ae(a1())}`)&&N()});x.useEffect(Co,[Co]);const fg=he(()=>{var q;(q=a.view)===null||q===void 0||q.call(a,{index:g.currentIndex})});x.useEffect(fg,[g.globalIndex,fg]),x.useEffect(()=>Wm(C(Br,q=>wt({direction:Br,...q})),C(Vr,q=>wt({direction:Vr,...q})),C(t1,q=>w(q))),[C,wt,w]);const uC=x.useMemo(()=>({prev:W,next:X,close:ee,focus:N,slideRect:A?lL(A,r.padding):{width:0,height:0},containerRect:A||{width:0,height:0},subscribeSensors:k,containerRef:j,setCarouselRef:P,toolbarWidth:p,setToolbarWidth:m}),[W,X,ee,N,k,A,j,P,p,m,r.padding]);return x.useImperativeHandle(o.ref,()=>({prev:W,next:X,close:ee,focus:N,getLightboxProps:U,getLightboxState:G}),[W,X,ee,N,U,G]),x.createElement("div",{ref:L,className:jn(ae(a1()),ae(zm)),style:{...h===st.SWIPE?{[_t("swipe_offset")]:`${Math.round(b.current)}px`}:null,...h===st.PULL?{[_t("pull_offset")]:`${Math.round(S.current)}px`,[_t("pull_opacity")]:`${E.current}`}:null,...o.touchAction!=="none"?{[_t("controller_touch_action")]:o.touchAction}:null,...l.container},tabIndex:-1,...T},A&&x.createElement(o_.Provider,{value:uC},e,(n=s.controls)===null||n===void 0?void 0:n.call(s)))}const zL=Ir(D2,FL);function Lr(e){return ns(I2,e)}function s1(e){return ns(Nm,e)}function NL({slide:e,offset:t}){const n=x.useRef(null),{currentIndex:r,slides:i}=Dr(),{slideRect:o,focus:a}=rr(),{render:l,carousel:{imageFit:s,imageProps:u},on:{click:d},styles:{slide:c},labels:y}=Jt(),{getOwnerDocument:p}=kc(),m=t!==0;x.useEffect(()=>{var w;m&&(!((w=n.current)===null||w===void 0)&&w.contains(p().activeElement))&&a()},[m,a,p]);const g=()=>{var w,h,v,b;let S=(w=l.slide)===null||w===void 0?void 0:w.call(l,{slide:e,offset:t,rect:o});return!S&&So(e)&&(S=x.createElement(lu,{slide:e,offset:t,render:l,rect:o,imageFit:s,imageProps:u,onClick:m?void 0:()=>d==null?void 0:d({index:r})})),S?x.createElement(x.Fragment,null,(h=l.slideHeader)===null||h===void 0?void 0:h.call(l,{slide:e}),((v=l.slideContainer)!==null&&v!==void 0?v:({children:E})=>E)({slide:e,children:S}),(b=l.slideFooter)===null||b===void 0?void 0:b.call(l,{slide:e})):null};return x.createElement("div",{ref:n,className:jn(ae(s1()),!m&&ae(s1("current")),ae(zm)),...hL(m),style:c,role:"group","aria-roledescription":lo(y,"Slide"),"aria-label":sL(y,i,r+t)},g())}function BL(){const e=Jt().styles.slide;return x.createElement("div",{className:ae(Nm),style:e})}function VL({carousel:e,labels:t}){const{slides:n,currentIndex:r,globalIndex:i}=Dr(),{setCarouselRef:o}=rr(),{autoPlaying:a,focusWithin:l}=K2(),s=su(e.spacing),u=su(e.padding),d=fL(e,n,1),c=[];if(G2(n))for(let y=r-d;y<=r+d;y+=1){const p=q2(n,y),m=i-r+y,g=e.finite&&(y<0||y>n.length-1);c.push(g?{key:m}:{key:[`${m}`,cL(p)].filter(Boolean).join("|"),offset:y-r,slide:p})}return x.createElement("div",{ref:o,className:jn(ae(Lr()),c.length>0&&ae(Lr("with_slides"))),style:{[`${_t(Lr("slides_count"))}`]:c.length,[`${_t(Lr("spacing_px"))}`]:s.pixel||0,[`${_t(Lr("spacing_percent"))}`]:s.percent||0,[`${_t(Lr("padding_px"))}`]:u.pixel||0,[`${_t(Lr("padding_percent"))}`]:u.percent||0},role:"region","aria-live":a&&!l?"off":"polite","aria-roledescription":lo(t,"Carousel"),"aria-label":lo(t,"Photo gallery")},c.map(({key:y,slide:p,offset:m})=>p?x.createElement(NL,{key:y,slide:p,offset:m}):x.createElement(BL,{key:y})))}const UL=Ir(I2,VL);function a_(){const{carousel:e}=Jt(),{slides:t,currentIndex:n}=Dr(),r=t.length===0||e.finite&&n===0,i=t.length===0||e.finite&&n===t.length-1;return{prevDisabled:r,nextDisabled:i}}function WL(e){var t;const n=Qm(),{publish:r}=Pc(),{animation:i}=Jt(),{prevDisabled:o,nextDisabled:a}=a_(),l=((t=i.navigation)!==null&&t!==void 0?t:i.swipe)/2,s=o1(()=>r(Br),l),u=o1(()=>r(Vr),l),d=he(c=>{switch(c.key){case rL:r(so);break;case iL:(n?a:o)||(n?u:s)();break;case oL:(n?o:a)||(n?s:u)();break}});x.useEffect(()=>e(Bm,d),[e,d])}function l1({label:e,icon:t,renderIcon:n,action:r,onClick:i,disabled:o,style:a}){return x.createElement(Xm,{label:e,icon:t,renderIcon:n,className:ae(`navigation_${r}`),disabled:o,onClick:i,style:a,...$L(rr().focus,o)})}function HL({render:{buttonPrev:e,buttonNext:t,iconPrev:n,iconNext:r},styles:i}){const{prev:o,next:a,subscribeSensors:l}=rr(),{prevDisabled:s,nextDisabled:u}=a_();return WL(l),x.createElement(x.Fragment,null,e?e():x.createElement(l1,{label:"Previous",action:Br,icon:PL,renderIcon:n,style:i.navigationPrev,disabled:s,onClick:o}),t?t():x.createElement(l1,{label:"Next",action:Vr,icon:TL,renderIcon:r,style:i.navigationNext,disabled:u,onClick:a}))}const GL=Ir(Y6,HL),u1=ae(eL),qL=ae(R2);function YL(e){return"style"in e}function c1(e,t,n){const r=window.getComputedStyle(e),i=n?"padding-left":"padding-right",o=n?r.paddingLeft:r.paddingRight,a=e.style.getPropertyValue(i);return e.style.setProperty(i,`${(Ec(o)||0)+t}px`),()=>{a?e.style.setProperty(i,a):e.style.removeProperty(i)}}function XL({noScroll:{disabled:e},children:t}){const n=Qm(),{getOwnerDocument:r,getOwnerWindow:i}=kc();return x.useEffect(()=>{if(e)return()=>{};const o=[],a=i(),{body:l,documentElement:s}=r(),u=Math.round(a.innerWidth-s.clientWidth);if(u>0){o.push(c1(l,u,n));const d=l.getElementsByTagName("*");for(let c=0;c<d.length;c+=1){const y=d[c];YL(y)&&a.getComputedStyle(y).getPropertyValue("position")==="fixed"&&!y.classList.contains(qL)&&o.push(c1(y,u,n))}}return l.classList.add(u1),()=>{l.classList.remove(u1),o.forEach(d=>d())}},[n,e,r,i]),x.createElement(x.Fragment,null,t)}const KL=Ir(X6,XL);function d1(e){return ns(Fm,e)}function f1(e,t,n){const r=e.getAttribute(t);return e.setAttribute(t,n),()=>{r?e.setAttribute(t,r):e.removeAttribute(t)}}function QL({children:e,animation:t,styles:n,className:r,on:i,portal:o,close:a,labels:l}){const[s,u]=x.useState(!1),[d,c]=x.useState(!1),y=x.useRef([]),p=x.useRef(null),{setTimeout:m}=Tc(),{subscribe:g}=Pc(),h=Km()?0:t.fade;x.useEffect(()=>(u(!0),()=>{u(!1),c(!1)}),[]);const v=he(()=>{y.current.forEach(T=>T()),y.current=[]}),b=he(()=>{var T;c(!1),v(),(T=i.exiting)===null||T===void 0||T.call(i),m(()=>{var k;(k=i.exited)===null||k===void 0||k.call(i),a()},h)});x.useEffect(()=>g(so,b),[g,b]);const S=he(T=>{var k,C,M;mL(T),c(!0),(k=i.entering)===null||k===void 0||k.call(i);const $=(M=(C=T.parentNode)===null||C===void 0?void 0:C.children)!==null&&M!==void 0?M:[];for(let D=0;D<$.length;D+=1){const R=$[D];["TEMPLATE","SCRIPT","STYLE"].indexOf(R.tagName)===-1&&R!==T&&(y.current.push(f1(R,"inert","")),y.current.push(f1(R,"aria-hidden","true")))}y.current.push(()=>{var D,R;(R=(D=p.current)===null||D===void 0?void 0:D.focus)===null||R===void 0||R.call(D)}),m(()=>{var D;(D=i.entered)===null||D===void 0||D.call(i)},h)}),E=x.useCallback(T=>{T?S(T):v()},[S,v]);return s?Du.createPortal(x.createElement(DL,{ref:E,className:jn(r,ae(d1()),ae(R2),d&&ae(d1("open"))),"aria-modal":!0,role:"dialog","aria-label":lo(l,"Lightbox"),style:{...t.fade!==Wp.animation.fade?{[_t("fade_animation_duration")]:`${h}ms`}:null,...t.easing.fade!==Wp.animation.easing.fade?{[_t("fade_animation_timing_function")]:t.easing.fade}:null,...n.root},onFocus:T=>{p.current||(p.current=T.relatedTarget)}},e),o.root||document.body):null}const ZL=Ir(Fm,QL);function JL({children:e}){return x.createElement(x.Fragment,null,e)}const eR=Ir(K6,JL);function tR(e){return ns(L2,e)}function nR({toolbar:{buttons:e},render:{buttonClose:t,iconClose:n},styles:r}){const{close:i,setToolbarWidth:o}=rr(),{setContainerRef:a,containerRect:l}=r_();Mn(()=>{o(l==null?void 0:l.width)},[o,l==null?void 0:l.width]);const s=()=>t?t():x.createElement(Xm,{key:so,label:"Close",icon:kL,renderIcon:n,onClick:i});return x.createElement("div",{ref:a,style:r.toolbar,className:ae(tR())},e==null?void 0:e.map(u=>u===so?s():u))}const rR=Ir(L2,nR);function s_(e,t){var n;return x.createElement(e.module.component,{key:e.module.name,...t},(n=e.children)===null||n===void 0?void 0:n.map(r=>s_(r,t)))}function iR(e,t={}){const{easing:n,...r}=e,{easing:i,...o}=t;return{easing:{...n,...i},...r,...o}}function oR({carousel:e,animation:t,render:n,toolbar:r,controller:i,noScroll:o,on:a,plugins:l,slides:s,index:u,...d}){const{animation:c,carousel:y,render:p,toolbar:m,controller:g,noScroll:w,on:h,slides:v,index:b,plugins:S,...E}=Wp,{config:T,augmentation:k}=gL([He(ZL,[He(KL,[He(zL,[He(UL),He(rR),He(GL)])])])],l||S),C=k({animation:iR(c,t),carousel:{...y,...e},render:{...p,...n},toolbar:{...m,...r},controller:{...g,...i},noScroll:{...w,...o},on:{...h,...a},...E,...d});return C.open?x.createElement(bL,{...C},x.createElement(_L,{slides:s||v,index:Ec(u||b)},x.createElement(CL,null,x.createElement(xL,null,x.createElement(vL,null,s_(He(eR,T),C)))))):null}const aR={minZoom:1,maxZoomPixelRatio:1,zoomInMultiplier:2,doubleTapDelay:300,doubleClickDelay:500,doubleClickMaxStops:2,keyboardMoveDistance:50,wheelZoomDistanceFactor:100,pinchZoomDistanceFactor:100,pinchZoomV4:!1,scrollToZoom:!1};function sR(e){return Math.min(Math.max(e,Number.EPSILON),1)}function l_(e){const{minZoom:t,...n}={...aR,...e};return{minZoom:sR(t),...n}}function lR(e,t,n,r){const i=x.useRef(void 0),o=x.useRef(void 0),{zoom:a}=Jt().animation,l=Km(),s=he(()=>{var u,d,c;if((u=i.current)===null||u===void 0||u.cancel(),i.current=void 0,o.current&&(r!=null&&r.current)){try{i.current=(c=(d=r.current).animate)===null||c===void 0?void 0:c.call(d,[{transform:o.current},{transform:`scale(${e}) translateX(${t}px) translateY(${n}px)`}],{duration:l?0:a??500,easing:i.current?"ease-out":"ease-in-out"})}catch(y){console.error(y)}o.current=void 0,i.current&&(i.current.onfinish=()=>{i.current=void 0})}});return Mn(s,[e,t,n,s]),x.useCallback(()=>{o.current=r!=null&&r.current?window.getComputedStyle(r.current).transform:void 0},[r])}function uR(e,t){const{on:n}=Jt(),r=he(()=>{var i;t||(i=n.zoom)===null||i===void 0||i.call(n,{zoom:e})});x.useEffect(r,[e,r])}function Oc(){const{zoom:e}=Jt();return l_(e)}function cR(e,t){var n,r;let i={width:0,height:0},o={width:0,height:0};const{currentSlide:a}=Dr(),{imageFit:l}=Jt().carousel,{maxZoomPixelRatio:s}=Oc();if(e&&a){const d={...a,...t};if(So(d)){const c=qm(d,l),y=Math.max(...(((n=d.srcSet)===null||n===void 0?void 0:n.map(m=>m.width))||[]).concat(d.width?[d.width]:[])),p=Math.max(...(((r=d.srcSet)===null||r===void 0?void 0:r.map(m=>m.height))||[]).concat(d.height?[d.height]:[]));y>0&&p>0&&e.width>0&&e.height>0&&(o=c?{width:Math.round(Math.min(y,e.width/e.height*p)),height:Math.round(Math.min(p,e.height/e.width*y))}:{width:y,height:p},o={width:o.width*s,height:o.height*s},i=c?{width:Math.min(e.width,o.width,y),height:Math.min(e.height,o.height,p)}:{width:Math.round(Math.min(e.width,e.height/p*y,y)),height:Math.round(Math.min(e.height,e.width/y*p,p))})}}const u=i.width?Math.max(Gm(o.width/i.width,5),1):1;return{imageRect:i,maxZoom:u}}function p1(e,t){return Math.hypot(e.clientX-t.clientX,e.clientY-t.clientY)}function h1(e,t,n=100,r=2){return e*Math.min(1+Math.abs(t/n),r)**Math.sign(t)}function dR(e,t,n,r,i,o,a,l,s){const u=x.useRef([]),d=x.useRef(0),c=x.useRef(void 0),{globalIndex:y}=Dr(),{getOwnerWindow:p}=kc(),{containerRef:m,subscribeSensors:g}=rr(),{keyboardMoveDistance:w,zoomInMultiplier:h,wheelZoomDistanceFactor:v,scrollToZoom:b,doubleTapDelay:S,doubleClickDelay:E,doubleClickMaxStops:T,pinchZoomDistanceFactor:k,pinchZoomV4:C}=Oc(),M=x.useCallback(P=>{if(m.current){const{pageX:I,pageY:z}=P,{scrollX:B,scrollY:N}=p(),{left:U,top:G,width:W,height:X}=m.current.getBoundingClientRect();return[I-U-B-W/2,z-G-N-X/2]}return[]},[m,p]),$=he(P=>{const{key:I,metaKey:z,ctrlKey:B}=P,N=z||B,U=()=>{P.preventDefault(),P.stopPropagation()};if(e>1){const G=(W,X)=>{U(),l(W,X)};I==="ArrowDown"?G(0,w):I==="ArrowUp"?G(0,-w):I==="ArrowLeft"?G(-w,0):I==="ArrowRight"&&G(w,0)}I==="+"||N&&I==="="?(U(),i()):I==="-"||N&&I==="_"?(U(),o()):N&&I==="0"&&(U(),a(1))}),D=he(P=>{if((P.ctrlKey||b)&&Math.abs(P.deltaY)>Math.abs(P.deltaX)){P.stopPropagation(),a(h1(e,-P.deltaY,v),!0,...M(P));return}e>1&&(P.stopPropagation(),b||l(P.deltaX,P.deltaY))}),R=x.useCallback(P=>{const I=u.current;I.splice(0,I.length,...I.filter(z=>z.pointerId!==P.pointerId))},[]),j=x.useCallback(P=>{R(P),P.persist(),u.current.push(P)},[R]),F=he(P=>{var I;const z=u.current;if(P.pointerType==="mouse"&&P.buttons>1||!(!((I=s==null?void 0:s.current)===null||I===void 0)&&I.contains(P.target)))return;e>1&&P.stopPropagation();const{timeStamp:B}=P;if(z.length===0&&B-d.current<(P.pointerType==="touch"?S:E)){d.current=0;const N=e>=1?e!==n?e*Math.max(n**(1/T),h):1:e!==t?e/Math.max(t**(-1/T),h):1;a(N,!1,...M(P))}else d.current=B;if(j(P),z.length===2){const N=p1(z[0],z[1]);c.current={previousDistance:N,initialDistance:Math.max(N,1),initialZoom:e}}}),A=he(P=>{const I=u.current,z=I.find(B=>B.pointerId===P.pointerId);if(I.length===2&&c.current){P.stopPropagation(),j(P);const B=p1(I[0],I[1]),N=C?c.current.initialZoom/c.current.initialDistance*B:h1(e,B-c.current.previousDistance,k);a(N,!0,...I.map(U=>M(U)).reduce((U,G)=>G.map((W,X)=>U[X]+W/2))),c.current.previousDistance=B;return}e>1&&(P.stopPropagation(),z&&(I.length===1&&l((z.clientX-P.clientX)/e,(z.clientY-P.clientY)/e),j(P)))}),L=x.useCallback(P=>{const I=u.current;I.length===2&&I.find(z=>z.pointerId===P.pointerId)&&(c.current=void 0),R(P)},[R]),O=x.useCallback(()=>{const P=u.current;P.splice(0,P.length),d.current=0,c.current=void 0},[]);i_(g,F,A,L,r),x.useEffect(O,[y,O]),x.useEffect(()=>r?()=>{}:Wm(O,g(Bm,$),g(Vm,D)),[r,g,O,$,D])}function fR(e,t,n){const[r,i]=x.useState(1),[o,a]=x.useState(0),[l,s]=x.useState(0),u=lR(r,o,l,n),{currentSlide:d,globalIndex:c}=Dr(),{containerRect:y,slideRect:p}=rr(),{minZoom:m,zoomInMultiplier:g}=Oc(),w=d&&So(d)?d.src:void 0,h=!w||!(n!=null&&n.current);Mn(()=>{i(1),a(0),s(0)},[c,w]);const v=x.useCallback((k,C,M)=>{const $=M||r,D=o-(k||0),R=l-(C||0),j=(e.width*$-p.width)/2/$,F=(e.height*$-p.height)/2/$;a(Math.min(Math.abs(D),Math.max(j,0))*Math.sign(D)),s(Math.min(Math.abs(R),Math.max(F,0))*Math.sign(R))},[r,o,l,p,e.width,e.height]),b=x.useCallback((k,C,M,$)=>{const D=Gm(k+.01<t?k-.01>m?k:m:t,5);C||u(),v(M?M*(1/r-1/D):0,$?$*(1/r-1/D):0,D),i(D)},[r,m,t,v,u]),S=he(()=>{r>1&&(r>t&&b(t,!0),v())});Mn(S,[y.width,y.height,S]);const E=x.useCallback(()=>{const k=r*g;b(r<1&&k>1?1:k)},[r,g,b]),T=x.useCallback(()=>{const k=r/g;b(r>1&&k<1?1:k)},[r,g,b]);return{zoom:r,offsetX:o,offsetY:l,disabled:h,changeOffsets:v,changeZoom:b,zoomIn:E,zoomOut:T}}const u_=x.createContext(null),Zm=nr("useZoom","ZoomControllerContext",u_);function pR({children:e}){const[t,n]=x.useState(),{slideRect:r}=rr(),{ref:i,minZoom:o}=Oc(),{imageRect:a,maxZoom:l}=cR(r,t==null?void 0:t.imageDimensions),{zoom:s,offsetX:u,offsetY:d,disabled:c,changeZoom:y,changeOffsets:p,zoomIn:m,zoomOut:g}=fR(a,l,t==null?void 0:t.zoomWrapperRef);uR(s,c),dR(s,o,l,c,m,g,y,p,t==null?void 0:t.zoomWrapperRef);const w=x.useMemo(()=>({zoom:s,minZoom:o,maxZoom:l,offsetX:u,offsetY:d,disabled:c,zoomIn:m,zoomOut:g,changeZoom:y}),[s,o,l,u,d,c,m,g,y]);x.useImperativeHandle(i,()=>w,[w]);const h=x.useMemo(()=>({...w,setZoomWrapper:n}),[w,n]);return x.createElement(u_.Provider,{value:h},e)}const hR=ci("ZoomIn",x.createElement(x.Fragment,null,x.createElement("path",{d:"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"}),x.createElement("path",{d:"M12 10h-2v2H9v-2H7V9h2V7h1v2h2v1z"}))),mR=ci("ZoomOut",x.createElement("path",{d:"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zM7 9h5v1H7z"})),m1=x.forwardRef(function({zoomIn:t,onLoseFocus:n},r){const i=x.useRef(!1),o=x.useRef(!1),{zoom:a,minZoom:l,maxZoom:s,zoomIn:u,zoomOut:d,disabled:c}=Zm(),{render:y}=Jt(),p=c||(t?a>=s:a<=l);return x.useEffect(()=>{p&&i.current&&o.current&&n(),p||(i.current=!0)},[p,n]),x.createElement(Xm,{ref:r,disabled:p,label:t?"Zoom in":"Zoom out",icon:t?hR:mR,renderIcon:t?y.iconZoomIn:y.iconZoomOut,onClick:t?u:d,onFocus:()=>{o.current=!0},onBlur:()=>{o.current=!1}})});function gR(){const e=x.useRef(null),t=x.useRef(null),{focus:n}=rr(),r=x.useCallback(a=>{var l,s;!((l=a.current)===null||l===void 0)&&l.disabled?n():(s=a.current)===null||s===void 0||s.focus()},[n]),i=x.useCallback(()=>r(e),[r]),o=x.useCallback(()=>r(t),[r]);return x.createElement(x.Fragment,null,x.createElement(m1,{zoomIn:!0,ref:e,onLoseFocus:o}),x.createElement(m1,{ref:t,onLoseFocus:i}))}function vR(){const{render:e}=Jt(),t=Zm();return e.buttonZoom?x.createElement(x.Fragment,null,e.buttonZoom(t)):x.createElement(gR,null)}function yR(e){var t;return(((t=e.srcSet)===null||t===void 0?void 0:t.length)||0)>0}function xR({current:e,preload:t},{type:n,source:r}){switch(n){case"fetch":return e?{current:e,preload:r}:{current:r};case"done":return r===t?{current:r}:{current:e,preload:t};default:throw new Error(W2)}}function bR(e){var t,n;const[{current:r,preload:i},o]=x.useReducer(xR,{}),{slide:a,rect:l,imageFit:s,render:u,interactive:d}=e,c=a.srcSet.sort((E,T)=>E.width-T.width),y=(t=a.width)!==null&&t!==void 0?t:c[c.length-1].width,p=(n=a.height)!==null&&n!==void 0?n:c[c.length-1].height,m=qm(a,s),g=Math.max(...c.map(E=>E.width)),w=Math.min((m?Math.max:Math.min)(l.width,y*(l.height/p)),g),h=uL(),v=he(()=>{var E;const T=(E=c.find(k=>k.width>=w*h))!==null&&E!==void 0?E:c[c.length-1];(!r||c.findIndex(k=>k.src===r)<c.findIndex(k=>k===T))&&o({type:"fetch",source:T.src})});Mn(v,[l.width,l.height,h,v]);const b=he(E=>o({type:"done",source:E})),S={WebkitTransform:d?"initial":"translateZ(0)"};return m||Object.assign(S,l.width/l.height<y/p?{width:"100%",height:"auto"}:{width:"auto",height:"100%"}),x.createElement(x.Fragment,null,i&&i!==r&&x.createElement(lu,{key:"preload",...e,offset:void 0,slide:{...a,src:i,srcSet:void 0},style:{position:"absolute",visibility:"hidden",...S},onLoad:()=>b(i),render:{...u,iconLoading:()=>null,iconError:()=>null}}),r&&x.createElement(lu,{key:"current",...e,slide:{...a,src:r,srcSet:void 0},style:S}))}function wR({render:e,slide:t,offset:n,rect:r}){var i;const[o,a]=x.useState(),l=x.useRef(null),{zoom:s,maxZoom:u,offsetX:d,offsetY:c,setZoomWrapper:y}=Zm(),p=s>1,{carousel:m,on:g}=Jt(),{currentIndex:w}=Dr();Mn(()=>n===0?(y({zoomWrapperRef:l,imageDimensions:o}),()=>y(void 0)):()=>{},[n,o,y]);let h=(i=e.slide)===null||i===void 0?void 0:i.call(e,{slide:t,offset:n,rect:r,zoom:s,maxZoom:u});if(!h&&So(t)){const v={slide:t,offset:n,rect:r,render:e,imageFit:m.imageFit,imageProps:m.imageProps,onClick:n===0?()=>{var b;return(b=g.click)===null||b===void 0?void 0:b.call(g,{index:w})}:void 0};h=yR(t)?x.createElement(bR,{...v,slide:t,interactive:p,rect:n===0?{width:r.width*s,height:r.height*s}:r}):x.createElement(lu,{onLoad:b=>a({width:b.naturalWidth,height:b.naturalHeight}),...v})}return h?x.createElement("div",{ref:l,className:jn(ae(J6),ae(zm),ae(A2),p&&ae(tL)),style:n===0?{transform:`scale(${s}) translateX(${d}px) translateY(${c}px)`}:void 0},h):null}const SR=({augment:e,addModule:t})=>{e(({zoom:n,toolbar:r,render:i,controller:o,...a})=>{const l=l_(n);return{zoom:l,toolbar:dL(r,e1,x.createElement(vR,null)),render:{...i,slide:s=>{var u;return So(s.slide)?x.createElement(wR,{render:i,...s}):(u=i.slide)===null||u===void 0?void 0:u.call(i,s)}},controller:{...o,preventDefaultWheelY:l.scrollToZoom},...a}}),t(Ir(e1,pR))};var c_={exports:{}};(function(e,t){(function(n,r){e.exports=r()})(te,function(){var n=1e3,r=6e4,i=36e5,o="millisecond",a="second",l="minute",s="hour",u="day",d="week",c="month",y="quarter",p="year",m="date",g="Invalid Date",w=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,h=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,v={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(F){var A=["th","st","nd","rd"],L=F%100;return"["+F+(A[(L-20)%10]||A[L]||A[0])+"]"}},b=function(F,A,L){var O=String(F);return!O||O.length>=A?F:""+Array(A+1-O.length).join(L)+F},S={s:b,z:function(F){var A=-F.utcOffset(),L=Math.abs(A),O=Math.floor(L/60),P=L%60;return(A<=0?"+":"-")+b(O,2,"0")+":"+b(P,2,"0")},m:function F(A,L){if(A.date()<L.date())return-F(L,A);var O=12*(L.year()-A.year())+(L.month()-A.month()),P=A.clone().add(O,c),I=L-P<0,z=A.clone().add(O+(I?-1:1),c);return+(-(O+(L-P)/(I?P-z:z-P))||0)},a:function(F){return F<0?Math.ceil(F)||0:Math.floor(F)},p:function(F){return{M:c,y:p,w:d,d:u,D:m,h:s,m:l,s:a,ms:o,Q:y}[F]||String(F||"").toLowerCase().replace(/s$/,"")},u:function(F){return F===void 0}},E="en",T={};T[E]=v;var k="$isDayjsObject",C=function(F){return F instanceof R||!(!F||!F[k])},M=function F(A,L,O){var P;if(!A)return E;if(typeof A=="string"){var I=A.toLowerCase();T[I]&&(P=I),L&&(T[I]=L,P=I);var z=A.split("-");if(!P&&z.length>1)return F(z[0])}else{var B=A.name;T[B]=A,P=B}return!O&&P&&(E=P),P||!O&&E},$=function(F,A){if(C(F))return F.clone();var L=typeof A=="object"?A:{};return L.date=F,L.args=arguments,new R(L)},D=S;D.l=M,D.i=C,D.w=function(F,A){return $(F,{locale:A.$L,utc:A.$u,x:A.$x,$offset:A.$offset})};var R=function(){function F(L){this.$L=M(L.locale,null,!0),this.parse(L),this.$x=this.$x||L.x||{},this[k]=!0}var A=F.prototype;return A.parse=function(L){this.$d=function(O){var P=O.date,I=O.utc;if(P===null)return new Date(NaN);if(D.u(P))return new Date;if(P instanceof Date)return new Date(P);if(typeof P=="string"&&!/Z$/i.test(P)){var z=P.match(w);if(z){var B=z[2]-1||0,N=(z[7]||"0").substring(0,3);return I?new Date(Date.UTC(z[1],B,z[3]||1,z[4]||0,z[5]||0,z[6]||0,N)):new Date(z[1],B,z[3]||1,z[4]||0,z[5]||0,z[6]||0,N)}}return new Date(P)}(L),this.init()},A.init=function(){var L=this.$d;this.$y=L.getFullYear(),this.$M=L.getMonth(),this.$D=L.getDate(),this.$W=L.getDay(),this.$H=L.getHours(),this.$m=L.getMinutes(),this.$s=L.getSeconds(),this.$ms=L.getMilliseconds()},A.$utils=function(){return D},A.isValid=function(){return this.$d.toString()!==g},A.isSame=function(L,O){var P=$(L);return this.startOf(O)<=P&&P<=this.endOf(O)},A.isAfter=function(L,O){return $(L)<this.startOf(O)},A.isBefore=function(L,O){return this.endOf(O)<$(L)},A.$g=function(L,O,P){return D.u(L)?this[O]:this.set(P,L)},A.unix=function(){return Math.floor(this.valueOf()/1e3)},A.valueOf=function(){return this.$d.getTime()},A.startOf=function(L,O){var P=this,I=!!D.u(O)||O,z=D.p(L),B=function(we,ie){var Ie=D.w(P.$u?Date.UTC(P.$y,ie,we):new Date(P.$y,ie,we),P);return I?Ie:Ie.endOf(u)},N=function(we,ie){return D.w(P.toDate()[we].apply(P.toDate("s"),(I?[0,0,0,0]:[23,59,59,999]).slice(ie)),P)},U=this.$W,G=this.$M,W=this.$D,X="set"+(this.$u?"UTC":"");switch(z){case p:return I?B(1,0):B(31,11);case c:return I?B(1,G):B(0,G+1);case d:var ee=this.$locale().weekStart||0,pe=(U<ee?U+7:U)-ee;return B(I?W-pe:W+(6-pe),G);case u:case m:return N(X+"Hours",0);case s:return N(X+"Minutes",1);case l:return N(X+"Seconds",2);case a:return N(X+"Milliseconds",3);default:return this.clone()}},A.endOf=function(L){return this.startOf(L,!1)},A.$set=function(L,O){var P,I=D.p(L),z="set"+(this.$u?"UTC":""),B=(P={},P[u]=z+"Date",P[m]=z+"Date",P[c]=z+"Month",P[p]=z+"FullYear",P[s]=z+"Hours",P[l]=z+"Minutes",P[a]=z+"Seconds",P[o]=z+"Milliseconds",P)[I],N=I===u?this.$D+(O-this.$W):O;if(I===c||I===p){var U=this.clone().set(m,1);U.$d[B](N),U.init(),this.$d=U.set(m,Math.min(this.$D,U.daysInMonth())).$d}else B&&this.$d[B](N);return this.init(),this},A.set=function(L,O){return this.clone().$set(L,O)},A.get=function(L){return this[D.p(L)]()},A.add=function(L,O){var P,I=this;L=Number(L);var z=D.p(O),B=function(G){var W=$(I);return D.w(W.date(W.date()+Math.round(G*L)),I)};if(z===c)return this.set(c,this.$M+L);if(z===p)return this.set(p,this.$y+L);if(z===u)return B(1);if(z===d)return B(7);var N=(P={},P[l]=r,P[s]=i,P[a]=n,P)[z]||1,U=this.$d.getTime()+L*N;return D.w(U,this)},A.subtract=function(L,O){return this.add(-1*L,O)},A.format=function(L){var O=this,P=this.$locale();if(!this.isValid())return P.invalidDate||g;var I=L||"YYYY-MM-DDTHH:mm:ssZ",z=D.z(this),B=this.$H,N=this.$m,U=this.$M,G=P.weekdays,W=P.months,X=P.meridiem,ee=function(ie,Ie,Ue,We){return ie&&(ie[Ie]||ie(O,I))||Ue[Ie].slice(0,We)},pe=function(ie){return D.s(B%12||12,ie,"0")},we=X||function(ie,Ie,Ue){var We=ie<12?"AM":"PM";return Ue?We.toLowerCase():We};return I.replace(h,function(ie,Ie){return Ie||function(Ue){switch(Ue){case"YY":return String(O.$y).slice(-2);case"YYYY":return D.s(O.$y,4,"0");case"M":return U+1;case"MM":return D.s(U+1,2,"0");case"MMM":return ee(P.monthsShort,U,W,3);case"MMMM":return ee(W,U);case"D":return O.$D;case"DD":return D.s(O.$D,2,"0");case"d":return String(O.$W);case"dd":return ee(P.weekdaysMin,O.$W,G,2);case"ddd":return ee(P.weekdaysShort,O.$W,G,3);case"dddd":return G[O.$W];case"H":return String(B);case"HH":return D.s(B,2,"0");case"h":return pe(1);case"hh":return pe(2);case"a":return we(B,N,!0);case"A":return we(B,N,!1);case"m":return String(N);case"mm":return D.s(N,2,"0");case"s":return String(O.$s);case"ss":return D.s(O.$s,2,"0");case"SSS":return D.s(O.$ms,3,"0");case"Z":return z}return null}(ie)||z.replace(":","")})},A.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},A.diff=function(L,O,P){var I,z=this,B=D.p(O),N=$(L),U=(N.utcOffset()-this.utcOffset())*r,G=this-N,W=function(){return D.m(z,N)};switch(B){case p:I=W()/12;break;case c:I=W();break;case y:I=W()/3;break;case d:I=(G-U)/6048e5;break;case u:I=(G-U)/864e5;break;case s:I=G/i;break;case l:I=G/r;break;case a:I=G/n;break;default:I=G}return P?I:D.a(I)},A.daysInMonth=function(){return this.endOf(c).$D},A.$locale=function(){return T[this.$L]},A.locale=function(L,O){if(!L)return this.$L;var P=this.clone(),I=M(L,O,!0);return I&&(P.$L=I),P},A.clone=function(){return D.w(this.$d,this)},A.toDate=function(){return new Date(this.valueOf())},A.toJSON=function(){return this.isValid()?this.toISOString():null},A.toISOString=function(){return this.$d.toISOString()},A.toString=function(){return this.$d.toUTCString()},F}(),j=R.prototype;return $.prototype=j,[["$ms",o],["$s",a],["$m",l],["$H",s],["$W",u],["$M",c],["$y",p],["$D",m]].forEach(function(F){j[F[1]]=function(A){return this.$g(A,F[0],F[1])}}),$.extend=function(F,A){return F.$i||(F(A,R,$),F.$i=!0),$},$.locale=M,$.isDayjs=C,$.unix=function(F){return $(1e3*F)},$.en=T[E],$.Ls=T,$.p={},$})})(c_);var _R=c_.exports;const g1=Na(_R),CR=_.div`
  /* max-width: 800px; */
  margin: 20px auto;
...
`,cA=({item:e})=>{const t=In();return f.jsxs(uA,{children:[f.jsx("button",{onClick:()=>t(I4(e.id)),children:"-"}),f.jsx("span",{children:e.quantity}),f.jsx("button",{onClick:()=>t($4({id:e.id,stock:e.stock})),disabled:e.quantity>=e.stock,children:"+"})]})},dA=()=>{const e=In(),t=Zt(),[n,r]=x.useState([]),i=Xe(p=>p.cart.items),a=Xe(p=>p.cart.items).reduce((p,m)=>p+m.quantity,0),l=i.reduce((p,m)=>p+(m.new_price??m.price)*(m.quantity||1),0),s=Xe(p=>p.favorites.items),u=i.length===0,d=(p,m)=>{m.stopPropagation(),console.log(p);const g=s.some(w=>w.id===p.id);e(ui(p)),g?Y.warning(`${p.name} видалено з обраного`):Y.info(`${p.name} додано в обране`)},c=p=>{r(m=>[...m,p.id]),setTimeout(()=>{e(j4(p)),r(m=>m.filter(g=>g!==p.id))},300)},y=()=>{e(vm())};return f.jsx(f.Fragment,{children:u?f.jsx(lA,{}):f.jsxs(FR,{children:[f.jsx($r,{autoClose:1500}),f.jsxs(zR,{children:[" ",f.jsx(Pe,{to:"/",style:{color:"inherit",textDecoration:"none"},children:"Головна"})," ","/"," ",f.jsx(Pe,{to:"/cart",style:{color:"inherit",textDecoration:"none"},children:"Кошик"})]}),f.jsx(NR,{children:"Кошик"}),f.jsxs(BR,{children:[f.jsx(VR,{children:i.map((p,m)=>{var b,S;console.log(p);const g=s.some(E=>E.id===p.id),w=p.new_price&&p.new_price<p.price,h=w?p.new_price:p.price,v=w?Math.round((p.price-p.new_price)/p.price*100):0;return f.jsxs(UR,{className:n.includes(p.id)?"removing":"",children:[f.jsx(WR,{src:((S=(b=p.images)==null?void 0:b[0])==null?void 0:S.url)||"/nofoto.png",alt:p.name,onClick:()=>t(`/product/${p.id}`),onError:E=>{E.currentTarget.onerror=null,E.currentTarget.src=oo}}),f.jsx(HR,{children:f.jsx("h3",{children:p.name})}),f.jsxs(GR,{children:[f.jsx(cA,{item:{...p,quantity:p.quantity||1}}),f.jsx(jc,{children:f.jsxs(Mc,{children:[f.jsxs($c,{$discount:w,children:[(h*(p.quantity||1)).toLocaleString()," грн"]}),w&&f.jsxs(f.Fragment,{children:[f.jsxs(Ic,{children:[(p.price*(p.quantity||1)).toLocaleString()," грн"]}),f.jsxs(Dc,{children:["-",v,"%"]})]})]})})]}),f.jsxs(qR,{children:[f.jsx(XR,{onClick:E=>d(p,E),style:{background:"none",border:"none",cursor:"pointer",color:"#ccc"},children:f.jsx(Ya,{size:22,fill:g?"#ff4d4f":"none",color:g?"#ff4d4f":"#999"})}),f.jsx(YR,{onClick:()=>c(p),style:{background:"none",border:"none",cursor:"pointer",color:"#000000"},children:f.jsx(gw,{size:22})})]})]},`${p.id}-${m}`)})}),f.jsxs(KR,{children:[f.jsxs(QR,{children:[f.jsx("span",{children:"Всього в обраному:"}),f.jsxs("strong",{children:[a," шт."]}),f.jsx("span",{children:"На суму:"}),f.jsxs("strong",{children:[l," грн"]})]}),f.jsx(ZR,{to:"/checkout",children:"Оформити замовлення"}),f.jsx(JR,{onClick:y,children:"Oчистити кошик"})]})]})]})})},fA=_.div`
  color: var(-black-color);
  font-family: var(--main-font);
  width: 100%;
  max-width: 750px;
...
`,Dz=_.label`
  ...
  color: #666;
  margin-bottom: 5px;
`,Lz=({cityOptions:e,selectedCity:t,onChange:n,onInputChange:r})=>f.jsxs(Iz,{children:[f.jsx(Dz,{children:"Місто"}),f.jsx(Ac,{options:e,onInputChange:r,onChange:n,placeholder:"Почніть вводити місто...",value:t,noOptionsMessage:()=>"Введіть назву міста"})]}),Rz=_.div`
  margin-bottom: 15px;
  display: flex;
  flex-direction: column;
`,Az=_.label`
  ...
  color: #666;
  margin-bottom: 5px;
`,Fz=({options:e=[],value:t,onChange:n,selectedCity:r})=>f.jsxs(Rz,{children:[f.jsx(Az,{children:"Спосіб доставки"}),f.jsx(Ac,{options:e,placeholder:"Оберіть спосіб доставки...",isDisabled:!r,value:e.find(i=>i.value===t)||null,onChange:i=>n(i.value)})]}),W1=_.div`
  margin-bottom: 15px;
  display: flex;
  flex-direction: column;
`,H1=_.label`
...
`;const vN=({formData:e,setFormData:t,errors:n})=>{const r=i=>{const{name:o,value:a}=i.target;o==="phone"&&!a.startsWith("+38 (0")||t(l=>({...l,[o]:a}))};return f.jsxs(f.Fragment,{children:[f.jsx("h3",{children:"Контактні дані"}),f.jsxs(uf,{children:[f.jsx(cf,{children:"Прізвище та ім’я"}),f.jsx(df,{type:"text",name:"fullName",value:e.fullName,onChange:r,placeholder:"Прізвище Ім'я",autoComplete:"name"}),n.fullName&&f.jsx(ff,{children:n.fullName})]}),f.jsxs(uf,{children:[f.jsx(cf,{children:"Номер телефону"}),f.jsx(gN,{mask:"+38 (099) 999-99-99",maskChar:"_",name:"phone",autoComplete:"tel",value:e.phone,onChange:r,children:i=>f.jsx(df,{...i,type:"tel"})}),n.phone&&f.jsx(ff,{children:n.phone})]}),f.jsxs(uf,{children:[f.jsx(cf,{children:"E-mail"}),f.jsx(df,{type:"email",name:"email",value:e.email,onChange:r,placeholder:"email@example.com",autoComplete:"email"}),n.email&&f.jsx(ff,{children:n.email})]})]})},yN=_.div`
  width: 100%;
  max-width: 750px;
  padding-left: 10px;
  padding-right: 10px;
...
`,e7=()=>f.jsx(UN,{children:f.jsxs(WN,{children:[f.jsx(HN,{children:"Контакти"}),f.jsx(GN,{children:"Зв’яжіться з нами для консультації або замовлення"}),f.jsxs(qN,{children:[f.jsxs(YN,{children:[f.jsxs(Rs,{children:[f.jsx("h3",{children:"Адреса"}),f.jsx("p",{children:"вул. Казармена 6Г, Київ, Україна"}),f.jsx("a",{style:{color:"black",fontWeight:"500",fontSize:"0.9rem",display:"inline-block",marginTop:"5px",cursor:"pointer"},href:"https://www.google.com/maps/search/?api=1&query=вул.+Казармена+6Г,+Київ,+Україна",target:"_blank",rel:"noopener noreferrer",children:"📍 Показати на карті"})]}),f.jsxs(Rs,{children:[f.jsx("h3",{children:"Телефон"}),f.jsx("p",{children:"+38 (097) 123-45-67"})]}),f.jsxs(Rs,{children:[f.jsx("h3",{children:"Email"}),f.jsx("p",{children:"didivhliv.com"})]}),f.jsxs(Rs,{children:[f.jsx("h3",{children:"Графік роботи"}),f.jsx("p",{children:"З 11:00 - 20:00"}),f.jsx("p",{children:"Вихідні: Пн, Чт"})]})]}),f.jsxs(XN,{children:[f.jsx(KN,{children:"Ми в соцмережах"}),f.jsx(QN,{children:"Слідкуйте за нашими новинами, новими надходженнями та крутими вело-поїздками у зручному для вас форматі."}),f.jsxs(ZN,{children:[f.jsxs(J1,{href:"https://www.instagram.com/didivxliv?igsh=MXhsNWRjdW5rajYwdQ==",target:"_blank",rel:"noopener noreferrer",children:[f.jsx("svg",{width:"20px",children:f.jsx("use",{href:`${pn}#icon-instagram`})}),f.jsx("span",{children:"Instagram"})]}),f.jsxs(J1,{href:"https://t.me/didivxliv",target:"_blank",rel:"noopener noreferrer",children:[f.jsx("svg",{width:"20px",children:f.jsx("use",{href:`${pn}#icon-telegram`})}),f.jsx("span",{children:"Telegram"})]})]}),f.jsx(JN,{children:"Приєднуйся до спільноти!"})]})]})]})}),t7=_.section`
  background-color:  var(--second-background);
`,n7=_.div`
  display: flex;
  flex-direction: column;
...
`,P7=()=>{const[e,t]=x.useState([]),[n,r]=x.useState(!0),i=Xe(E=>E.favorites.items),o=Xe(E=>E.cart.items),[a,l]=x.useState(!1),[s,u]=x.useState("date"),[d,c]=x.useState("asc"),[y,p]=x.useState(1),[m,g]=x.useState(1),w=Zt(),h=In(),v=x.useRef(null);x.useEffect(()=>{const E=T=>{v.current&&!v.current.contains(T.target)&&l(!1)};return document.addEventListener("mousedown",E),()=>{document.removeEventListener("mousedown",E)}},[]),x.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[y]),x.useEffect(()=>{(async()=>{const T=new Date,k=new Date;k.setDate(T.getDate()-7);const C=k.toISOString();try{r(!0);const M=await fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[createdAt][$gte]=${C}&pagination[page]=${y}&pagination[pageSize]=24`);if(!M.ok)throw new Error(`HTTP error! Status: ${M.status}`);const $=await M.json();t($.data),g($.meta.pagination.pageCount)}catch(M){console.error("Помилка при завантаженні продуктів:",M)}finally{r(!1)}})()},[y]);const b=x.useMemo(()=>{const E=[...e],T=k=>k.new_price&&k.new_price<k.price?k.new_price:k.price;switch(s){case"name":return E.sort((k,C)=>d==="asc"?k.name.localeCompare(C.name):C.name.localeCompare(k.name));case"price":return E.sort((k,C)=>{const M=T(k),$=T(C);return d==="asc"?M-$:$-M});case"date":return E.sort((k,C)=>d==="asc"?new Date(k.createdAt)-new Date(C.createdAt):new Date(C.createdAt)-new Date(k.createdAt));default:return E}},[s,e,d]),S=(E,T)=>{T.stopPropagation();const k=i.some(C=>C.id===E.id);h(ui(E)),k?Y.warning(`${E.name} видалено з обраного`):Y.info(`${E.name} додано в обране`)};return n?f.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:f.jsx(Ja,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):b.length===0?f.jsxs(H_,{children:[f.jsx("p",{style:{textAlign:"center"},children:"Нажаль, нічого нового за останній тиждень"}),f.jsxs(G_,{to:"/catalog",children:[f.jsx("p",{children:"Весь каталог"}),f.jsx(Bu,{size:24})]})]}):f.jsxs(t7,{children:[f.jsxs(n7,{children:[f.jsx($r,{autoClose:1500}),f.jsxs(r7,{children:[f.jsx(i7,{children:"Нові товари "}),f.jsxs(d7,{ref:v,children:[f.jsxs(f7,{onClick:()=>l(E=>!E),children:["Сортування",f.jsx(Nu,{strokeWidth:.9,size:22})]}),a&&f.jsxs(p7,{children:[f.jsx(Si,{onClick:()=>{u("name"),c("asc"),l(!1)},children:"А-Я"}),f.jsx(Si,{onClick:()=>{u("name"),c("desc"),l(!1)},children:"Я-А"}),f.jsx(Si,{onClick:()=>{u("price"),c("asc"),l(!1)},children:"Ціна ↑"}),f.jsx(Si,{onClick:()=>{u("price"),c("desc"),l(!1)},children:"Ціна ↓"}),f.jsx(Si,{onClick:()=>{u("date"),c("desc"),l(!1)},children:"Спочатку новіші"}),f.jsx(Si,{onClick:()=>{u("date"),c("asc"),l(!1)},children:"Спочатку старіші"})]})]})]}),f.jsx(o7,{children:b.map(E=>{var A,L;const T=i.some(O=>O.id===E.id),k=(E==null?void 0:E.available)??!0,C=o.find(O=>O.id===E.id),$=(C?C.quantity:0)>=(E.stock||0),D=E.new_price&&E.new_price<E.price,R=D?E.new_price:E.price,j=D?Math.round((E.price-E.new_price)/E.price*100):0,F=(O,P)=>{if(P.stopPropagation(),$){Y.error("Товар уже у кошику");return}h(vo({...O,quantity:1})),Y.success(`${O.name} додано в кошик!`)};return f.jsxs(a7,{onClick:()=>w(`/product/${E.id}`),children:[!k&&f.jsx(ym,{children:"Заброньовано"}),f.jsx(s7,{src:((L=(A=E.images)==null?void 0:A[0])==null?void 0:L.url)||oo,alt:E.name}),f.jsx(u7,{children:E.name}),f.jsxs(l7,{children:[f.jsx(jc,{children:f.jsxs(Mc,{children:[f.jsxs($c,{$discount:D,children:[R.toLocaleString()," грн"]}),D&&f.jsxs(Ic,{children:[E.price.toLocaleString()," грн"]}),D&&f.jsxs(Dc,{children:["-",j,"%"]})]})}),f.jsxs(c7,{children:[k&&f.jsx(gu,{onClick:O=>F(E,O),children:f.jsx(go,{size:24,color:C?"var(--orange-color)":"black",strokeWidth:2})}),f.jsx(gu,{onClick:O=>S(E,O),children:f.jsx(Ya,{size:24,fill:T?"#ff4d4f":"none",color:T?"#ff4d4f":"#000000",strokeWidth:T?1:2})})]})]})]},E.id)})}),f.jsxs(W_,{children:[f.jsx(Hi,{onClick:()=>p(E=>Math.max(E-1,1)),disabled:y===1,children:"Назад"}),Array.from({length:m},(E,T)=>f.jsx(Hi,{onClick:()=>p(T+1),active:y===T+1,children:T+1},T)),f.jsx(Hi,{onClick:()=>p(E=>Math.min(E+1,m)),disabled:y===m,children:"Вперед"})]})]})," "]})},T7=()=>{const[e,t]=x.useState([]),[n,r]=x.useState(!0),[i,o]=x.useState(!1),[a,l]=x.useState("date"),[s,u]=x.useState("desc"),[d,c]=x.useState(1),y=24;console.log(i);const p=Zt(),m=In(),g=Xe(C=>C.favorites.items),w=Xe(C=>C.cart.items),h=x.useRef(null);x.useEffect(()=>{const C=M=>{h.current&&!h.current.contains(M.target)&&o(!1)};return document.addEventListener("mousedown",C),()=>{document.removeEventListener("mousedown",C)}},[]),x.useEffect(()=>{(async()=>{const M="https://backenddidiv-production.up.railway.app";try{const D=await(await fetch(`${M}/api/products?filters[new_price][$notNull]=true&pagination[pageSize]=500&populate=*`)).json();console.log(D.data),t(D.data),r(!1)}catch($){console.log($)}})()},[]),x.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[d]);const v=x.useMemo(()=>{const C=[...e];switch(a){case"name":return C.sort((M,$)=>s==="asc"?M.name.localeCompare($.name):$.name.localeCompare(M.name));case"price":return C.sort((M,$)=>s==="asc"?M.new_price-$.new_price:$.new_price-M.new_price);case"date":return C.sort((M,$)=>s==="asc"?new Date(M.createdAt)-new Date($.createdAt):new Date($.createdAt)-new Date(M.createdAt));default:return C}},[a,e,s]),b=d*y,S=b-y,E=v.slice(S,b),T=Math.ceil(e.length/y),k=(C,M)=>{M.stopPropagation();const $=g.some(D=>D.id===C.id);m(ui(C)),$?Y.warning(`${C.name} видалено з обраного`):Y.info(`${C.name} додано в обране`)};return n?f.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:f.jsx(Ja,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):e.length===0?f.jsxs(H_,{children:[f.jsx("p",{style:{textAlign:"center"},children:"Нажаль, поки знижок немає"}),f.jsxs(G_,{to:"/catalog",children:[f.jsx("p",{children:"Весь каталог"}),f.jsx(Bu,{size:24})]})]}):f.jsx(h7,{children:f.jsxs(m7,{children:[f.jsx($r,{autoClose:1500}),f.jsxs(g7,{children:[f.jsx(v7,{children:"Акційні товари"}),f.jsxs(C7,{ref:h,children:[f.jsxs(k7,{onClick:()=>o(C=>!C),children:["Сортування",f.jsx(Nu,{strokeWidth:.9,size:22})]}),i&&f.jsxs(E7,{children:[f.jsx(_i,{onClick:()=>{l("name"),u("asc"),o(!1)},children:"А-Я"}),f.jsx(_i,{onClick:()=>{l("name"),u("desc"),o(!1)},children:"Я-А"}),f.jsx(_i,{onClick:()=>{l("price"),u("asc"),o(!1)},children:"Ціна ↑"}),f.jsx(_i,{onClick:()=>{l("price"),u("desc"),o(!1)},children:"Ціна ↓"}),f.jsx(_i,{onClick:()=>{l("date"),u("desc"),o(!1)},children:"Спочатку новіші"}),f.jsx(_i,{onClick:()=>{l("date"),u("asc"),o(!1)},children:"Спочатку старіші"})]})]})]}),f.jsx(y7,{children:E.map(C=>{var P,I;const M=C.new_price&&C.new_price<C.price,$=M?C.new_price:C.price,D=(C==null?void 0:C.available)??!0,R=M?Math.round((C.price-C.new_price)/C.price*100):0,j=g.some(z=>z.id===C.id),F=w.find(z=>z.id===C.id),L=(F?F.quantity:0)>=(C.stock||0),O=(z,B)=>{if(B.stopPropagation(),L){Y.error("Товар уже у кошику");return}m(vo({...z,quantity:1})),Y.success(`${z.name} додано в кошик!`)};return f.jsxs(x7,{onClick:()=>p(`/product/${C.id}`),style:{cursor:"pointer"},children:[!D&&f.jsx(ym,{children:"Заброньовано"}),f.jsx(b7,{src:((I=(P=C.images)==null?void 0:P[0])==null?void 0:I.url)||"/nofoto.png"}),f.jsx(w7,{children:C.name}),f.jsxs(S7,{children:[f.jsx(jc,{children:f.jsxs(Mc,{children:[f.jsxs($c,{$discount:M,children:[$.toLocaleString()," грн"]}),M&&f.jsxs(Ic,{children:[C.price.toLocaleString()," грн"]}),M&&f.jsxs(Dc,{children:["-",R,"%"]})]})}),f.jsxs(_7,{children:[D&&f.jsx(gu,{onClick:z=>O(C,z),children:f.jsx(go,{size:24,color:F?"var(--orange-color)":"black",strokeWidth:2})}),f.jsx(gu,{onClick:z=>k(C,z),children:f.jsx(Ya,{size:24,fill:j?"#ff4d4f":"none",color:j?"#ff4d4f":"#000000",strokeWidth:j?1:2})})]})]})]},C.id)})}),v.length>y&&f.jsxs(W_,{children:[f.jsx(Hi,{onClick:()=>c(C=>Math.max(C-1,1)),disabled:d===1,children:"Назад"}),Array.from({length:T},(C,M)=>f.jsx(Hi,{onClick:()=>c(M+1),active:d===M+1,children:M+1},M)),f.jsx(Hi,{onClick:()=>c(C=>Math.min(C+1,T)),disabled:d===T,children:"Вперед"})]})]})})},O7=_.div`
  position: fixed;
  inset: 0;
...
`,A7=({isOpen:e,onClose:t,mode:n,setMode:r})=>{const[i,o]=x.useState(!1),[a,l]=x.useState(!1),[s,u]=x.useState({first_name:"",last_name:"",email:"",password:"",confirmPassword:""});if(console.log(s),x.useEffect(()=>{const m=g=>{g.key==="Escape"&&t()};return window.addEventListener("keydown",m),()=>window.removeEventListener("keydown",m)},[t]),!e)return null;const d=m=>{u(g=>({...g,[m.target.name]:m.target.value}))},c=m=>{m.target===m.currentTarget&&t()},y=async()=>{var w;const m=await fetch("https://backenddidiv-production.up.railway.app/api/auth/local",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({identifier:s.email,password:s.password})}),g=await m.json();if(!m.ok){alert(((w=g.error)==null?void 0:w.message)||"Помилка авторизації");return}localStorage.setItem("token",g.jwt),t()},p=async()=>{if(s.password!==s.confirmPassword){alert("Паролі не співпадають");return}const g=await(await fetch("https://backenddidiv-production.up.railway.app/api/auth/local/register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:s.first_name,first_name:s.first_name,last_name:s.last_name,email:s.email,password:s.password})})).json();localStorage.setItem("token",g.jwt),t()};return f.jsx(O7,{onClick:c,children:f.jsxs(j7,{children:[f.jsx(M7,{onClick:t,children:"×"}),f.jsx($7,{children:n==="login"?"Вхід":"Реєстрація"}),f.jsx(I7,{children:n==="login"?"Увійдіть до свого акаунта":"Створіть новий акаунт"}),f.jsxs(D7,{children:[f.jsx(ey,{active:n==="login",onClick:()=>r("login"),children:"Вхід"}),f.jsx(ey,{active:n==="register",onClick:()=>r("register"),children:"Реєстрація"})]}),n==="register"&&f.jsxs(f.Fragment,{children:[f.jsx(Vo,{name:"first_name",value:s.first_name,onChange:d,placeholder:"Ім'я"}),f.jsx(Vo,{name:"last_name",value:s.last_name,onChange:d,placeholder:"Прізвище"})]}),f.jsx(Vo,{name:"email",type:"email",value:s.email,onChange:d,placeholder:"Email"}),f.jsxs(ty,{children:[f.jsx(Vo,{name:"password",type:i?"text":"password",value:s.password,onChange:d,placeholder:"Пароль"}),f.jsx(ny,{type:"button",onClick:()=>o(m=>!m),children:i?f.jsx(G0,{size:20}):f.jsx(q0,{size:20})})]}),n==="register"&&f.jsxs(ty,{children:[f.jsx(Vo,{name:"confirmPassword",type:a?"text":"password",value:s.confirmPassword,onChange:d,placeholder:"Повторіть пароль"}),f.jsx(ny,{type:"button",onClick:()=>l(m=>!m),children:i?f.jsx(G0,{size:20}):f.jsx(q0,{size:20})})]}),f.jsx(L7,{onClick:n==="login"?y:p,children:n==="login"?"Увійти":"Зареєструватися"}),f.jsx(R7,{children:n==="login"?f.jsxs(f.Fragment,{children:["Немає акаунта?"," ",f.jsx("span",{onClick:()=>r("register"),children:"Зареєструватися"})]}):f.jsxs(f.Fragment,{children:["Вже є акаунт?"," ",f.jsx("span",{onClick:()=>r("login"),children:"Увійти"})]})})]})})},F7=({isLoggedIn:e,children:t})=>e?t:f.jsx(Iy,{to:"/",replace:!0}),z7=_.main`
 width: 100%;
  max-width: 750px;
  padding: 10px;
  margin: 0 auto;
...
`,D9=()=>{var s,u;const[e,t]=x.useState(!1),[n,r]=x.useState(""),[i,o]=x.useState("");x.useEffect(()=>{(async()=>{try{const c=localStorage.getItem("token"),p=await(await fetch("https://backenddidiv-production.up.railway.app/api/users/me",{headers:{Authorization:`Bearer ${c}`}})).json();r(p.first_name),o(p.email)}catch(c){console.error(c)}})()},[]);const l={"/account":"Особисті дані","/account/profile":"Особисті дані","/account/orders":"Замовлення","/account/favorites":"Обране","/account/password":"Змінити пароль"}[location.pathname]||"Особисті дані";return f.jsxs(P9,{children:[f.jsxs(T9,{children:[f.jsx(O9,{children:((u=(s=n||n)==null?void 0:s[0])==null?void 0:u.toUpperCase())||"?"}),f.jsxs("div",{children:[f.jsx(j9,{children:n}),f.jsx(M9,{children:i})]})]}),f.jsxs($9,{onClick:()=>t(d=>!d),children:[l,e?f.jsx(ij,{size:22}):f.jsx(nj,{size:22})]}),e&&f.jsxs(I9,{children:[f.jsx(Uo,{to:"/account/profile",onClick:()=>t(!1),children:"Особисті дані"}),f.jsx(Uo,{to:"/account/orders",onClick:()=>t(!1),children:"Замовлення"}),f.jsx(Uo,{to:"/account/favorites",onClick:()=>t(!1),children:"Обране"}),f.jsx(Uo,{to:"/account/password",onClick:()=>t(!1),children:"Змінити пароль"}),f.jsx(Uo,{to:"/",children:"Вийти"})]})]})},L9=()=>{const e=k9({maxWidth:767});return f.jsxs(z7,{className:"container",children:[e?f.jsx(D9,{}):f.jsx(G7,{}),f.jsx(N7,{children:f.jsx(Dy,{})})]})},R9=_.div`
  background: white;
  border-radius: 24px;
  padding: 24px;
