...
`,yd=T.div`
  font-size: 14px;
  color: #888;
`,kS=()=>y.jsxs(I5,{children:[y.jsxs(gd,{children:[y.jsx(vd,{children:"3000+"}),y.jsx(yd,{children:"Перевірених деталей"})]}),y.jsxs(gd,{children:[y.jsx(vd,{children:"6 років"}),y.jsx(yd,{children:"Досвіду на ринку"})]}),y.jsxs(gd,{children:[y.jsx(vd,{children:"100%"}),y.jsx(yd,{children:"Контроль якості"})]})]}),j5=Fe.div`
...
`,B$=T.div`
  ...
  gap: 15px;
  margin-bottom: 20px;
`,U$=T.span`color: #27ae60; font-size: 14px;`,H$=T.div`
  background: #fdfdfd;
...
`,I8=T.label`
  ...
  color: #666;
  margin-bottom: 5px;
`,j8=({options:e=[],value:t,onChange:n,selectedCity:r})=>y.jsxs(M8,{children:[y.jsx(I8,{children:"Спосіб доставки"}),y.jsx(Zl,{options:e,placeholder:"Оберіть спосіб доставки...",isDisabled:!r,value:e.find(i=>i.value===t)||null,onChange:i=>n(i.value)})]}),$d=T.div`
  margin-bottom: 15px;
  display: flex;
  flex-direction: column;
`,Dd=T.label`
