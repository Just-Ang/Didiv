 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,M){var N=P.length;P.push(M);e:for(;0<N;){var B=N-1>>>1,z=P[B];if(0<i(z,M))P[B]=M,P[N]=z,N=B;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var M=P[0],N=P.pop();if(N!==M){P[0]=N;e:for(var B=0,z=P.length,H=z>>>1;B<H;){var U=2*(B+1)-1,Y=P[U],X=U+1,ee=P[X];if(0>i(Y,N))X<z&&0>i(ee,Y)?(P[B]=ee,P[X]=N,B=X):(P[B]=Y,P[U]=N,B=U);else if(X<z&&0>i(ee,N))P[B]=ee,P[X]=N,B=X;else break e}}return M}function i(P,M){var N=P.sortIndex-M.sortIndex;return N!==0?N:P.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var s=[],u=[],c=1,d=null,m=3,p=!1,h=!1,v=!1,w=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(P){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=P)r(u),M.sortIndex=M.expirationTime,t(s,M);else break;M=n(u)}}function S(P){if(v=!1,x(P),!h)if(n(s)!==null)h=!0,F(E);else{var M=n(u);M!==null&&A(S,M.startTime-P)}}function E(P,M){h=!1,v&&(v=!1,f(C),C=-1),p=!0;var N=m;try{for(x(M),d=n(s);d!==null&&(!(d.expirationTime>M)||P&&!j());){var B=d.callback;if(typeof B=="function"){d.callback=null,m=d.priorityLevel;var z=B(d.expirationTime<=M);M=e.unstable_now(),typeof z=="function"?d.callback=z:d===n(s)&&r(s),x(M)}else r(s);d=n(s)}if(d!==null)var H=!0;else{var U=n(u);U!==null&&A(S,U.startTime-M),H=!1}return H}finally{d=null,m=N,p=!1}}var k=!1,_=null,C=-1,O=5,$=-1;function j(){return!(e.unstable_now()-$<O)}function I(){if(_!==null){var P=e.unstable_now();$=P;var M=!0;try{M=_(!0,P)}finally{M?D():(k=!1,_=null)}}else k=!1}var D;if(typeof g=="function")D=function(){g(I)};else if(typeof MessageChannel<"u"){var R=new MessageChannel,L=R.port2;R.port1.onmessage=I,D=function(){L.postMessage(null)}}else D=function(){w(I,0)};function F(P){_=P,k||(k=!0,D())}function A(P,M){C=w(function(){P(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){h||p||(h=!0,F(E))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):O=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(P){switch(m){case 1:case 2:case 3:var M=3;break;default:M=m}var N=m;m=M;try{return P()}finally{m=N}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,M){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var N=m;m=P;try{return M()}finally{m=N}},e.unstable_scheduleCallback=function(P,M,N){var B=e.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?B+N:B):N=B,P){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=N+z,P={id:c++,callback:M,priorityLevel:P,startTime:N,expirationTime:z,sortIndex:-1},N>B?(P.sortIndex=N,t(u,P),n(s)===null&&P===n(u)&&(v?(f(C),C=-1):v=!0,A(S,N-B))):(P.sortIndex=z,t(s,P),h||p||(h=!0,F(E))),P},e.unstable_shouldYield=j,e.unstable_wrapCallback=function(P){var M=m;return function(){var N=m;m=M;try{return P.apply(this,arguments)}finally{m=N}}}})(U1);H1.exports=U1;var SE=H1.exports;/**
 * @license React
...
`,OS=({childValues:e,onChange:t})=>{const o=(e==null?void 0:e[0])??10,a=(e==null?void 0:e[1])??1e4,l=o!==a,[s,u]=b.useState([o,a]);b.useEffect(()=>{e&&e.length===2&&(u(e),t&&t(e))},[e,t]);const c=p=>{u(p),t&&t(p)},d=(p,h)=>{const v=h===""?"":Number(h),w=[...s];w[p]=v,c(w)},m=p=>{const h=[...s];p===0?((h[0]===""||h[0]<o)&&(h[0]=o),h[0]>h[1]-50&&(h[0]=h[1]-50)):((h[1]===""||h[1]>a)&&(h[1]=a),h[1]<h[0]+50&&(h[1]=h[0]+50)),c(h)};return y.jsx(y.Fragment,{children:l&&y.jsxs(bj,{children:[y.jsxs(wj,{children:[y.jsx(mv,{type:"number",value:s[0],min:o,max:s[1],onChange:p=>d(0,p.target.value),onBlur:()=>m(0)}),y.jsx(mv,{type:"number",value:s[1],min:s[0],max:a,onChange:p=>d(1,p.target.value),onBlur:()=>m(1)})]}),y.jsx(gp.Range,{values:s,step:50,min:o,max:a,onChange:c,renderTrack:({props:p,children:h})=>y.jsx(Sj,{...p,background:gp.getTrackBackground({values:s,colors:["#ddd","#85683d","#ddd"],min:o,max:a}),children:h}),renderThumb:({props:p})=>y.jsx(_j,{...p})})]})})},Ej=({childValues:e,category:t,selectedFilters:n,setSelectedFilters:r,setPriceRange:i})=>{const[o,a]=b.useState([]);b.useEffect(()=>{t&&(async()=>{try{const h=await fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[category][title][$eq]=${encodeURIComponent(t)}&pagination[pageSize]=200`);console.log(t);const v=await h.json();console.log("dataaaa",v.data);const w=v.data||[],f={};w.forEach(x=>{var S;(S=x.attributes)==null||S.forEach(E=>{f[E.label]||(f[E.label]=new Set),f[E.label].add(E.value)})});const g=Object.entries(f).map(([x,S])=>({type:"checkbox",label:x,name:x.toLowerCase(),options:Array.from(S)}));console.log("fillltr",g),a(g)}catch(h){console.error(h)}})()},[t]);const[l,s]=b.useState({}),u=p=>{s(h=>({...h,[p]:!h[p]}))},c=(p,h)=>{r(v=>{const w=v[p]||[];return w.includes(h)?{...v,[p]:w.filter(f=>f!==h)}:{...v,[p]:[...w,h]}})},d=Object.values(n).some(p=>Array.isArray(p)&&p.length>0),m=()=>{d&&r({})};return console.log(d),y.jsxs(ij,{children:[y.jsxs(oj,{children:["Фільтри ",y.jsx(wb,{size:20})]}),(o||[]).map(p=>{var v;const h=!!l[p.name];return y.jsxs(aj,{children:[y.jsxs(sj,{onClick:()=>u(p.name),children:[y.jsx(lj,{children:p.label}),y.jsx(uj,{isOpen:h})]}),y.jsxs(cj,{isOpen:h,children:[p.type==="checkbox"&&((v=p.options)==null?void 0:v.map(w=>{var f;return y.jsxs(dj,{children:[y.jsx(mp,{checked:((f=n[p.name])==null?void 0:f.includes(w))||!1,onChange:()=>c(p.name,w)}),y.jsx(fj,{}),w]},w)})),p.type==="range"&&y.jsx(OS,{onChange:i,childValues:e})]})]},p.name)}),y.jsx(PS,{onClick:m,disabled:!d,children:"Скинути обрані фільтри"})]})},Cj=T.aside`
  width: 100%;
  max-width: 400px;
  background: #ffffff;
  padding: 20px;
...
`,jj=({childValues:e,category:t,selectedFilters:n,setSelectedFilters:r,setPriceRange:i})=>{const[o,a]=b.useState({}),[l,s]=b.useState([]);b.useEffect(()=>{t&&(async()=>{var m;try{const v=((m=(await(await fetch(`https://backenddidiv-production.up.railway.app/api/categories?filters[title][$eq]=${t}&populate=filters`)).json()).data[0])==null?void 0:m.filters)||[];s(v)}catch(p){console.error(p)}})()},[t]);const u=d=>{a(m=>({...m,[d]:!m[d]}))},c=(d,m)=>{r(p=>{const h=p[d]||[];return h.includes(m)?{...p,[d]:h.filter(v=>v!==m)}:{...p,[d]:[...h,m]}})};return y.jsx(Cj,{children:(l||[]).map(d=>{var p;const m=!!o[d.name];return y.jsxs(kj,{children:[y.jsxs(Tj,{onClick:()=>u(d.name),children:[y.jsx(Pj,{children:d.label}),y.jsx(Oj,{isOpen:m})]}),y.jsxs(Mj,{isOpen:m,children:[d.type==="checkbox"&&((p=d.options)==null?void 0:p.map(h=>{var v;return y.jsxs($j,{children:[y.jsx(vp,{checked:((v=n[d.name])==null?void 0:v.includes(h))||!1,onChange:()=>c(d.name,h)}),y.jsx(Ij,{}),h]},h)})),d.type==="range"&&y.jsx(OS,{onChange:i,childValues:e})]})]},d.name)})})},Dj=T.div`
`,Lj=T.h2`
  text-align: center;
  font-size:34px;
  font-weight:600px;
...
`,_R=({item:e})=>{const t=ri();return y.jsxs(SR,{children:[y.jsx("button",{onClick:()=>t(oI(e.id)),children:"-"}),y.jsx("span",{children:e.quantity}),y.jsx("button",{onClick:()=>t(iI({id:e.id,stock:e.stock})),disabled:e.quantity>=e.stock,children:"+"})]})},ER=()=>{const e=ri(),[t,n]=b.useState([]),r=Dt(m=>m.cart.items),o=Dt(m=>m.cart.items).reduce((m,p)=>m+p.quantity,0),a=r.reduce((m,p)=>m+p.price*(p.quantity||1),0),l=Dt(m=>m.favorites.items),s=r.length===0,u=(m,p)=>{p.stopPropagation(),console.log(m);const h=l.some(v=>v.id===m.id);e(Ba(m)),h?J.warning(`${m.name} видалено з обраного`):J.info(`${m.name} додано в обране`)},c=m=>{n(p=>[...p,m.id]),setTimeout(()=>{e(tI(m)),n(p=>p.filter(h=>h!==m.id))},300)},d=()=>{e(nI())};return y.jsx(y.Fragment,{children:s?y.jsx(wR,{}):y.jsxs(QL,{children:[y.jsx(oo,{autoClose:1500}),y.jsxs(JL,{children:[" ",y.jsx(Me,{to:"/",style:{color:"inherit",textDecoration:"none"},children:"Головна"})," ","/"," ",y.jsx(Me,{to:"/cart",style:{color:"inherit",textDecoration:"none"},children:"Кошик"})]}),y.jsx(eR,{children:"Кошик"}),y.jsxs(tR,{children:[y.jsx(nR,{children:r.map((m,p)=>{var v,w;console.log(m);const h=l.some(f=>f.id===m.id);return y.jsxs(rR,{className:t.includes(m.id)?"removing":"",children:[y.jsx(iR,{src:((w=(v=m.images)==null?void 0:v[0])==null?void 0:w.url)||"/nofoto.png",alt:m.name,onError:f=>{f.currentTarget.onerror=null,f.currentTarget.src=_a}}),y.jsx(oR,{children:y.jsx("h3",{children:m.name})}),y.jsxs(aR,{children:[y.jsx(_R,{item:{...m,quantity:m.quantity||1}}),y.jsx(lR,{children:y.jsxs("div",{className:"current-price",children:[(m.price*(m.quantity||1)).toLocaleString()," грн"]})})]}),y.jsxs(sR,{children:[y.jsx(cR,{onClick:f=>u(m,f),style:{background:"none",border:"none",cursor:"pointer",color:"#ccc"},children:y.jsx(zh,{size:22,fill:h?"#ff4d4f":"none",color:h?"#ff4d4f":"#999"})}),y.jsx(uR,{onClick:()=>c(m),style:{background:"none",border:"none",cursor:"pointer",color:"#000000"},children:y.jsx(Sb,{size:22})})]})]},`${m.id}-${p}`)})}),y.jsxs(dR,{children:[y.jsxs(fR,{children:[y.jsx("span",{children:"Всього в обраному:"}),y.jsxs("strong",{children:[o," шт."]}),y.jsx("span",{children:"На суму:"}),y.jsxs("strong",{children:[a," грн"]})]}),y.jsx(pR,{to:"/checkout",children:"Оформити замовлення"}),y.jsx(hR,{onClick:d,children:"Oчистити кошик"})]})]})]})})},CR=T.div`
  color: var(-black-color);
  font-family: var(--main-font);
  width: 100%;
  max-width: 750px;
