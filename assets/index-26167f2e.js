 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var lm=A3,lo=60103,Tw=60106;le.Fragment=60107;le.StrictMode=60108;le.Profiler=60114;var Pw=60109,Ow=60110,Mw=60112;le.Suspense=60113;var jw=60115,$w=60116;if(typeof Symbol=="function"&&Symbol.for){var Qt=Symbol.for;lo=Qt("react.element"),Tw=Qt("react.portal"),le.Fragment=Qt("react.fragment"),le.StrictMode=Qt("react.strict_mode"),le.Profiler=Qt("react.profiler"),Pw=Qt("react.provider"),Ow=Qt("react.context"),Mw=Qt("react.forward_ref"),le.Suspense=Qt("react.suspense"),jw=Qt("react.memo"),$w=Qt("react.lazy")}var G0=typeof Symbol=="function"&&Symbol.iterator;function R3(e){return e===null||typeof e!="object"?null:(e=G0&&e[G0]||e["@@iterator"],typeof e=="function"?e:null)}function Ha(e){for(var t="https://reactjs.org/docs/error-decoder.html?invariant="+e,n=1;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var Iw={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Dw={};function uo(e,t,n){this.props=e,this.context=t,this.refs=Dw,this.updater=n||Iw}uo.prototype.isReactComponent={};uo.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error(Ha(85));this.updater.enqueueSetState(this,e,t,"setState")};uo.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function Lw(){}Lw.prototype=uo.prototype;function um(e,t,n){this.props=e,this.context=t,this.refs=Dw,this.updater=n||Iw}var cm=um.prototype=new Lw;cm.constructor=um;lm(cm,uo.prototype);cm.isPureReactComponent=!0;var dm={current:null},Aw=Object.prototype.hasOwnProperty,Rw={key:!0,ref:!0,__self:!0,__source:!0};function Fw(e,t,n){var r,i={},o=null,a=null;if(t!=null)for(r in t.ref!==void 0&&(a=t.ref),t.key!==void 0&&(o=""+t.key),t)Aw.call(t,r)&&!Rw.hasOwnProperty(r)&&(i[r]=t[r]);var l=arguments.length-2;if(l===1)i.children=n;else if(1<l){for(var s=Array(l),u=0;u<l;u++)s[u]=arguments[u+2];i.children=s}if(e&&e.defaultProps)for(r in l=e.defaultProps,l)i[r]===void 0&&(i[r]=l[r]);return{$$typeof:lo,type:e,key:o,ref:a,props:i,_owner:dm.current}}function F3(e,t){return{$$typeof:lo,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function fm(e){return typeof e=="object"&&e!==null&&e.$$typeof===lo}function N3(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var Y0=/\/+/g;function ld(e,t){return typeof e=="object"&&e!==null&&e.key!=null?N3(""+e.key):t.toString(36)}function Ks(e,t,n,r,i){var o=typeof e;(o==="undefined"||o==="boolean")&&(e=null);var a=!1;if(e===null)a=!0;else switch(o){case"string":case"number":a=!0;break;case"object":switch(e.$$typeof){case lo:case Tw:a=!0}}if(a)return a=e,i=i(a),e=r===""?"."+ld(a,0):r,Array.isArray(i)?(n="",e!=null&&(n=e.replace(Y0,"$&/")+"/"),Ks(i,t,n,"",function(u){return u})):i!=null&&(fm(i)&&(i=F3(i,n+(!i.key||a&&a.key===i.key?"":(""+i.key).replace(Y0,"$&/")+"/")+e)),t.push(i)),1;if(a=0,r=r===""?".":r+":",Array.isArray(e))for(var l=0;l<e.length;l++){o=e[l];var s=r+ld(o,l);a+=Ks(o,t,n,s,i)}else if(s=R3(e),typeof s=="function")for(e=s.call(e),l=0;!(o=e.next()).done;)o=o.value,s=r+ld(o,l++),a+=Ks(o,t,n,s,i);else if(o==="object")throw t=""+e,Error(Ha(31,t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t));return a}function ys(e,t,n){if(e==null)return e;var r=[],i=0;return Ks(e,r,"","",function(o){return t.call(n,o,i++)}),r}function z3(e){if(e._status===-1){var t=e._result;t=t(),e._status=0,e._result=t,t.then(function(n){e._status===0&&(n=n.default,e._status=1,e._result=n)},function(n){e._status===0&&(e._status=2,e._result=n)})}if(e._status===1)return e._result;throw e._result}var Nw={current:null};function Zn(){var e=Nw.current;if(e===null)throw Error(Ha(321));return e}var B3={ReactCurrentDispatcher:Nw,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:dm,IsSomeRendererActing:{current:!1},assign:lm};le.Children={map:ys,forEach:function(e,t,n){ys(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return ys(e,function(){t++}),t},toArray:function(e){return ys(e,function(t){return t})||[]},only:function(e){if(!fm(e))throw Error(Ha(143));return e}};le.Component=uo;le.PureComponent=um;le.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=B3;le.cloneElement=function(e,t,n){if(e==null)throw Error(Ha(267,e));var r=lm({},e.props),i=e.key,o=e.ref,a=e._owner;if(t!=null){if(t.ref!==void 0&&(o=t.ref,a=dm.current),t.key!==void 0&&(i=""+t.key),e.type&&e.type.defaultProps)var l=e.type.defaultProps;for(s in t)Aw.call(t,s)&&!Rw.hasOwnProperty(s)&&(r[s]=t[s]===void 0&&l!==void 0?l[s]:t[s])}var s=arguments.length-2;if(s===1)r.children=n;else if(1<s){l=Array(s);for(var u=0;u<s;u++)l[u]=arguments[u+2];r.children=l}return{$$typeof:lo,type:e.type,key:i,ref:o,props:r,_owner:a}};le.createContext=function(e,t){return t===void 0&&(t=null),e={$$typeof:Ow,_calculateChangedBits:t,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null},e.Provider={$$typeof:Pw,_context:e},e.Consumer=e};le.createElement=Fw;le.createFactory=function(e){var t=Fw.bind(null,e);return t.type=e,t};le.createRef=function(){return{current:null}};le.forwardRef=function(e){return{$$typeof:Mw,render:e}};le.isValidElement=fm;le.lazy=function(e){return{$$typeof:$w,_payload:{_status:-1,_result:e},_init:z3}};le.memo=function(e,t){return{$$typeof:jw,type:e,compare:t===void 0?null:t}};le.useCallback=function(e,t){return Zn().useCallback(e,t)};le.useContext=function(e,t){return Zn().useContext(e,t)};le.useDebugValue=function(){};le.useEffect=function(e,t){return Zn().useEffect(e,t)};le.useImperativeHandle=function(e,t,n){return Zn().useImperativeHandle(e,t,n)};le.useLayoutEffect=function(e,t){return Zn().useLayoutEffect(e,t)};le.useMemo=function(e,t){return Zn().useMemo(e,t)};le.useReducer=function(e,t,n){return Zn().useReducer(e,t,n)};le.useRef=function(e){return Zn().useRef(e)};le.useState=function(e){return Zn().useState(e)};le.version="17.0.2";kw.exports=le;var V3=kw.exports;/** @license React v17.0.2
 * react-jsx-runtime.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
...
`,ZA=({item:e})=>{const t=Qn();return h.jsxs(QA,{children:[h.jsx("button",{onClick:()=>t(w4(e.id)),children:"-"}),h.jsx("span",{children:e.quantity}),h.jsx("button",{onClick:()=>t(b4({id:e.id,stock:e.stock})),disabled:e.quantity>=e.stock,children:"+"})]})},JA=()=>{const e=Qn(),t=Xn(),[n,r]=b.useState([]),i=Et(f=>f.cart.items),a=Et(f=>f.cart.items).reduce((f,m)=>f+m.quantity,0),l=i.reduce((f,m)=>f+m.price*(m.quantity||1),0),s=Et(f=>f.favorites.items),u=i.length===0,d=(f,m)=>{m.stopPropagation(),console.log(f);const v=s.some(w=>w.id===f.id);e(Wa(f)),v?J.warning(`${f.name} видалено з обраного`):J.info(`${f.name} додано в обране`)},c=f=>{r(m=>[...m,f.id]),setTimeout(()=>{e(y4(f)),r(m=>m.filter(v=>v!==f.id))},300)},y=()=>{e(Qh())};return h.jsx(h.Fragment,{children:u?h.jsx(KA,{}):h.jsxs(TA,{children:[h.jsx(oi,{autoClose:1500}),h.jsxs(PA,{children:[" ",h.jsx(Oe,{to:"/",style:{color:"inherit",textDecoration:"none"},children:"Головна"})," ","/"," ",h.jsx(Oe,{to:"/cart",style:{color:"inherit",textDecoration:"none"},children:"Кошик"})]}),h.jsx(OA,{children:"Кошик"}),h.jsxs(MA,{children:[h.jsx(jA,{children:i.map((f,m)=>{var w,p;console.log(f);const v=s.some(g=>g.id===f.id);return h.jsxs($A,{className:n.includes(f.id)?"removing":"",children:[h.jsx(IA,{src:((p=(w=f.images)==null?void 0:w[0])==null?void 0:p.url)||"/nofoto.png",alt:f.name,onClick:()=>t(`/product/${f.id}`),onError:g=>{g.currentTarget.onerror=null,g.currentTarget.src=Ca}}),h.jsx(DA,{children:h.jsx("h3",{children:f.name})}),h.jsxs(LA,{children:[h.jsx(ZA,{item:{...f,quantity:f.quantity||1}}),h.jsx(RA,{children:h.jsxs("div",{className:"current-price",children:[(f.price*(f.quantity||1)).toLocaleString()," грн"]})})]}),h.jsxs(AA,{children:[h.jsx(NA,{onClick:g=>d(f,g),style:{background:"none",border:"none",cursor:"pointer",color:"#ccc"},children:h.jsx(Wh,{size:22,fill:v?"#ff4d4f":"none",color:v?"#ff4d4f":"#999"})}),h.jsx(FA,{onClick:()=>c(f),style:{background:"none",border:"none",cursor:"pointer",color:"#000000"},children:h.jsx(Db,{size:22})})]})]},`${f.id}-${m}`)})}),h.jsxs(zA,{children:[h.jsxs(BA,{children:[h.jsx("span",{children:"Всього в обраному:"}),h.jsxs("strong",{children:[a," шт."]}),h.jsx("span",{children:"На суму:"}),h.jsxs("strong",{children:[l," грн"]})]}),h.jsx(VA,{to:"/checkout",children:"Оформити замовлення"}),h.jsx(UA,{onClick:y,children:"Oчистити кошик"})]})]})]})})},eR=k.div`
  color: var(-black-color);
  font-family: var(--main-font);
  width: 100%;
  max-width: 750px;
