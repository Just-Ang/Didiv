...
`,NO=()=>f.jsxs(zO,{children:[f.jsx(gi,{to:"/",children:"Головна"}),f.jsx(gi,{to:"/catalog",children:"Каталог"}),f.jsx(gi,{to:"/catalog/new",children:"Новинки"}),f.jsx(gi,{to:"/catalog/sale",children:"Акційні товари"}),f.jsx(gi,{to:"/about",children:"Про нас"}),f.jsx(gi,{to:"/contacts",children:"Контакти"})]}),BO=_.svg`
  width: 24px;
  height: 24px;
  fill: var(--white-color);
`,VO=_(Pe)`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _j=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],vw=Ke("x",_j),Cj=({openLogin:e})=>{const[t,n]=x.useState(!1),r=Zt(),i=()=>{const o=localStorage.getItem("token");console.log("token:",o),o?(console.log("navigate"),r("/account")):(console.log("login"),e())};return f.jsx(zT,{children:f.jsx(NT,{children:f.jsxs(BT,{children:[f.jsxs(VT,{children:[f.jsx(HT,{to:"/",children:"Дідів хлів"}),f.jsxs(UT,{children:[f.jsx(FO,{}),f.jsx(WT,{onClick:i,children:f.jsx(Sj,{size:28,color:"#f2ebd4",strokeWidth:1.9})}),f.jsx(HO,{}),f.jsx(NO,{}),f.jsx(qT,{onClick:()=>n(!t),children:f.jsx(GT,{children:f.jsx("use",{href:`${pn}#icon-menu`})})}),f.jsx(ZT,{open:t,onClick:()=>n(!1)}),f.jsxs(YT,{open:t,children:[f.jsx(XT,{onClick:()=>n(!1),children:f.jsx(vw,{size:28,strokeWidth:1.5})}),f.jsxs(KT,{children:[f.jsxs(mi,{onClick:()=>n(!1),to:"/",children:[f.jsx(uj,{size:22,strokeWidth:1.5})," Головна"]}),f.jsxs(mi,{onClick:()=>n(!1),to:"/catalog",children:[f.jsx(vj,{size:22,strokeWidth:1.5})," Каталог"]}),f.jsxs(mi,{onClick:()=>n(!1),to:"/catalog/new",children:[f.jsx(pj,{size:22,strokeWidth:1.5}),"Новинки"]}),f.jsxs(mi,{onClick:()=>n(!1),to:"/catalog/sale",children:[f.jsx(ej,{size:22,strokeWidth:1.5}),"Акційні товари"]}),f.jsxs(mi,{onClick:()=>n(!1),to:"/about",children:[f.jsx(dj,{size:22,strokeWidth:1.5})," Про нас"]}),f.jsxs(mi,{onClick:()=>n(!1),to:"/contacts",children:[f.jsx(mj,{size:22,strokeWidth:1.5})," Контакти"]})]}),f.jsx(QT,{children:f.jsx("p",{children:"© 2020 Дідів Хлів"})})]})]})]}),f.jsx(uO,{})]})})})},Ej=_.div`
