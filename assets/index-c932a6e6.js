 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,M){var R=P.length;P.push(M);e:for(;0<R;){var B=R-1>>>1,N=P[B];if(0<i(N,M))P[B]=M,P[R]=N,R=B;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var M=P[0],R=P.pop();if(R!==M){P[0]=R;e:for(var B=0,N=P.length,U=N>>>1;B<U;){var G=2*(B+1)-1,W=P[G],H=G+1,ee=P[H];if(0>i(W,R))H<N&&0>i(ee,W)?(P[B]=ee,P[H]=R,B=H):(P[B]=W,P[G]=R,B=G);else if(H<N&&0>i(ee,R))P[B]=ee,P[H]=R,B=H;else break e}}return M}function i(P,M){var R=P.sortIndex-M.sortIndex;return R!==0?R:P.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var s=[],c=[],d=1,f=null,v=3,m=!1,p=!1,y=!1,w=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(P){for(var M=n(c);M!==null;){if(M.callback===null)r(c);else if(M.startTime<=P)r(c),M.sortIndex=M.expirationTime,t(s,M);else break;M=n(c)}}function S(P){if(y=!1,b(P),!p)if(n(s)!==null)p=!0,z(_);else{var M=n(c);M!==null&&F(S,M.startTime-P)}}function _(P,M){p=!1,y&&(y=!1,h(k),k=-1),m=!0;var R=v;try{for(b(M),f=n(s);f!==null&&(!(f.expirationTime>M)||P&&!A());){var B=f.callback;if(typeof B=="function"){f.callback=null,v=f.priorityLevel;var N=B(f.expirationTime<=M);M=e.unstable_now(),typeof N=="function"?f.callback=N:f===n(s)&&r(s),b(M)}else r(s);f=n(s)}if(f!==null)var U=!0;else{var G=n(c);G!==null&&F(S,G.startTime-M),U=!1}return U}finally{f=null,v=R,m=!1}}var T=!1,E=null,k=-1,O=5,$=-1;function A(){return!(e.unstable_now()-$<O)}function I(){if(E!==null){var P=e.unstable_now();$=P;var M=!0;try{M=E(!0,P)}finally{M?j():(T=!1,E=null)}}else T=!1}var j;if(typeof g=="function")j=function(){g(I)};else if(typeof MessageChannel<"u"){var L=new MessageChannel,D=L.port2;L.port1.onmessage=I,j=function(){D.postMessage(null)}}else j=function(){w(I,0)};function z(P){E=P,T||(T=!0,j())}function F(P,M){k=w(function(){P(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){p||m||(p=!0,z(_))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):O=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(P){switch(v){case 1:case 2:case 3:var M=3;break;default:M=v}var R=v;v=M;try{return P()}finally{v=R}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,M){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var R=v;v=P;try{return M()}finally{v=R}},e.unstable_scheduleCallback=function(P,M,R){var B=e.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?B+R:B):R=B,P){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=R+N,P={id:d++,callback:M,priorityLevel:P,startTime:R,expirationTime:N,sortIndex:-1},R>B?(P.sortIndex=R,t(c,P),n(s)===null&&P===n(c)&&(y?(h(k),k=-1):y=!0,F(S,R-B))):(P.sortIndex=N,t(s,P),p||m||(p=!0,z(_))),P},e.unstable_shouldYield=A,e.unstable_wrapCallback=function(P){var M=v;return function(){var R=v;v=M;try{return P.apply(this,arguments)}finally{v=R}}}})(Gy);Hy.exports=Gy;var qk=Hy.exports;/**
 * @license React
...
`,HD=[{id:1,title:"Дідів хлів - найкращий вибір для Вашого велосипеда",desc:"Якісні запчастини, професійний серевіс та індивідуальний підхід. Створюйте ідеальний байк разом з нами",img:"/Didiv/bike2-hero.jpeg",btn:"До каталогу",url:"/catalog"},{id:2,title:"Постійне оновлення товару",desc:"Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam reprehenderit obcaecati molestias est alias vitae laboriosam nulla perferendis officia incidunt aliquid voluptatem iste libero, officiis ex modi enim repellat. Consectetur!",img:"/Didiv/inside.webp",btn:"До новинок",url:"/catalog/new"}],GD=()=>u.jsx(BD,{children:u.jsx(F2,{modules:[bI,SI,wI],spaceBetween:0,slidesPerView:1,navigation:!0,pagination:{clickable:!0},autoplay:{delay:5e3},loop:!0,children:HD.map(e=>u.jsx(z2,{children:u.jsx(VD,{bg:e.img,children:u.jsxs(UD,{children:[u.jsx("h1",{children:e.title}),u.jsx("p",{children:e.desc}),u.jsx(WD,{to:e.url,children:e.btn})]})})},e.id))})}),qD=C.div`
  display: grid;
...
`,Hd=C.div`
  font-size: 14px;
  color: #888;
`,N2=()=>u.jsxs(qD,{children:[u.jsxs(Ud,{children:[u.jsx(Wd,{children:"3000+"}),u.jsx(Hd,{children:"Перевірених деталей"})]}),u.jsxs(Ud,{children:[u.jsx(Wd,{children:"6 років"}),u.jsx(Hd,{children:"Досвіду на ринку"})]}),u.jsxs(Ud,{children:[u.jsx(Wd,{children:"100%"}),u.jsx(Hd,{children:"Контроль якості"})]})]}),YD=Fe.div`
...
`;Fe.img`
  ...
  height: 40px;
  object-fit: cover;
`;const KD=()=>u.jsx(YD,{children:u.jsxs(XD,{children:[u.jsx(GD,{}),u.jsx(iS,{}),u.jsx(cI,{}),u.jsx(N2,{})]})}),QD=C.div`
  width: 100%;
  max-width: 750px;
  padding: 10px;
  margin: 0 auto;
...
`,V2=({childValues:e,onChange:t})=>{const o=(e==null?void 0:e[0])??10,a=(e==null?void 0:e[1])??1e4,l=o!==a,[s,c]=x.useState([o,a]);x.useEffect(()=>{e&&e.length===2&&(c(e),t&&t(e))},[e,t]);const d=m=>{c(m),t&&t(m)},f=(m,p)=>{const y=p===""?"":Number(p),w=[...s];w[m]=y,d(w)},v=m=>{const p=[...s];m===0?((p[0]===""||p[0]<o)&&(p[0]=o),p[0]>p[1]-50&&(p[0]=p[1]-50)):((p[1]===""||p[1]>a)&&(p[1]=a),p[1]<p[0]+50&&(p[1]=p[0]+50)),d(p)};return u.jsx(u.Fragment,{children:l&&u.jsxs(E6,{children:[u.jsxs(T6,{children:[u.jsx(Qv,{type:"number",value:s[0],min:o,max:s[1],onChange:m=>f(0,m.target.value),onBlur:()=>v(0)}),u.jsx(Qv,{type:"number",value:s[1],min:s[0],max:a,onChange:m=>f(1,m.target.value),onBlur:()=>v(1)})]}),u.jsx(Bp.Range,{values:s,step:50,min:o,max:a,onChange:d,renderTrack:({props:m,children:p})=>u.jsx(P6,{...m,background:Bp.getTrackBackground({values:s,colors:["#ddd","#85683d","#ddd"],min:o,max:a}),children:p}),renderThumb:({props:m})=>u.jsx(j6,{...m})})]})})},O6=({childValues:e,category:t,selectedFilters:n,setSelectedFilters:r,setPriceRange:i})=>{const[o,a]=x.useState([]),[l,s]=x.useState({});x.useEffect(()=>{t&&(async()=>{try{const w=(await(await fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[category][title][$eq]=${encodeURIComponent(t)}&pagination[pageSize]=200`)).json()).data||[],h={};w.forEach(b=>{var S;(S=b.attributes)==null||S.forEach(_=>{h[_.label]||(h[_.label]=new Set),h[_.label].add(_.value)})});const g=Object.entries(h).map(([b,S])=>({type:"checkbox",label:b,name:b.toLowerCase(),options:Array.from(S)}));a(g)}catch(p){console.error(p)}})()},[t]);const c=m=>{s(p=>({...p,[m]:!p[m]}))},d=(m,p)=>{r(y=>{const w=y[m]||[];return w.includes(p)?{...y,[m]:w.filter(h=>h!==p)}:{...y,[m]:[...w,p]}})},f=Object.values(n).some(m=>Array.isArray(m)&&m.length>0),v=()=>{f&&r({})};return u.jsxs(u6,{children:[u.jsxs(d6,{children:["Фільтри ",u.jsx(Sw,{size:20})]}),(o||[]).map(m=>{var y;const p=!!l[m.name];return u.jsxs(f6,{children:[u.jsxs(p6,{onClick:()=>c(m.name),children:[u.jsx(h6,{children:m.label}),u.jsx(m6,{isOpen:p})]}),u.jsxs(g6,{isOpen:p,children:[m.type==="checkbox"&&((y=m.options)==null?void 0:y.map(w=>{var h;return u.jsxs(v6,{children:[u.jsx(Np,{checked:((h=n[m.name])==null?void 0:h.includes(w))||!1,onChange:()=>d(m.name,w)}),u.jsx(y6,{}),w]},w)})),m.type==="range"&&u.jsx(V2,{onChange:i,childValues:e})]})]},m.name)}),u.jsx(B2,{onClick:v,disabled:!f,children:"Скинути обрані фільтри"})]})},$6=C.aside`
  width: 100%;
  max-width: 400px;
  background: #ffffff;
  padding: 20px;
...
`,z6=({childValues:e,category:t,selectedFilters:n,setSelectedFilters:r,setPriceRange:i})=>{const[o,a]=x.useState({}),[l,s]=x.useState([]);x.useEffect(()=>{t&&(async()=>{try{const p=(await(await fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[category][title][$eq]=${encodeURIComponent(t)}&pagination[pageSize]=200`)).json()).data||[],y={};p.forEach(h=>{var g;(g=h.attributes)==null||g.forEach(b=>{y[b.label]||(y[b.label]=new Set),y[b.label].add(b.value)})});const w=Object.entries(y).map(([h,g])=>({type:"checkbox",label:h,name:h.toLowerCase(),options:Array.from(g)}));s(w)}catch(v){console.error(v)}})()},[t]);const c=f=>{a(v=>({...v,[f]:!v[f]}))},d=(f,v)=>{r(m=>{const p=m[f]||[];return p.includes(v)?{...m,[f]:p.filter(y=>y!==v)}:{...m,[f]:[...p,v]}})};return u.jsx($6,{children:(l||[]).map(f=>{var m;const v=!!o[f.name];return u.jsxs(M6,{children:[u.jsxs(I6,{onClick:()=>c(f.name),children:[u.jsx(D6,{children:f.label}),u.jsx(L6,{isOpen:v})]}),u.jsxs(A6,{isOpen:v,children:[f.type==="checkbox"&&((m=f.options)==null?void 0:m.map(p=>{var y;return u.jsxs(R6,{children:[u.jsx(Vp,{checked:((y=n[f.name])==null?void 0:y.includes(p))||!1,onChange:()=>d(f.name,p)}),u.jsx(F6,{}),p]},p)})),f.type==="range"&&u.jsx(V2,{onChange:i,childValues:e})]})]},f.name)})})},N6=({setValues:e,category:t,selectedFilters:n={},priceRange:r,sortType:i,setIsSortOpen:o,isSortOpen:a,setSortType:l,sortOrder:s,setSortOrder:c})=>{const[d,f]=x.useState([]),[v,m]=x.useState(!0),[p,y]=x.useState(1),w=24;let h=d;console.log(d);const g=x.useRef(null);x.useEffect(()=>{const j=L=>{g.current&&!g.current.contains(L.target)&&o(!1)};return document.addEventListener("mousedown",j),()=>{document.removeEventListener("mousedown",j)}},[o]),x.useEffect(()=>{(async()=>{try{m(!0);const D=await(await fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[category][title][$eq]=${encodeURIComponent(t)}&pagination[pageSize]=500`)).json();f(D.data);const z=D.data.map(F=>F.price);if(z.length>0){let F=Math.min(...z),P=Math.max(...z);e([F,P])}}catch(L){console.error("Error fetching products:",L)}finally{m(!1)}})()},[t,e]),x.useEffect(()=>{y(1)},[t,n,r]),x.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[p]);const b=xt(),S=Mt(),_=Ue(j=>j.favorites.items),T=Ue(j=>j.cart.items),E=(j,L)=>{L.stopPropagation();const D=_.some(z=>z.id===(j==null?void 0:j.id));ui(j,D,S,X)};if(Object.keys(n).forEach(j=>{const L=n[j];Array.isArray(L)&&L.length>0&&(h=h.filter(D=>{var F;const z=(F=D.attributes)==null?void 0:F.find(P=>P.label.toLowerCase()===j.toLowerCase());return z&&L.includes(z.value)}))}),r&&r.length===2){const[j,L]=r;console.log(j,L)}const k=x.useMemo(()=>{const j=[...h],L=D=>D.new_price&&D.new_price<D.price?D.new_price:D.price;switch(i){case"name":return j.sort((D,z)=>s==="asc"?D.name.localeCompare(z.name):z.name.localeCompare(D.name));case"price":return j.sort((D,z)=>{const F=L(D),P=L(z);return s==="asc"?F-P:P-F});case"date":return j.sort((D,z)=>s==="asc"?new Date(D.createdAt)-new Date(z.createdAt):new Date(z.createdAt)-new Date(D.createdAt));default:return j}},[i,h,s]),O=p*w,$=O-w,A=k.slice($,O),I=Math.ceil(h.length/w);return v?u.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:u.jsx(di,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):u.jsxs(z4,{children:[u.jsxs(N4,{children:[u.jsx(B4,{children:t}),u.jsxs(X4,{ref:g,children:[u.jsxs(K4,{onClick:()=>o(j=>!j),children:["Сортування",u.jsx(Bc,{strokeWidth:.9,size:22})]}),a&&u.jsxs(Q4,{children:[u.jsx(yi,{onClick:()=>{l("name"),c("asc"),o(!1)},children:"А-Я"}),u.jsx(yi,{onClick:()=>{l("name"),c("desc"),o(!1)},children:"Я-А"}),u.jsx(yi,{onClick:()=>{l("price"),c("asc"),o(!1)},children:"Ціна ↑"}),u.jsx(yi,{onClick:()=>{l("price"),c("desc"),o(!1)},children:"Ціна ↓"}),u.jsx(yi,{onClick:()=>{l("date"),c("desc"),o(!1)},children:"Спочатку новіші"}),u.jsx(yi,{onClick:()=>{l("date"),c("asc"),o(!1)},children:"Спочатку старіші"})]})]})]}),u.jsx(Ln,{autoClose:1500}),h.length===0?u.jsx(V4,{children:u.jsx("p",{style:{textAlign:"center",fontSize:"30px",marginTop:"50px",marginLeft:"auto",marginRight:"auto"},children:"Нічого не знайдено 😢"})}):u.jsx(U4,{children:A.map(j=>{var G,W;const L=_.some(H=>H.id===j.id),D=j!=null&&j.createdAt?Date.now()-new Date(j.createdAt).getTime()<7*24*60*60*1e3:!1,z=T.find(H=>H.id===j.id),P=(z?z.quantity:0)>=(j.stock||0),M=(j==null?void 0:j.available)??!0,R=j.new_price&&j.new_price<j.price,B=R?j.new_price:j.price,N=R?Math.round((j.price-j.new_price)/j.price*100):0,U=(H,ee)=>{if(ee.stopPropagation(),P){X.error("Товар уже у кошику");return}S(Ip({...H,quantity:1})),X.success(`${H.name} додано в кошик!`)};return u.jsxs(W4,{onClick:()=>b(`/product/${j.slug??j.id}`),style:{cursor:"pointer"},children:[u.jsxs(Mw,{children:[D&&u.jsx(hm,{children:"Новинка"}),!M&&u.jsx(pm,{children:"Бронь"}),u.jsx(H4,{src:((W=(G=j.images)==null?void 0:G[0])==null?void 0:W.url)||"/placeholder.jpg",alt:j.name,onError:H=>{H.currentTarget.onerror=null,H.currentTarget.src=ri}})]}),u.jsx(q4,{children:j.name}),u.jsxs(G4,{children:[u.jsx(Dw,{children:u.jsxs(Lw,{children:[u.jsxs(Aw,{$discount:R,children:[B.toLocaleString()," грн"]}),R&&u.jsxs(Rw,{children:[j.price.toLocaleString()," грн"]}),R&&u.jsxs(Fw,{children:["-",N,"%"]})]})}),u.jsxs(Iw,{children:[M&&u.jsx(ql,{onClick:H=>U(j,H),children:u.jsx(vo,{size:24,color:z?"var(--orange-color)":"black",strokeWidth:2})}),u.jsx(ql,{onClick:H=>E(j,H),children:u.jsx(Ya,{size:24,fill:L?"#ff4d4f":"none",color:L?"#ff4d4f":"#000000",strokeWidth:L?1:2})})]})]})]},j.id)})}),h.length>w&&u.jsxs(Y4,{children:[u.jsx(Ed,{onClick:()=>y(j=>Math.max(j-1,1)),disabled:p===1,children:"Назад"}),Array.from({length:I},(j,L)=>u.jsx(Ed,{onClick:()=>y(L+1),active:p===L+1,children:L+1},L)),u.jsx(Ed,{onClick:()=>y(j=>Math.min(j+1,I)),disabled:p===I,children:"Вперед"})]})]})},B6=()=>{const[e,t]=x.useState({}),{category:n}=Fy(),[r,i]=x.useState(!1),[o,a]=x.useState(!1),[l,s]=x.useState("date"),[c,d]=x.useState("desc"),[f,v]=x.useState([]),[m,p]=x.useState([0,0]),y=Object.values(e).some(h=>Array.isArray(h)&&h.length>0),w=()=>{y&&t({})};return u.jsxs(ZD,{children:[u.jsxs(QD,{children:[u.jsxs(JD,{children:[u.jsxs(e6,{onClick:()=>i(!0),children:["Фільтр",u.jsx(t6,{children:u.jsx("use",{href:`${hn}#icon-filter`})})]}),u.jsxs(l6,{children:[u.jsxs(n6,{onClick:()=>a(h=>!h),children:["Сортування",u.jsx(Bc,{strokeWidth:.9,size:22})]}),o&&u.jsxs(c6,{children:[u.jsx(bi,{onClick:()=>{s("name"),d("asc"),a(!1)},children:"А-Я"}),u.jsx(bi,{onClick:()=>{s("name"),d("desc"),a(!1)},children:"Я-А"}),u.jsx(bi,{onClick:()=>{s("price"),d("asc"),a(!1)},children:"Ціна ↑"}),u.jsx(bi,{onClick:()=>{s("price"),d("desc"),a(!1)},children:"Ціна ↓"}),u.jsx(bi,{onClick:()=>{s("date"),d("desc"),a(!1)},children:"Спочатку новіші"}),u.jsx(bi,{onClick:()=>{s("date"),d("asc"),a(!1)},children:"Спочатку старіші"})]})]})]}),u.jsx(O6,{category:n,selectedFilters:e,setSelectedFilters:t,childValues:f,priceRange:m,setPriceRange:p}),u.jsx(N6,{priceRange:m,values:f,setValues:v,category:n,selectedFilters:e,sortType:l,setIsSortOpen:a,isSortOpen:o,setSortType:s,sortOrder:c,setSortOrder:d}),r&&u.jsx(r6,{onClick:()=>i(!1),open:r,children:u.jsxs(i6,{onClick:h=>h.stopPropagation(),open:r,children:[u.jsxs(o6,{children:[u.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[u.jsx(Sw,{size:20}),u.jsx("h2",{children:"Фільтри"})]}),u.jsx(_w,{size:24,onClick:()=>i(!1),style:{cursor:"pointer"}})]}),u.jsx(z6,{childValues:f,category:n,selectedFilters:e,setSelectedFilters:t,priceRange:m,setPriceRange:p}),u.jsxs(a6,{children:[u.jsx(B2,{onClick:w,disabled:!y,children:"Скинути обрані фільтри"}),u.jsx(s6,{onClick:()=>i(!1),children:"Показати результати"})]})]})})]})," "]})},Zv=C.div`
  width: 100%;
  max-width: 750px;
  margin: 0 auto;
  padding: 20px;
...
`,C1=({productId:e,questions:t})=>{const[n,r]=x.useState(""),[i,o]=x.useState(""),a=async l=>{l.preventDefault(),(await fetch("https://backenddidiv-production.up.railway.app/api/questions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({data:{question:n,userName:i,product:e}})})).ok&&(X.success("Запитання надіслано! Воно з’явиться після модерації."),r(""),o(""))};return u.jsxs(VA,{children:[u.jsx(Ln,{autoClose:1500}),u.jsxs(UA,{onSubmit:a,children:[u.jsx(WA,{placeholder:"Ваше ім'я",value:i,onChange:l=>o(l.target.value),required:!0}),u.jsx(HA,{placeholder:"Запитайте нас про цей товар...",value:n,onChange:l=>r(l.target.value),required:!0}),u.jsx(GA,{children:"Надіслати запитання"})]}),u.jsx(qA,{children:t&&t.length>0?t.map(l=>l.answer?u.jsxs(YA,{children:[u.jsxs(XA,{children:[u.jsx(KA,{children:l.userName||"Гість"}),u.jsx(QA,{children:new Date(l.createdAt).toLocaleDateString()})]}),u.jsx(ZA,{children:l.question}),u.jsxs(JA,{children:[u.jsx(eR,{children:"Адміністратор"}),u.jsx("p",{children:l.answer})]})]},l.id):null):u.jsx("p",{style:{textAlign:"center",color:"#999"},children:"Запитань поки немає. Будьте першим!"})})]})},tR=()=>{var F;const{identifier:e}=Fy(),[t,n]=x.useState([]),[r,i]=x.useState(1),[o,a]=x.useState("description"),[l,s]=x.useState(null),[c,d]=x.useState(!1),[f,v]=x.useState(0),[m,p]=x.useState(!0),y=!isNaN(e),w=t.find(P=>y?String(P.id)===String(e):P.slug===e),h=w?S1().diff(S1(w.createdAt),"day")<7:!1,b=(P=>{const[M,R]=x.useState(!1);return x.useEffect(()=>{const B=window.matchMedia(P),N=()=>R(B.matches);return N(),B.addEventListener("change",N),()=>B.removeEventListener("change",N)},[P]),M})("(min-width: 768px)"),S=Ue(P=>P.cart.items),_=w?S.find(P=>P.id===w.id):null,T=(_==null?void 0:_.quantity)||0;x.useEffect(()=>{(async()=>{try{p(!0);const M=y?`filters[id][$eq]=${e}`:`filters[slug][$eq]=${e}`,B=await(await fetch(`https://backenddidiv-production.up.railway.app/api/products?${M}&populate=*`)).json();n(B.data)}catch(M){console.error("Error fetching products:",M)}finally{p(!1)}})()},[e,y]);const E=(w==null?void 0:w.available)??!0;x.useEffect(()=>{var P,M;w&&w.images&&s((M=(P=w.images)==null?void 0:P[0])==null?void 0:M.url)},[w]);const k=((w==null?void 0:w.images)??[]).map(P=>({src:P.url})),O=()=>{const P=w.images.findIndex(M=>M.url===l);v(P>=0?P:0),d(!0)},$=Mt(),I=Ue(P=>P.favorites.items).some(P=>P.id===(w==null?void 0:w.id)),j=async()=>{if(T>=w.stock){X.warning("Товар вже в кошику (досягнуто максимум)");return}if(T+r>w.stock){X.warning(`Доступно лише ${w.stock} шт.`);return}await Za(w,r,$,X)},L=(P,M)=>{M.stopPropagation(),ui(P,I,$,X)},D=(w==null?void 0:w.new_price)&&(w==null?void 0:w.new_price)<w.price,z=D?Math.round((w.price-w.new_price)/w.price*100):0;return m?u.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:u.jsx(di,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):w?u.jsxs(Zv,{children:[" ",u.jsx(Ln,{autoClose:1500}),u.jsxs(V6,{children:[u.jsx(Te,{to:"/",children:"Головна"})," / ",u.jsx(Te,{to:"/catalog",children:"Каталог"})," /"," ",w.name]}),u.jsxs(U6,{children:[u.jsxs(W6,{children:[u.jsx(H6,{src:l,alt:w.name,onClick:O}),u.jsx(G6,{children:(w.images??[]).map(P=>{const M=P.url;return u.jsx(q6,{src:M,onClick:()=>s(M),style:{cursor:"pointer",opacity:l===M?1:.4}},P.id)})})]}),u.jsx(CA,{open:c,close:()=>d(!1),index:f,slides:k,controller:{closeOnBackdropClick:!0},on:{view:({index:P})=>{var M,R;v(P),(R=(M=w==null?void 0:w.images)==null?void 0:M[P])!=null&&R.url&&s(w.images[P].url)}},plugins:[NA],zoom:{maxZoomPixelRatio:3,zoomInMultiplier:2,doubleTapDelay:300,doubleClickDelay:300,doubleClickEnabled:!0,pinchZoomDistanceFactor:100,scrollToZoom:!0}}),u.jsxs(Y6,{children:[u.jsx(X6,{children:w.name}),u.jsxs(K6,{children:["Артикул: ",w.sku??""]}),u.jsx(Q6,{children:h&&u.jsx(J6,{children:"● Новий товар"})}),!E&&u.jsx(Z6,{children:"Бронь"}),u.jsxs(eL,{children:[u.jsx(tL,{children:D?u.jsxs(u.Fragment,{children:[u.jsxs(Jv,{$discount:!0,children:[w.new_price.toLocaleString()," грн"]}),u.jsxs(nL,{children:[w.price.toLocaleString()," грн"]}),u.jsxs(rL,{children:["-",z,"%"]})]}):u.jsxs(Jv,{children:[w.price.toLocaleString()," грн"]})}),u.jsxs(iL,{children:[u.jsxs(oL,{children:[u.jsx("button",{onClick:()=>i(Math.max(1,r-1)),children:"-"}),u.jsx("span",{children:r}),u.jsxs(dL,{$active:r>=w.stock,children:[u.jsx("button",{onClick:()=>i(Math.min(w.stock,r+1)),disabled:r>=w.stock,children:"+"}),u.jsxs(U2,{children:["Максимум: ",w.stock]})]})]}),u.jsxs(aL,{onClick:j,disabled:!E,children:[" ",u.jsx(vo,{size:25}),u.jsx("span",{children:"В КОШИК"})]}),u.jsxs(cL,{$active:I,onClick:P=>L(w,P),children:[u.jsxs(uL,{$active:I,children:[" ",u.jsx("use",{href:`${hn}#icon-heart`})]}),u.jsx("span",{children:"В ОБРАНЕ"})]})]})]})]})]}),!b&&u.jsxs(n1,{children:[u.jsxs(r1,{children:[u.jsx(Bo,{active:o==="description",onClick:()=>a("description"),children:"Опис"}),u.jsx(Bo,{active:o==="attributes",onClick:()=>a("attributes"),children:"Характеристики"}),u.jsx(Bo,{active:o==="FAQ",onClick:()=>a("FAQ"),children:"Питання та відповіді"})]}),u.jsxs(i1,{children:[o==="description"&&u.jsx(o1,{children:w.description}),o==="attributes"&&u.jsx(e1,{children:(F=w.attributes)!=null&&F.length?w.attributes.map(P=>u.jsxs(t1,{children:[u.jsx("span",{children:P.label}),u.jsx("b",{children:P.value})]},P.id)):u.jsx("p",{children:"Характеристики відсутні"})}),o==="FAQ"&&u.jsx(C1,{productId:w.documentId,questions:w.questions})]})]}),b&&u.jsxs(lL,{children:[u.jsxs(n1,{children:[u.jsxs(r1,{children:[u.jsx(Bo,{active:o==="description",onClick:()=>a("description"),children:"Опис"}),u.jsx(Bo,{active:o==="FAQ",onClick:()=>a("FAQ"),children:"Питання та відповіді"})]}),u.jsxs(i1,{children:[o==="description"&&u.jsx(o1,{children:w.description}),o==="FAQ"&&u.jsx(C1,{productId:w.documentId,questions:w.questions})]})]}),u.jsxs(e1,{children:[u.jsx(sL,{children:" Характеристики"}),(()=>{const P=[...w.attributes||[],...w.features||[]];return P.length?P.map((M,R)=>u.jsxs(t1,{children:[u.jsx("span",{children:M.label}),u.jsx("b",{children:M.value})]},`${M.id}-${R}`)):u.jsx("p",{children:"Характеристики відсутні"})})()]})]})]}):u.jsx(Zv,{children:"Товар не знайдено"})},nR=C.div`
  font-family: var(--main-font);
  width: 100%;
  max-width: 750px;
  padding: 10px;
...
`;const LN=({formData:e,setFormData:t,errors:n})=>{const r=i=>{const{name:o,value:a}=i.target;o==="phone"&&!a.startsWith("+38 (0")||t(l=>({...l,[o]:a}))};return u.jsxs(u.Fragment,{children:[u.jsx("h3",{children:"Контактні дані"}),u.jsxs(uf,{children:[u.jsx(df,{children:"Прізвище та ім’я"}),u.jsx(ff,{type:"text",name:"fullName",value:e.fullName,onChange:r,placeholder:"Прізвище Ім'я",autoComplete:"name"}),n.fullName&&u.jsx(pf,{children:n.fullName})]}),u.jsxs(uf,{children:[u.jsx(df,{children:"Номер телефону"}),u.jsx(DN,{mask:"+38 (099) 999-99-99",maskChar:"_",name:"phone",autoComplete:"tel",value:e.phone,onChange:r,children:i=>u.jsx(ff,{...i,type:"tel"})}),n.phone&&u.jsx(pf,{children:n.phone})]}),u.jsxs(uf,{children:[u.jsx(df,{children:"E-mail"}),u.jsx(ff,{type:"email",name:"email",value:e.email,onChange:r,placeholder:"email@example.com",autoComplete:"email"}),n.email&&u.jsx(pf,{children:n.email})]})]})},AN=C.div`
  width: 100%;
  max-width: 750px;
  padding-left: 10px;
  padding-right: 10px;
...
`;C.button`
`;const zN=({options:e,value:t,onChange:n,error:r})=>{const i=e.find(o=>o.value===t)||null;return u.jsxs("div",{style:{marginBottom:"20px"},children:[u.jsx("label",{style:{display:"block",marginBottom:"8px"},children:"Спосіб оплати"}),u.jsx(Fu,{options:e,value:i,onChange:o=>n(o==null?void 0:o.value),placeholder:"Оберіть спосіб оплати",styles:{control:o=>({...o,borderColor:r?"red":o.borderColor})}}),r&&u.jsx("span",{style:{color:"red",fontSize:"12px"},children:"Оберіть спосіб оплати"})]})},NN=e=>{if(!e)return"";const t=e.replace(/\D/g,"");return t.length!==10?e:`+38 (${t.slice(0,3)}) ${t.slice(3,6)}-${t.slice(6,8)}-${t.slice(8,10)}`},ry=async(e,t,n)=>{if(!(e!=null&&e.documentId)||!t)return;const r=await fetch(`https://backenddidiv-production.up.railway.app/api/cart-items?filters[user][documentId][$eq]=${e.documentId}`,{headers:{Authorization:`Bearer ${t}`}});if(!r.ok)throw new Error("Не вдалося отримати кошик");const{data:i}=await r.json();await Promise.all(i.map(o=>fetch(`https://backenddidiv-production.up.railway.app/api/cart-items/${o.documentId}`,{method:"DELETE",headers:{Authorization:`Bearer ${t}`}}))),n(yo())},iy={}.VITE_NP_API_KEY,oy="https://api.novaposhta.ua/v2.0/json/",BN=()=>{const e=Ue(R=>R.cart.items),t=xt(),n=Mt(),r=localStorage.getItem("token"),i=x.useMemo(()=>{const R=localStorage.getItem("user");return R?JSON.parse(R):null},[]);console.log(i);const[o,a]=x.useState({fullName:"",phone:"+38(0",email:"",city:"",postOffice:""});console.log(o);const[l,s]=x.useState(""),[c,d]=x.useState(null),[f,v]=x.useState(null),[m,p]=x.useState(null),[y,w]=x.useState(null),[h,g]=x.useState([]),[b,S]=x.useState([]),[_,T]=x.useState(null),E=x.useRef(!1);x.useEffect(()=>{!i||E.current||(E.current=!0,a({fullName:`${i.last_name||""} ${i.first_name||""}`.trim(),phone:NN(i.phone),email:i.email||""}))},[i]);const k=e.filter(R=>R.available!==!1).reduce((R,B)=>R+(B.new_price??B.price)*B.quantity,0),O=e.filter(R=>R.available!==!1),$=e.filter(R=>R.available!==!1).reduce((R,B)=>R+B.quantity,0),I=(()=>{const R=new Date().getFullYear().toString().slice(-2),B=Date.now().toString().slice(-4),N=Math.floor(100+Math.random()*900);return`${R}${B}${N}`})();x.useEffect(()=>{if(l.length<2)return;const R=setTimeout(async()=>{const N=await(await fetch(oy,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:iy,modelName:"Address",calledMethod:"getCities",methodProperties:{FindByString:l}})})).json();g(N.data.map(U=>({value:U.Ref,label:U.Description})))},500);return()=>clearTimeout(R)},[l]),x.useEffect(()=>{if(!c||f!=="nova")return;(async()=>{const N=await(await fetch(oy,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:iy,modelName:"AddressGeneral",calledMethod:"getWarehouses",methodProperties:{CityRef:c.value}})})).json();S(N.data.map(U=>({value:U.Ref,label:U.Description})))})()},[c,f]);const j=R=>{d(R),a(B=>({...B,city:(R==null?void 0:R.label)||"",postOffice:""})),v(null),p(null),w(null)},L=()=>{const R={};return o.fullName.trim().split(" ").length<2&&(R.fullName="Введіть прізвище та ім'я"),/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(o.email)||(R.email="Некоректний email"),o.phone.replace(/\D/g,"").length<12&&(R.phone="Номер неповний"),c||(R.city=!0),f==="nova"&&!m&&(R.postOffice=!0),f==="ukr"&&!y&&(R.postOffice=!0),f||(R.delivery=!0),_||(R.payment=!0),R},D=x.useMemo(L,[o,f,m,y,c,_]),z=Object.keys(D).length===0&&e.length>0,F=async R=>{if(R.preventDefault(),!_){alert("Оберіть спосіб оплати");return}try{if(await fetch("https://backenddidiv-production.up.railway.app/api/orders",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({data:{name:o.fullName,phone:o.phone,email:o.email,city:o.city,products:e==null?void 0:e.map(N=>{var U;return{id:N==null?void 0:N.id,name:N==null?void 0:N.name,quantity:N==null?void 0:N.quantity,price:(N==null?void 0:N.new_price)??N.price,image:(U=N==null?void 0:N.images)==null?void 0:U[0].url}}),status_order:"pending",order_number:I,payment_method:_==="liqpay"?"Онлайн (LiqPay)":_==="cod"?"Післяплата":_==="bank_transfer"?"Оплата за реквізитами":"",delivery_method:f==="nova"?"Нова Пошта":f==="ukr"?"УкрПошта":"Самовивіз",delivery_address:f==="nova"?m==null?void 0:m.label:f==="ukr"?y:"Самовивіз"}})}),_==="liqpay"){const N=await fetch("https://backenddidiv-production.up.railway.app/api/liqpay/create",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({amount:k,order_number:I})}),{data:U,signature:G}=await N.json();await ry(i,r,n);const W=document.createElement("form");W.method="POST",W.action="https://www.liqpay.ua/api/3/checkout",W.innerHTML=`
        <input type="hidden" name="data" value="${U}" />
        <input type="hidden" name="signature" value="${G}" />
      `,document.body.appendChild(W),W.requestSubmit();return}const B={...o,name:o.fullName,city:c.label,deliveryMethod:f==="nova"?"Нова Пошта":f==="ukr"?"УкрПошта":"Самовивіз",address:f==="nova"?m==null?void 0:m.label:f==="ukr"?y:"Самовивіз",products:e==null?void 0:e.map(N=>({id:N.id,name:N.name,quantity:N.quantity,price:N.new_price??N.price})),total:k,order_number:I,delivery_address:f==="nova"?m==null?void 0:m.label:f==="ukr"?y:"Самовивіз",payment_method:_==="liqpay"?"Онлайн (LiqPay)":_==="cod"?"Післяплата":_==="bank_transfer"?"Оплата за реквізитами":""};await ry(i,r,n),t("/order-confirmation",{state:{order:B}})}catch(B){console.error(B),alert("Помилка оформлення")}},P=x.useMemo(()=>[{value:"nova",label:"Нова пошта"},{value:"ukr",label:"Укрпошта"}],[]),M=[{value:"liqpay",label:"Онлайн оплата (LiqPay)"},{value:"cod",label:"Післяплата"},{value:"bank_transfer",label:"Оплата за реквізитами"}];return u.jsx(AN,{children:u.jsxs(RN,{children:[u.jsxs(FN,{children:[u.jsx(LN,{formData:o,setFormData:a,errors:D}),u.jsx(Jz,{cityOptions:h,selectedCity:c,onChange:j,onInputChange:s}),u.jsx(nN,{options:P,value:f,onChange:v,selectedCity:c}),u.jsx(rN,{deliveryMethod:f,officeOptions:b,selectedOffice:m,selectedUkrOffice:y,setSelectedOffice:p,setSelectedUkrOffice:w}),u.jsx(zN,{options:M,value:_,onChange:T,error:D.payment})]}),u.jsx(mN,{cartItems:O,totalAmount:k,totalQuantity:$,isFormValid:z,handleSubmit:F})]})})},VN=C.div`
font-family: var(--main-font);
  max-width: 800px;
  margin: 40px auto;
  padding: 40px 20px;
...
`,XN=()=>{var v,m;const e=xt(),t=Dn(),[n]=Gk(),r=Mt(),i=(v=t.state)==null?void 0:v.order,o=n.get("orderId"),[a,l]=x.useState(i||null),[s,c]=x.useState(!i);x.useEffect(()=>{r(yo())},[r]),x.useEffect(()=>{i||(o?fetch(`https://backenddidiv-production.up.railway.app/api/orders?filters[order_number][$eq]=${o}&populate=*`).then(p=>p.json()).then(p=>{var y;((y=p.data)==null?void 0:y.length)>0&&l(p.data[0]),c(!1)}).catch(()=>c(!1)):c(!1))},[o,i]);const f=((a==null?void 0:a.products)??[]).reduce((p,y)=>p+Number(y.new_price??y.price)*(y.quantity||1),0);return s?u.jsx("div",{children:"Завантаження..."}):a?u.jsxs(VN,{children:[u.jsx(UN,{children:"Дякуємо за ваше замовлення!"}),u.jsxs(Ar,{children:["Ваше замовлення ",u.jsxs("strong",{children:["№",a.order_number]})," успішно прийняте."]}),u.jsx(Ar,{children:"Ми зв’яжемось з Вами в найближчий час"}),u.jsxs(WN,{children:[u.jsx(HN,{children:"Деталі замовлення:"}),u.jsx(GN,{children:(m=a.products)==null?void 0:m.map(p=>u.jsxs(qN,{children:[u.jsxs("span",{className:"item-info",children:[p.name," (x",p.quantity,")"]}),u.jsxs("span",{className:"item-price",children:[(p.new_price??p.price)*(p.quantity||1)," грн"]})]},p.id))}),u.jsxs(Ar,{children:[u.jsx("strong",{children:"На суму:"})," ",f," грн."]}),u.jsxs(Ar,{children:[u.jsx("strong",{children:"Отрмувач:"})," ",a.name,", ",a.phone,"."]}),u.jsxs(Ar,{children:[u.jsx("strong",{children:"Спосіб доставки:"})," ",a.deliveryMethod,"."]}),u.jsxs(Ar,{children:[u.jsx("strong",{children:"Адреса отримання:"})," ",a.city,","," ",a.delivery_address,"."]}),u.jsxs(Ar,{children:[u.jsx("strong",{children:"Спосіб оплати:"})," ",a.payment_method,"."]})]}),u.jsxs(YN,{children:[u.jsx(ay,{primary:!0,onClick:()=>e("/"),children:"Повернутися на головну"}),u.jsx(ay,{onClick:()=>e("/catalog"),children:"Продовжити покупки"})]})]}):u.jsxs("div",{children:["Замовлення не знайдено",u.jsx("button",{onClick:()=>e("/"),children:"На головну"})]})},KN=C.section`
  background-color: var(--second-background);
`,QN=C.div`
  width: 100%;
  max-width: 750px;
...
`,a7=()=>u.jsxs(KN,{children:[u.jsxs(QN,{children:[u.jsxs(ZN,{children:[u.jsx(JN,{children:"Про Дідів Хлів"}),u.jsx(e7,{children:"Даємо друге життя якісним велозапчастинам"})]}),u.jsxs(t7,{children:[u.jsx(n7,{children:"Бізнес створений з переконанням, що обладнання може бути доступним. Ми спеціалізуємося на розборі цікавих і унікальних велосипедів, усі запчастини перевірені нами. Стараємося пропонувати тільки найкраще від Shimano, Sram, Campagnolo та інших світових брендів."}),u.jsx(N2,{})]}),u.jsxs(r7,{children:[u.jsx(i7,{children:"Наша майстерня"}),u.jsxs(o7,{children:[u.jsx(Ls,{color:"#e2e2e2",children:"Фото майстерні"}),u.jsx(Ls,{color:"#d1d1d1",children:"Процес діагностики"}),u.jsx(Ls,{color:"#bcbcbc",children:"Склад запчастин"}),u.jsx(Ls,{color:"#a8a8a8",children:"Готові велосипеди"})]})]})]})," "]}),s7=()=>{const{pathname:e}=Dn();return x.useEffect(()=>{window.scrollTo(0,0)},[e]),null},l7=C.section`
  background-color:  var(--second-background);
  padding: 40px 0;
  min-height: 80vh;
`,c7=C.div`
...
`,x7=()=>u.jsx(l7,{children:u.jsxs(c7,{children:[u.jsx(u7,{children:"Контакти"}),u.jsx(d7,{children:"Зв’яжіться з нами для консультації або замовлення"}),u.jsxs(f7,{children:[u.jsxs(p7,{children:[u.jsxs(As,{children:[u.jsx("h3",{children:"Адреса"}),u.jsx("p",{children:"вул. Казармена 6Г, Київ, Україна"}),u.jsx("a",{style:{color:"black",fontWeight:"500",fontSize:"0.9rem",display:"inline-block",marginTop:"5px",cursor:"pointer"},href:"https://www.google.com/maps/search/?api=1&query=вул.+Казармена+6Г,+Київ,+Україна",target:"_blank",rel:"noopener noreferrer",children:"📍 Показати на карті"})]}),u.jsxs(As,{children:[u.jsx("h3",{children:"Телефон"}),u.jsx("p",{children:"+38 (097) 123-45-67"})]}),u.jsxs(As,{children:[u.jsx("h3",{children:"Email"}),u.jsx("p",{children:"didivhliv.com"})]}),u.jsxs(As,{children:[u.jsx("h3",{children:"Графік роботи"}),u.jsx("p",{children:"З 11:00 - 20:00"}),u.jsx("p",{children:"Вихідні: Пн, Чт"})]})]}),u.jsxs(h7,{children:[u.jsx(m7,{children:"Ми в соцмережах"}),u.jsx(g7,{children:"Слідкуйте за нашими новинами, новими надходженнями та крутими вело-поїздками у зручному для вас форматі."}),u.jsxs(v7,{children:[u.jsxs(sy,{href:"https://www.instagram.com/didivxliv?igsh=MXhsNWRjdW5rajYwdQ==",target:"_blank",rel:"noopener noreferrer",children:[u.jsx("svg",{width:"20px",children:u.jsx("use",{href:`${hn}#icon-instagram`})}),u.jsx("span",{children:"Instagram"})]}),u.jsxs(sy,{href:"https://t.me/didivxliv",target:"_blank",rel:"noopener noreferrer",children:[u.jsx("svg",{width:"20px",children:u.jsx("use",{href:`${hn}#icon-telegram`})}),u.jsx("span",{children:"Telegram"})]})]}),u.jsx(y7,{children:"Приєднуйся до спільноти!"})]})]})]})}),b7=C.section`
  background-color:  var(--second-background);
`,w7=C.div`
  display: flex;
  flex-direction: column;
...
`;C.svg`
  ...
  height: 24px;
  fill: var(--white-color);
`;const j7=C.div.attrs({className:"card-buttons"})`
  position: static;
  bottom: 10px;
  left: 10px;
  right: 10px;
...
`;const V7=C.div.attrs({className:"card-buttons"})`
  position: static;
  bottom: 10px;
  left: 10px;
  right: 10px;
...
`,G7=()=>{const[e,t]=x.useState([]),[n,r]=x.useState(!0),i=Ue(_=>_.favorites.items),o=Ue(_=>_.cart.items),[a,l]=x.useState(!1),[s,c]=x.useState("date"),[d,f]=x.useState("asc"),[v,m]=x.useState(1),[p,y]=x.useState(1),w=xt(),h=Mt(),g=x.useRef(null);x.useEffect(()=>{const _=T=>{g.current&&!g.current.contains(T.target)&&l(!1)};return document.addEventListener("mousedown",_),()=>{document.removeEventListener("mousedown",_)}},[]),x.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[v]),x.useEffect(()=>{(async()=>{const T=new Date,E=new Date;E.setDate(T.getDate()-7);const k=E.toISOString();try{r(!0);const O=await fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[createdAt][$gte]=${k}&pagination[page]=${v}&pagination[pageSize]=24`);if(!O.ok)throw new Error(`HTTP error! Status: ${O.status}`);const $=await O.json();t($.data),y($.meta.pagination.pageCount)}catch(O){console.error("Помилка при завантаженні продуктів:",O)}finally{r(!1)}})()},[v]);const b=x.useMemo(()=>{const _=[...e],T=E=>E.new_price&&E.new_price<E.price?E.new_price:E.price;switch(s){case"name":return _.sort((E,k)=>d==="asc"?E.name.localeCompare(k.name):k.name.localeCompare(E.name));case"price":return _.sort((E,k)=>{const O=T(E),$=T(k);return d==="asc"?O-$:$-O});case"date":return _.sort((E,k)=>d==="asc"?new Date(E.createdAt)-new Date(k.createdAt):new Date(k.createdAt)-new Date(E.createdAt));default:return _}},[s,e,d]),S=(_,T)=>{T.stopPropagation();const E=i.some(k=>k.id===(_==null?void 0:_.id));ui(_,E,h,X)};return n?u.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:u.jsx(di,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):b.length===0?u.jsxs(r_,{children:[u.jsx("p",{style:{textAlign:"center"},children:"Нажаль, нічого нового за останній тиждень"}),u.jsxs(i_,{to:"/catalog",children:[u.jsx("p",{children:"Весь каталог"}),u.jsx(Vc,{size:24})]})]}):u.jsxs(b7,{children:[u.jsxs(w7,{children:[u.jsx(Ln,{autoClose:1500}),u.jsxs(S7,{children:[u.jsx(C7,{children:"Нові товари "}),u.jsxs(O7,{ref:g,children:[u.jsxs($7,{onClick:()=>l(_=>!_),children:["Сортування",u.jsx(Bc,{strokeWidth:.9,size:22})]}),a&&u.jsxs(M7,{children:[u.jsx(_i,{onClick:()=>{c("name"),f("asc"),l(!1)},children:"А-Я"}),u.jsx(_i,{onClick:()=>{c("name"),f("desc"),l(!1)},children:"Я-А"}),u.jsx(_i,{onClick:()=>{c("price"),f("asc"),l(!1)},children:"Ціна ↑"}),u.jsx(_i,{onClick:()=>{c("price"),f("desc"),l(!1)},children:"Ціна ↓"}),u.jsx(_i,{onClick:()=>{c("date"),f("desc"),l(!1)},children:"Спочатку новіші"}),u.jsx(_i,{onClick:()=>{c("date"),f("asc"),l(!1)},children:"Спочатку старіші"})]})]})]}),u.jsx(_7,{children:b.map(_=>{var D,z;const T=i.some(F=>F.id===_.id),E=(_==null?void 0:_.available)??!0,k=o.find(F=>F.id===_.id),$=(k?k.quantity:0)>=(_.stock||0),A=_.new_price&&_.new_price<_.price,I=A?_.new_price:_.price,j=A?Math.round((_.price-_.new_price)/_.price*100):0,L=async(F,P)=>{if(P.stopPropagation(),$){X.error("Товар уже у кошику");return}await Za(F,1,h,X)};return u.jsxs(k7,{onClick:()=>w(`/product/${_.slug??_.id}`),children:[!E&&u.jsx(pm,{children:"Бронь"}),u.jsx(hm,{children:"Новинка"}),u.jsx(E7,{src:((z=(D=_.images)==null?void 0:D[0])==null?void 0:z.url)||ri,alt:_.name}),u.jsx(P7,{children:_.name}),u.jsxs(T7,{children:[u.jsx($u,{children:u.jsxs(Mu,{children:[u.jsxs(Iu,{$discount:A,children:[I.toLocaleString()," грн"]}),A&&u.jsxs(Du,{children:[_.price.toLocaleString()," грн"]}),A&&u.jsxs(Lu,{children:["-",j,"%"]})]})}),u.jsxs(j7,{children:[E&&u.jsx(vc,{onClick:F=>L(_,F),children:u.jsx(vo,{size:24,color:k?"var(--orange-color)":"black",strokeWidth:2})}),u.jsx(vc,{onClick:F=>S(_,F),children:u.jsx(Ya,{size:24,fill:T?"#ff4d4f":"none",color:T?"#ff4d4f":"#000000",strokeWidth:T?1:2})})]})]})]},_.id)})}),u.jsxs(n_,{children:[u.jsx(qi,{onClick:()=>m(_=>Math.max(_-1,1)),disabled:v===1,children:"Назад"}),Array.from({length:p},(_,T)=>u.jsx(qi,{onClick:()=>m(T+1),active:v===T+1,children:T+1},T)),u.jsx(qi,{onClick:()=>m(_=>Math.min(_+1,p)),disabled:v===p,children:"Вперед"})]})]})," "]})},q7=()=>{const[e,t]=x.useState([]),[n,r]=x.useState(!0),[i,o]=x.useState(!1),[a,l]=x.useState("date"),[s,c]=x.useState("desc"),[d,f]=x.useState(1),v=24,m=xt(),p=Mt(),y=Ue(k=>k.favorites.items),w=Ue(k=>k.cart.items),h=x.useRef(null);x.useEffect(()=>{const k=O=>{h.current&&!h.current.contains(O.target)&&o(!1)};return document.addEventListener("mousedown",k),()=>{document.removeEventListener("mousedown",k)}},[]),x.useEffect(()=>{(async()=>{const O="https://backenddidiv-production.up.railway.app";try{const A=await(await fetch(`${O}/api/products?filters[new_price][$notNull]=true&pagination[pageSize]=500&populate=*`)).json();t(A.data),r(!1)}catch($){console.log($)}})()},[]),x.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[d]);const g=x.useMemo(()=>{const k=[...e];switch(a){case"name":return k.sort((O,$)=>s==="asc"?O.name.localeCompare($.name):$.name.localeCompare(O.name));case"price":return k.sort((O,$)=>s==="asc"?O.new_price-$.new_price:$.new_price-O.new_price);case"date":return k.sort((O,$)=>s==="asc"?new Date(O.createdAt)-new Date($.createdAt):new Date($.createdAt)-new Date(O.createdAt));default:return k}},[a,e,s]),b=d*v,S=b-v,_=g.slice(S,b),T=Math.ceil(e.length/v),E=(k,O)=>{O.stopPropagation();const $=y.some(A=>A.id===(k==null?void 0:k.id));ui(k,$,p,X)};return n?u.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:u.jsx(di,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):e.length===0?u.jsxs(r_,{children:[u.jsx("p",{style:{textAlign:"center"},children:"Нажаль, поки знижок немає"}),u.jsxs(i_,{to:"/catalog",children:[u.jsx("p",{children:"Весь каталог"}),u.jsx(Vc,{size:24})]})]}):u.jsx(I7,{children:u.jsxs(D7,{children:[u.jsx(Ln,{autoClose:1500}),u.jsxs(L7,{children:[u.jsx(A7,{children:"Акційні товари"}),u.jsxs(U7,{ref:h,children:[u.jsxs(H7,{onClick:()=>o(k=>!k),children:["Сортування",u.jsx(Bc,{strokeWidth:.9,size:22})]}),i&&u.jsxs(W7,{children:[u.jsx(ki,{onClick:()=>{l("name"),c("asc"),o(!1)},children:"А-Я"}),u.jsx(ki,{onClick:()=>{l("name"),c("desc"),o(!1)},children:"Я-А"}),u.jsx(ki,{onClick:()=>{l("price"),c("asc"),o(!1)},children:"Ціна ↑"}),u.jsx(ki,{onClick:()=>{l("price"),c("desc"),o(!1)},children:"Ціна ↓"}),u.jsx(ki,{onClick:()=>{l("date"),c("desc"),o(!1)},children:"Спочатку новіші"}),u.jsx(ki,{onClick:()=>{l("date"),c("asc"),o(!1)},children:"Спочатку старіші"})]})]})]}),u.jsx(R7,{children:_.map(k=>{var M,R;const O=k.new_price&&k.new_price<k.price,$=k!=null&&k.createdAt?Date.now()-new Date(k.createdAt).getTime()<7*24*60*60*1e3:!1,A=O?k.new_price:k.price,I=(k==null?void 0:k.available)??!0,j=O?Math.round((k.price-k.new_price)/k.price*100):0,L=y.some(B=>B.id===k.id),D=w.find(B=>B.id===k.id),F=(D?D.quantity:0)>=(k.stock||0),P=async(B,N)=>{if(N.stopPropagation(),F){X.error("Товар уже у кошику");return}await Za(k,1,p,X)};return u.jsxs(F7,{onClick:()=>m(`/product/${k.slug??k.id}`),style:{cursor:"pointer"},children:["                ",$&&u.jsx(hm,{children:"Новинка"}),!I&&u.jsx(pm,{children:"Бронь"}),u.jsx(z7,{src:((R=(M=k.images)==null?void 0:M[0])==null?void 0:R.url)||"/nofoto.png"}),u.jsx(N7,{children:k.name}),u.jsxs(B7,{children:[u.jsx($u,{children:u.jsxs(Mu,{children:[u.jsxs(Iu,{$discount:O,children:[A.toLocaleString()," грн"]}),O&&u.jsxs(Du,{children:[k.price.toLocaleString()," грн"]}),O&&u.jsxs(Lu,{children:["-",j,"%"]})]})}),u.jsxs(V7,{children:[I&&u.jsx(vc,{onClick:B=>P(k,B),children:u.jsx(vo,{size:24,color:D?"var(--orange-color)":"black",strokeWidth:2})}),u.jsx(vc,{onClick:B=>E(k,B),children:u.jsx(Ya,{size:24,fill:L?"#ff4d4f":"none",color:L?"#ff4d4f":"#000000",strokeWidth:L?1:2})})]})]})]},k.id)})}),g.length>v&&u.jsxs(n_,{children:[u.jsx(qi,{onClick:()=>f(k=>Math.max(k-1,1)),disabled:d===1,children:"Назад"}),Array.from({length:T},(k,O)=>u.jsx(qi,{onClick:()=>f(O+1),active:d===O+1,children:O+1},O)),u.jsx(qi,{onClick:()=>f(k=>Math.min(k+1,T)),disabled:d===T,children:"Вперед"})]})]})})},Y7=C.div`
  position: fixed;
  inset: 0;
...
`;var ag="persist:",o_="persist/FLUSH",sg="persist/REHYDRATE",a_="persist/PAUSE",s_="persist/PERSIST",l_="persist/PURGE",c_="persist/REGISTER",h9=-1;function pl(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?pl=function(n){return typeof n}:pl=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},pl(e)}function fy(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function m9(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?fy(n,!0).forEach(function(r){g9(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):fy(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function g9(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function v9(e,t,n,r){r.debug;var i=m9({},n);return e&&pl(e)==="object"&&Object.keys(e).forEach(function(o){o!=="_persist"&&t[o]===n[o]&&(i[o]=e[o])}),i}function y9(e){var t=e.blacklist||null,n=e.whitelist||null,r=e.transforms||[],i=e.throttle||0,o="".concat(e.keyPrefix!==void 0?e.keyPrefix:ag).concat(e.key),a=e.storage,l;e.serialize===!1?l=function(_){return _}:typeof e.serialize=="function"?l=e.serialize:l=x9;var s=e.writeFailHandler||null,c={},d={},f=[],v=null,m=null,p=function(_){Object.keys(_).forEach(function(T){h(T)&&c[T]!==_[T]&&f.indexOf(T)===-1&&f.push(T)}),Object.keys(c).forEach(function(T){_[T]===void 0&&h(T)&&f.indexOf(T)===-1&&c[T]!==void 0&&f.push(T)}),v===null&&(v=setInterval(y,i)),c=_};function y(){if(f.length===0){v&&clearInterval(v),v=null;return}var S=f.shift(),_=r.reduce(function(T,E){return E.in(T,S,c)},c[S]);if(_!==void 0)try{d[S]=l(_)}catch(T){console.error("redux-persist/createPersistoid: error serializing state",T)}else delete d[S];f.length===0&&w()}function w(){Object.keys(d).forEach(function(S){c[S]===void 0&&delete d[S]}),m=a.setItem(o,l(d)).catch(g)}function h(S){return!(n&&n.indexOf(S)===-1&&S!=="_persist"||t&&t.indexOf(S)!==-1)}function g(S){s&&s(S)}var b=function(){for(;f.length!==0;)y();return m||Promise.resolve()};return{update:p,flush:b}}function x9(e){return JSON.stringify(e)}function b9(e){var t=e.transforms||[],n="".concat(e.keyPrefix!==void 0?e.keyPrefix:ag).concat(e.key),r=e.storage;e.debug;var i;return e.deserialize===!1?i=function(a){return a}:typeof e.deserialize=="function"?i=e.deserialize:i=w9,r.getItem(n).then(function(o){if(o)try{var a={},l=i(o);return Object.keys(l).forEach(function(s){a[s]=t.reduceRight(function(c,d){return d.out(c,s,l)},i(l[s]))}),a}catch(s){throw s}else return})}function w9(e){return JSON.parse(e)}function S9(e){var t=e.storage,n="".concat(e.keyPrefix!==void 0?e.keyPrefix:ag).concat(e.key);return t.removeItem(n,C9)}function C9(e){}function py(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function An(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?py(n,!0).forEach(function(r){_9(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):py(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function _9(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function k9(e,t){if(e==null)return{};var n=E9(e,t),r,i;if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(e);for(i=0;i<o.length;i++)r=o[i],!(t.indexOf(r)>=0)&&Object.prototype.propertyIsEnumerable.call(e,r)&&(n[r]=e[r])}return n}function E9(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}var T9=5e3;function u_(e,t){var n=e.version!==void 0?e.version:h9;e.debug;var r=e.stateReconciler===void 0?v9:e.stateReconciler,i=e.getStoredState||b9,o=e.timeout!==void 0?e.timeout:T9,a=null,l=!1,s=!0,c=function(f){return f._persist.rehydrated&&a&&!s&&a.update(f),f};return function(d,f){var v=d||{},m=v._persist,p=k9(v,["_persist"]),y=p;if(f.type===s_){var w=!1,h=function(k,O){w||(f.rehydrate(e.key,k,O),w=!0)};if(o&&setTimeout(function(){!w&&h(void 0,new Error('redux-persist: persist timed out for persist key "'.concat(e.key,'"')))},o),s=!1,a||(a=y9(e)),m)return An({},t(y,f),{_persist:m});if(typeof f.rehydrate!="function"||typeof f.register!="function")throw new Error("redux-persist: either rehydrate or register is not a function on the PERSIST action. This can happen if the action is being replayed. This is an unexplored use case, please open an issue and we will figure out a resolution.");return f.register(e.key),i(e).then(function(E){var k=e.migrate||function(O,$){return Promise.resolve(O)};k(E,n).then(function(O){h(O)},function(O){h(void 0,O)})},function(E){h(void 0,E)}),An({},t(y,f),{_persist:{version:n,rehydrated:!1}})}else{if(f.type===l_)return l=!0,f.result(S9(e)),An({},t(y,f),{_persist:m});if(f.type===o_)return f.result(a&&a.flush()),An({},t(y,f),{_persist:m});if(f.type===a_)s=!0;else if(f.type===sg){if(l)return An({},y,{_persist:An({},m,{rehydrated:!0})});if(f.key===e.key){var g=t(y,f),b=f.payload,S=r!==!1&&b!==void 0?r(b,d,g,e):g,_=An({},S,{_persist:An({},m,{rehydrated:!0})});return c(_)}}}if(!m)return t(d,f);var T=t(y,f);return T===y?d:c(An({},T,{_persist:m}))}}function hy(e){return O9(e)||j9(e)||P9()}function P9(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function j9(e){if(Symbol.iterator in Object(e)||Object.prototype.toString.call(e)==="[object Arguments]")return Array.from(e)}function O9(e){if(Array.isArray(e)){for(var t=0,n=new Array(e.length);t<e.length;t++)n[t]=e[t];return n}}function my(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(e,i).enumerable})),n.push.apply(n,r)}return n}function th(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]!=null?arguments[t]:{};t%2?my(n,!0).forEach(function(r){$9(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):my(n).forEach(function(r){Object.defineProperty(e,r,Object.getOwnPropertyDescriptor(n,r))})}return e}function $9(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var d_={registry:[],bootstrapped:!1},M9=function(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:d_,n=arguments.length>1?arguments[1]:void 0;switch(n.type){case c_:return th({},t,{registry:[].concat(hy(t.registry),[n.key])});case sg:var r=t.registry.indexOf(n.key),i=hy(t.registry);return i.splice(r,1),th({},t,{registry:i,bootstrapped:i.length===0});default:return t}};function I9(e,t,n){var r=n||!1,i=gm(M9,d_,t&&t.enhancer?t.enhancer:void 0),o=function(c){i.dispatch({type:c_,key:c})},a=function(c,d,f){var v={type:sg,payload:d,err:f,key:c};e.dispatch(v),i.dispatch(v),r&&l.getState().bootstrapped&&(r(),r=!1)},l=th({},i,{purge:function(){var c=[];return e.dispatch({type:l_,result:function(f){c.push(f)}}),Promise.all(c)},flush:function(){var c=[];return e.dispatch({type:o_,result:function(f){c.push(f)}}),Promise.all(c)},pause:function(){e.dispatch({type:a_})},persist:function(){e.dispatch({type:s_,register:o,rehydrate:a})}});return t&&t.manualPersist||l.persist(),l}var lg={},cg={};cg.__esModule=!0;cg.default=A9;function hl(e){return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?hl=function(n){return typeof n}:hl=function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},hl(e)}function hf(){}var D9={getItem:hf,setItem:hf,removeItem:hf};function L9(e){if((typeof self>"u"?"undefined":hl(self))!=="object"||!(e in self))return!1;try{var t=self[e],n="redux-persist ".concat(e," test");t.setItem(n,"test"),t.getItem(n),t.removeItem(n)}catch{return!1}return!0}function A9(e){var t="".concat(e,"Storage");return L9(t)?self[t]:D9}lg.__esModule=!0;lg.default=z9;var R9=F9(cg);function F9(e){return e&&e.__esModule?e:{default:e}}function z9(e){var t=(0,R9.default)(e);return{getItem:function(r){return new Promise(function(i,o){i(t.getItem(r))})},setItem:function(r,i){return new Promise(function(o,a){o(t.setItem(r,i))})},removeItem:function(r){return new Promise(function(i,o){i(t.removeItem(r))})}}}var ug=void 0,N9=B9(lg);function B9(e){return e&&e.__esModule?e:{default:e}}var V9=(0,N9.default)("local");ug=V9;const U9={key:"cart",storage:ug},W9={key:"favorites",storage:ug},H9=u_(U9,W$),G9=u_(W9,N$),f_=T$({reducer:{cart:H9,favorites:G9},middleware:e=>e({serializableCheck:!1})}),p_=I9(f_),q9=C.div`
  position: fixed;
  inset: 0;
  z-index: 9999;
...
`,h_=({onClose:e,onConfirm:t})=>u.jsx(q9,{onClick:e,children:u.jsxs(Y9,{onClick:n=>n.stopPropagation(),children:[u.jsx(X9,{children:"Вийти з акаунту?"}),u.jsx(K9,{children:"Ви впевнені, що хочете вийти з особистого кабінету?"}),u.jsxs(Q9,{children:[u.jsx(Z9,{onClick:e,children:"Скасувати"}),u.jsx(J9,{onClick:t,children:"Вийти"})]})]})}),eB=()=>{var c,d;const[e,t]=x.useState(""),[n,r]=x.useState(""),[i,o]=x.useState(!1),a=Mt(),l=xt();x.useEffect(()=>{(async()=>{try{const v=localStorage.getItem("token"),p=await(await fetch("https://backenddidiv-production.up.railway.app/api/users/me",{headers:{Authorization:`Bearer ${v}`}})).json();t(p.first_name),r(p.email)}catch(v){console.error(v)}})()},[]);const s=async()=>{localStorage.removeItem("token"),localStorage.removeItem("user"),a(eS()),a(yo()),await p_.purge(),l("/",{replace:!0})};return u.jsxs(c9,{children:[i&&u.jsx(h_,{onClose:()=>o(!1),onConfirm:s}),u.jsxs(u9,{children:[u.jsx(d9,{children:((d=(c=e||e)==null?void 0:c[0])==null?void 0:d.toUpperCase())||"?"}),u.jsxs("div",{children:[u.jsx(f9,{children:e}),u.jsx(p9,{children:n})]})]}),u.jsxs(dy,{children:[u.jsxs(dy,{children:[u.jsx(Rs,{to:"/account/profile",children:"Особисті дані"}),u.jsx(Rs,{to:"/account/orders",children:"Замовлення"}),u.jsx(Rs,{to:"/account/password",children:"Змінити пароль"})]}),u.jsx(Rs,{as:"button",className:"logout",onClick:()=>o(!0),children:"Вийти"})]})]})};var dg={};dg.match=aB;dg.parse=m_;var tB=/(?:(only|not)?\s*([^\s\(\)]+)(?:\s*and)?\s*)?(.+)?/i,nB=/\(\s*([^\s\:\)]+)\s*(?:\:\s*([^\s\)]+))?\s*\)/,rB=/^(?:(min|max)-)?(.+)/,iB=/(em|rem|px|cm|mm|in|pt|pc)?$/,oB=/(dpi|dpcm|dppx)?$/;function aB(e,t){return m_(e).some(function(n){var r=n.inverse,i=n.type==="all"||t.type===n.type;if(i&&r||!(i||r))return!1;var o=n.expressions.every(function(a){var l=a.feature,s=a.modifier,c=a.value,d=t[l];if(!d)return!1;switch(l){case"orientation":case"scan":return d.toLowerCase()===c.toLowerCase();case"width":case"height":case"device-width":case"device-height":c=yy(c),d=yy(d);break;case"resolution":c=vy(c),d=vy(d);break;case"aspect-ratio":case"device-aspect-ratio":case"device-pixel-ratio":c=gy(c),d=gy(d);break;case"grid":case"color":case"color-index":case"monochrome":c=parseInt(c,10)||1,d=parseInt(d,10)||0;break}switch(s){case"min":return d>=c;case"max":return d<=c;default:return d===c}});return o&&!r||!o&&r})}function m_(e){return e.split(",").map(function(t){t=t.trim();var n=t.match(tB),r=n[1],i=n[2],o=n[3]||"",a={};return a.inverse=!!r&&r.toLowerCase()==="not",a.type=i?i.toLowerCase():"all",o=o.match(/\([^\)]+\)/g)||[],a.expressions=o.map(function(l){var s=l.match(nB),c=s[1].toLowerCase().match(rB);return{modifier:c[1],feature:c[2],value:s[2]}}),a})}function gy(e){var t=Number(e),n;return t||(n=e.match(/^(\d+)\s*\/\s*(\d+)$/),t=n[1]/n[2]),t}function vy(e){var t=parseFloat(e),n=String(e).match(oB)[1];switch(n){case"dpcm":return t/2.54;case"dppx":return t*96;default:return t}}function yy(e){var t=parseFloat(e),n=String(e).match(iB)[1];switch(n){case"em":return t*16;case"rem":return t*16;case"cm":return t*96/2.54;case"mm":return t*96/2.54/10;case"in":return t*96;case"pt":return t*72;case"pc":return t*72/12;default:return t}}var sB=dg.match,xy=typeof window<"u"?window.matchMedia:null;function lB(e,t,n){var r=this,i;xy&&!n&&(i=xy.call(window,e)),i?(this.matches=i.matches,this.media=i.media,i.addListener(l)):(this.matches=sB(e,t),this.media=e),this.addListener=o,this.removeListener=a,this.dispose=s;function o(c){i&&i.addListener(c)}function a(c){i&&i.removeListener(c)}function l(c){r.matches=c.matches,r.media=c.media}function s(){i&&i.removeListener(l)}}function cB(e,t,n){return new lB(e,t,n)}var uB=cB;const dB=Na(uB);var fB=/[A-Z]/g,pB=/^ms-/,mf={};function hB(e){return"-"+e.toLowerCase()}function g_(e){if(mf.hasOwnProperty(e))return mf[e];var t=e.replace(fB,hB);return mf[e]=pB.test(t)?"-"+t:t}function mB(e,t){if(e===t)return!0;if(!e||!t)return!1;const n=Object.keys(e),r=Object.keys(t),i=n.length;if(r.length!==i)return!1;for(let o=0;o<i;o++){const a=n[o];if(e[a]!==t[a]||!Object.prototype.hasOwnProperty.call(t,a))return!1}return!0}var v_={exports:{}},gB="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",vB=gB,yB=vB;function y_(){}function x_(){}x_.resetWarningCache=y_;var xB=function(){function e(r,i,o,a,l,s){if(s!==yB){var c=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw c.name="Invariant Violation",c}}e.isRequired=e;function t(){return e}var n={array:e,bigint:e,bool:e,func:e,number:e,object:e,string:e,symbol:e,any:e,arrayOf:t,element:e,elementType:e,instanceOf:t,node:e,objectOf:t,oneOf:t,oneOfType:t,shape:t,exact:t,checkPropTypes:x_,resetWarningCache:y_};return n.PropTypes=n,n};v_.exports=xB();var bB=v_.exports;const fe=Na(bB),pt=fe.oneOfType([fe.string,fe.number]),fg={all:fe.bool,grid:fe.bool,aural:fe.bool,braille:fe.bool,handheld:fe.bool,print:fe.bool,projection:fe.bool,screen:fe.bool,tty:fe.bool,tv:fe.bool,embossed:fe.bool},b_={orientation:fe.oneOf(["portrait","landscape"]),scan:fe.oneOf(["progressive","interlace"]),aspectRatio:fe.string,deviceAspectRatio:fe.string,height:pt,deviceHeight:pt,width:pt,deviceWidth:pt,color:fe.bool,colorIndex:fe.bool,monochrome:fe.bool,resolution:pt,type:Object.keys(fg)},{type:cV,...wB}=b_,w_={minAspectRatio:fe.string,maxAspectRatio:fe.string,minDeviceAspectRatio:fe.string,maxDeviceAspectRatio:fe.string,minHeight:pt,maxHeight:pt,minDeviceHeight:pt,maxDeviceHeight:pt,minWidth:pt,maxWidth:pt,minDeviceWidth:pt,maxDeviceWidth:pt,minColor:fe.number,maxColor:fe.number,minColorIndex:fe.number,maxColorIndex:fe.number,minMonochrome:fe.number,maxMonochrome:fe.number,minResolution:pt,maxResolution:pt,...wB},SB={...fg,...w_};var CB={all:SB,types:fg,matchers:b_,features:w_};const _B=e=>`not ${e}`,kB=(e,t)=>{const n=g_(e);return typeof t=="number"&&(t=`${t}px`),t===!0?n:t===!1?_B(n):`(${n}: ${t})`},EB=e=>e.join(" and "),TB=e=>{const t=[];return Object.keys(CB.all).forEach(n=>{const r=e[n];r!=null&&t.push(kB(n,r))}),EB(t)},PB=x.createContext(void 0),jB=e=>e.query||TB(e),by=e=>e?Object.keys(e).reduce((n,r)=>(n[g_(r)]=e[r],n),{}):void 0,S_=()=>{const e=x.useRef(!1);return x.useEffect(()=>{e.current=!0},[]),e.current},OB=e=>{const t=x.useContext(PB),n=()=>by(e)||by(t),[r,i]=x.useState(n);return x.useEffect(()=>{const o=n();mB(r,o)||i(o)},[e,t]),r},$B=e=>{const t=()=>jB(e),[n,r]=x.useState(t);return x.useEffect(()=>{const i=t();n!==i&&r(i)},[e]),n},MB=(e,t)=>{const n=()=>dB(e,t||{},!!t),[r,i]=x.useState(n),o=S_();return x.useEffect(()=>{if(o){const a=n();return i(a),()=>{a&&a.dispose()}}},[e,t]),r},IB=e=>{const[t,n]=x.useState(e.matches);return x.useEffect(()=>{const r=i=>{n(i.matches)};return e.addListener(r),n(e.matches),()=>{e.removeListener(r)}},[e]),t},DB=(e,t,n)=>{const r=OB(t),i=$B(e);if(!i)throw new Error("Invalid or missing MediaQuery!");const o=MB(i,r),a=IB(o),l=S_();return x.useEffect(()=>{l&&n&&n(a)},[a]),x.useEffect(()=>()=>{o&&o.dispose()},[]),a},LB=C.div`
  margin-bottom: 24px;
`,AB=C.div`
  display: flex;
  align-items: center;
...
`,VB=()=>{var p,y;const[e,t]=x.useState(!1),[n,r]=x.useState(!1),[i,o]=x.useState(""),[a,l]=x.useState(""),s=Mt(),c=xt(),d=Dn(),f=async()=>{localStorage.removeItem("token"),localStorage.removeItem("user"),s(eS()),s(yo()),await p_.purge(),c("/",{replace:!0})};x.useEffect(()=>{(async()=>{try{const h=localStorage.getItem("token"),b=await(await fetch("https://backenddidiv-production.up.railway.app/api/users/me",{headers:{Authorization:`Bearer ${h}`}})).json();o(b.first_name),l(b.email)}catch(h){console.error(h)}})()},[]);const m={"/account":"Особисті дані","/account/profile":"Особисті дані","/account/orders":"Замовлення","/account/favorites":"Обране","/account/password":"Змінити пароль"}[d.pathname]||"Особисті дані";return u.jsxs(LB,{children:[n&&u.jsx(h_,{onClose:()=>r(!1),onConfirm:f}),u.jsxs(AB,{children:[u.jsx(RB,{children:((y=(p=i||i)==null?void 0:p[0])==null?void 0:y.toUpperCase())||"?"}),u.jsxs("div",{children:[u.jsx(FB,{children:i}),u.jsx(zB,{children:a})]})]}),u.jsxs(NB,{onClick:()=>t(w=>!w),children:[m,e?u.jsx(xO,{size:22}):u.jsx(vO,{size:22})]}),e&&u.jsxs(BB,{children:[u.jsx(Fs,{to:"/account/profile",onClick:()=>t(!1),children:"Особисті дані"}),u.jsx(Fs,{to:"/account/orders",onClick:()=>t(!1),children:"Замовлення"}),u.jsx(Fs,{to:"/account/password",onClick:()=>t(!1),children:"Змінити пароль"}),u.jsx(Fs,{className:"logout",onClick:()=>r(!0),children:"Вийти"})]})]})},UB=()=>{const e=DB({maxWidth:767});return u.jsxs(s9,{className:"container",children:[e?u.jsx(VB,{}):u.jsx(eB,{}),u.jsx(l9,{children:u.jsx(By,{})})]})},WB=C.div`
  background: white;
  border-radius: 24px;
  padding: 24px;
...
`,oV=C.div`
  ...
  flex-wrap: wrap;
  gap: 16px;
`,aV=()=>{const[e,t]=x.useState([]),[n,r]=x.useState(!0),i=localStorage.getItem("token"),o=JSON.parse(localStorage.getItem("user"));return x.useEffect(()=>{(async()=>{try{const s=await(await fetch(`https://backenddidiv-production.up.railway.app/api/orders?filters[email][$eq]=${encodeURIComponent(o.email)}`,{headers:{Authorization:`Bearer ${i}`}})).json(),c=Array.isArray(s)?s:s.data||[];t(c)}catch(l){console.error("Помилка завантаження замовлень:",l)}finally{r(!1)}})()},[i,o.email]),u.jsx(qB,{children:u.jsx(YB,{children:u.jsxs(XB,{children:[u.jsx(KB,{children:"Мої замовлення"}),n?u.jsx("p",{children:"Завантаження замовлень..."}):e.length===0?u.jsx("p",{children:"У вас поки немає замовлень."}):u.jsx(QB,{children:e.map(a=>{const l=a.attributes||a,s=typeof l.products=="string"?JSON.parse(l.products):l.products||[];return u.jsxs(ZB,{children:[u.jsx(JB,{children:u.jsxs("div",{children:[u.jsxs(eV,{children:["№ ",l.order_number]}),u.jsx(tV,{status:l.status_order,children:l.status_order||"pending"})]})}),u.jsx(nV,{children:s.map(c=>u.jsxs(rV,{children:[u.jsx("img",{src:c.image,alt:c.name}),u.jsxs(iV,{children:[u.jsx("p",{children:c.name}),u.jsxs("span",{children:[c.quantity," шт. × ",c.price," грн"]})]})]},c.id))}),u.jsxs(oV,{children:[l.city&&u.jsxs("span",{children:[u.jsx("b",{children:"Місто:"})," ",l.city]}),l.delivery_method&&u.jsxs("span",{children:[u.jsx("b",{children:"Доставка:"})," ",l.delivery_method]}),l.delivery_address&&u.jsxs("span",{children:[u.jsx("b",{children:"Адреса:"})," ",l.delivery_address]}),l.ttn&&u.jsxs("span",{children:[u.jsx("b",{children:"ТТН:"})," ",l.ttn]})]})]},a.id||l.order_number)})})]})})})};function sV(){const e=Mt(),[t,n]=x.useState(!1),[r,i]=x.useState("login"),o=!!localStorage.getItem("token"),a=localStorage.getItem("token"),l=JSON.parse(localStorage.getItem("user")||"null"),s=l==null?void 0:l.documentId,c=Ue(f=>f.favorites.items),d=Ue(f=>f.cart.items);return x.useEffect(()=>{if(!a||!s)return;(async()=>{const v=localStorage.getItem("token");if(!v)return;const y=(await(await fetch(`https://backenddidiv-production.up.railway.app/api/favorites?filters[user][documentId][$eq]=${s}&populate=product.images`,{headers:{Authorization:`Bearer ${v}`}})).json()).data.map(w=>({...w.product,favoriteId:w.id,favoriteDocumentId:w.documentId}));e(z$(y))})()},[s,e,a]),u.jsxs(b5,{children:[u.jsx(nI,{}),u.jsx(s7,{}),u.jsxs(x.Suspense,{fallback:u.jsx(eI,{}),children:[u.jsx(Lk,{children:u.jsxs(De,{path:"/",element:u.jsx(HO,{openLogin:()=>{i("login"),n(!0)},openRegister:()=>{i("register"),n(!0)}}),children:[u.jsx(De,{index:!0,element:u.jsx(KD,{})}),u.jsx(De,{path:"catalog",element:u.jsx(h5,{})}),u.jsx(De,{path:"/catalog/:category",element:u.jsx(B6,{})}),u.jsx(De,{path:"/product/:identifier",element:u.jsx(tR,{})}),u.jsx(De,{path:"cart",element:u.jsx(HR,{})}),u.jsx(De,{path:"favorite",element:u.jsx(ZR,{})}),u.jsx(De,{path:"/catalog/new",element:u.jsx(G7,{})}),u.jsx(De,{path:"/catalog/sale",element:u.jsx(q7,{})}),u.jsx(De,{path:"checkout",element:u.jsx(BN,{})}),u.jsx(De,{path:"/order-confirmation",element:u.jsx(XN,{})}),u.jsx(De,{path:"about",element:u.jsx(a7,{})}),u.jsx(De,{path:"contacts",element:u.jsx(x7,{})}),u.jsx(De,{path:"delivery",element:u.jsx(i8,{})}),u.jsxs(De,{path:"account",element:u.jsx(a9,{isLoggedIn:o,children:u.jsx(UB,{})}),children:[u.jsx(De,{index:!0,element:u.jsx(wy,{})}),u.jsx(De,{path:"profile",element:u.jsx(wy,{})}),u.jsx(De,{path:"orders",element:u.jsx(aV,{})})]}),u.jsx(De,{path:"*",element:u.jsx(x5,{})})]})}),u.jsx(o9,{localFavorites:c,localCartItems:d,isOpen:t,mode:r,onClose:()=>n(!1),setMode:i})]})]})}bf.createRoot(document.getElementById("root")).render(u.jsx(Wj,{store:f_,children:u.jsx(K.StrictMode,{children:u.jsx(Vk,{basename:"/Didiv/",children:u.jsx(sV,{})})})}));
