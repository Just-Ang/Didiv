 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,D){var N=P.length;P.push(D);e:for(;0<N;){var B=N-1>>>1,z=P[B];if(0<i(z,D))P[B]=D,P[N]=z,N=B;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var D=P[0],N=P.pop();if(N!==D){P[0]=N;e:for(var B=0,z=P.length,G=z>>>1;B<G;){var Q=2*(B+1)-1,Z=P[Q],K=Q+1,re=P[K];if(0>i(Z,N))K<z&&0>i(re,Z)?(P[B]=re,P[K]=N,B=K):(P[B]=Z,P[Q]=N,B=Q);else if(K<z&&0>i(re,N))P[B]=re,P[K]=N,B=K;else break e}}return D}function i(P,D){var N=P.sortIndex-D.sortIndex;return N!==0?N:P.id-D.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var s=[],u=[],c=1,d=null,h=3,p=!1,v=!1,g=!1,w=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(P){for(var D=n(u);D!==null;){if(D.callback===null)r(u);else if(D.startTime<=P)r(u),D.sortIndex=D.expirationTime,t(s,D);else break;D=n(u)}}function S(P){if(g=!1,x(P),!v)if(n(s)!==null)v=!0,F(C);else{var D=n(u);D!==null&&A(S,D.startTime-P)}}function C(P,D){v=!1,g&&(g=!1,f(E),E=-1),p=!0;var N=h;try{for(x(D),d=n(s);d!==null&&(!(d.expirationTime>D)||P&&!$());){var B=d.callback;if(typeof B=="function"){d.callback=null,h=d.priorityLevel;var z=B(d.expirationTime<=D);D=e.unstable_now(),typeof z=="function"?d.callback=z:d===n(s)&&r(s),x(D)}else r(s);d=n(s)}if(d!==null)var G=!0;else{var Q=n(u);Q!==null&&A(S,Q.startTime-D),G=!1}return G}finally{d=null,h=N,p=!1}}var k=!1,_=null,E=-1,M=5,I=-1;function $(){return!(e.unstable_now()-I<M)}function O(){if(_!==null){var P=e.unstable_now();I=P;var D=!0;try{D=_(!0,P)}finally{D?j():(k=!1,_=null)}}else k=!1}var j;if(typeof m=="function")j=function(){m(O)};else if(typeof MessageChannel<"u"){var R=new MessageChannel,L=R.port2;R.port1.onmessage=O,j=function(){L.postMessage(null)}}else j=function(){w(O,0)};function F(P){_=P,k||(k=!0,j())}function A(P,D){E=w(function(){P(e.unstable_now())},D)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){v||p||(v=!0,F(C))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(P){switch(h){case 1:case 2:case 3:var D=3;break;default:D=h}var N=h;h=D;try{return P()}finally{h=N}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,D){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var N=h;h=P;try{return D()}finally{h=N}},e.unstable_scheduleCallback=function(P,D,N){var B=e.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?B+N:B):N=B,P){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=N+z,P={id:c++,callback:D,priorityLevel:P,startTime:N,expirationTime:z,sortIndex:-1},N>B?(P.sortIndex=N,t(u,P),n(s)===null&&P===n(u)&&(g?(f(E),E=-1):g=!0,A(S,N-B))):(P.sortIndex=z,t(s,P),v||p||(v=!0,F(C))),P},e.unstable_shouldYield=$,e.unstable_wrapCallback=function(P){var D=h;return function(){var N=h;h=D;try{return P.apply(this,arguments)}finally{h=N}}}})(B1);V1.exports=B1;var vE=V1.exports;/**
 * @license React
...
`,PS=({childValues:e,onChange:t})=>{const o=(e==null?void 0:e[0])??1340,a=(e==null?void 0:e[1])??100340,[l,s]=b.useState([o,a]);b.useEffect(()=>{e&&e.length===2&&(s(e),t&&t(e))},[e]);const u=h=>{s(h),t&&t(h)},c=(h,p)=>{const v=p===""?"":Number(p),g=[...l];g[h]=v,u(g)},d=h=>{const p=[...l];h===0?((p[0]===""||p[0]<o)&&(p[0]=o),p[0]>p[1]-100&&(p[0]=p[1]-100)):((p[1]===""||p[1]>a)&&(p[1]=a),p[1]<p[0]+100&&(p[1]=p[0]+100)),u(p)};return y.jsxs(h$,{children:[y.jsxs(m$,{children:[y.jsx(fv,{type:"number",value:l[0],min:o,max:l[1],onChange:h=>c(0,h.target.value),onBlur:()=>d(0)}),y.jsx(fv,{type:"number",value:l[1],min:l[0],max:a,onChange:h=>c(1,h.target.value),onBlur:()=>d(1)})]}),y.jsx(hp.Range,{values:l,step:100,min:o,max:a,onChange:u,renderTrack:({props:h,children:p})=>y.jsx(g$,{...h,background:hp.getTrackBackground({values:l,colors:["#ddd","#85683d","#ddd"],min:o,max:a}),children:p}),renderThumb:({props:h})=>y.jsx(v$,{...h})})]})},y$=({childValues:e,category:t,selectedFilters:n,setSelectedFilters:r,setPriceRange:i})=>{const[o,a]=b.useState([]);console.log(o),b.useEffect(()=>{t&&(async()=>{var v;try{const f=((v=(await(await fetch(`https://backenddidiv-production.up.railway.app/api/categories?filters[id_title][$eq]=${t}&populate=filters`)).json()).data[0])==null?void 0:v.filters)||[];a(f)}catch(g){console.error(g)}})()},[t]);const[l,s]=b.useState({}),u=p=>{s(v=>({...v,[p]:!v[p]}))},c=(p,v)=>{r(g=>{const w=g[p]||[];return w.includes(v)?{...g,[p]:w.filter(f=>f!==v)}:{...g,[p]:[...w,v]}})},d=Object.values(n).some(p=>Array.isArray(p)&&p.length>0),h=()=>{d&&r({})};return console.log(d),y.jsxs(Qj,{children:[y.jsxs(Jj,{children:["Фільтри ",y.jsx(bb,{size:20})]}),(o||[]).map(p=>{var g;const v=!!l[p.name];return y.jsxs(e$,{children:[y.jsxs(t$,{onClick:()=>u(p.name),children:[y.jsx(n$,{children:p.label}),y.jsx(r$,{isOpen:v})]}),y.jsxs(i$,{isOpen:v,children:[p.type==="checkbox"&&((g=p.options)==null?void 0:g.map(w=>{var f;return y.jsxs(o$,{children:[y.jsx(pp,{checked:((f=n[p.name])==null?void 0:f.includes(w))||!1,onChange:()=>c(p.name,w)}),y.jsx(a$,{}),w]},w)})),p.type==="range"&&y.jsx(PS,{onChange:i,childValues:e})]})]},p.name)}),y.jsx(TS,{onClick:h,disabled:!d,children:"Скинути обрані фільтри"})]})},x$=T.aside`
  width: 100%;
  max-width: 400px;
  background: #ffffff;
  padding: 20px;
...
`,T$=({childValues:e,category:t,selectedFilters:n,setSelectedFilters:r,setPriceRange:i})=>{const[o,a]=b.useState({}),[l,s]=b.useState([]);console.log(l),b.useEffect(()=>{t&&(async()=>{var h;try{const g=((h=(await(await fetch(`https://backenddidiv-production.up.railway.app/api/categories?filters[id_title][$eq]=${t}&populate=filters`)).json()).data[0])==null?void 0:h.filters)||[];s(g)}catch(p){console.error(p)}})()},[t]);const u=d=>{a(h=>({...h,[d]:!h[d]}))},c=(d,h)=>{r(p=>{const v=p[d]||[];return v.includes(h)?{...p,[d]:v.filter(g=>g!==h)}:{...p,[d]:[...v,h]}})};return y.jsx(x$,{children:(l||[]).map(d=>{var p;const h=!!o[d.name];return y.jsxs(b$,{children:[y.jsxs(w$,{onClick:()=>u(d.name),children:[y.jsx(S$,{children:d.label}),y.jsx(_$,{isOpen:h})]}),y.jsxs(E$,{isOpen:h,children:[d.type==="checkbox"&&((p=d.options)==null?void 0:p.map(v=>{var g;return y.jsxs(C$,{children:[y.jsx(mp,{checked:((g=n[d.name])==null?void 0:g.includes(v))||!1,onChange:()=>c(d.name,v)}),y.jsx(k$,{}),v]},v)})),d.type==="range"&&y.jsx(PS,{onChange:i,childValues:e})]})]},d.name)})})};T.div``;const P$=T.div`
  flex: 1;
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  align-items: start;
...
`,dR=({item:e})=>{const t=eo();return y.jsxs(cR,{children:[y.jsx("button",{onClick:()=>t(ej(e.id)),children:"-"}),y.jsx("span",{children:e.quantity}),y.jsx("button",{onClick:()=>t(J5(e.id)),children:"+"})]})},fR=()=>{const e=eo(),[t,n]=b.useState([]),r=Nn(h=>h.cart.items),o=Nn(h=>h.cart.items).reduce((h,p)=>h+p.quantity,0),a=r.reduce((h,p)=>h+p.price*(p.quantity||1),0),l=Nn(h=>h.favorites.items),s=r.length===0,u=(h,p)=>{p.stopPropagation(),console.log(h);const v=l.some(g=>g.id===h.id);e(ac(h)),v?te.warning(`${h.name} видалено з обраного`):te.info(`${h.name} додано в обране`)},c=h=>{n(p=>[...p,h.id]),setTimeout(()=>{e(K5(h)),n(p=>p.filter(v=>v!==h.id))},300)},d=()=>{e(Z5())};return y.jsx(y.Fragment,{children:s?y.jsx(uR,{}):y.jsxs(zL,{children:[y.jsx(Ra,{autoClose:1500}),y.jsxs(VL,{children:[" ",y.jsx(Pe,{to:"/",style:{color:"inherit",textDecoration:"none"},children:"Головна"})," ","/"," ",y.jsx(Pe,{to:"/cart",style:{color:"inherit",textDecoration:"none"},children:"Кошик"})]}),y.jsx(BL,{children:"Кошик"}),y.jsxs(UL,{children:[y.jsx(HL,{children:r.map((h,p)=>{var g,w;console.log(h);const v=l.some(f=>f.id===h.id);return y.jsxs(WL,{className:t.includes(h.id)?"removing":"",children:[y.jsx(GL,{src:((w=(g=h.images)==null?void 0:g[0])==null?void 0:w.url)||"/nofoto.png",alt:h.name,onError:f=>{f.currentTarget.onerror=null,f.currentTarget.src=wa}}),y.jsx(YL,{children:y.jsx("h3",{children:h.name})}),y.jsxs(XL,{children:[y.jsx(dR,{item:{...h,quantity:h.quantity||1}}),y.jsx(KL,{children:y.jsxs("div",{className:"current-price",children:[(h.price*(h.quantity||1)).toLocaleString()," грн"]})})]}),y.jsxs(qL,{children:[y.jsx(QL,{onClick:f=>u(h,f),style:{background:"none",border:"none",cursor:"pointer",color:"#ccc"},children:y.jsx(xb,{size:22,fill:v?"#ff4d4f":"none",color:v?"#ff4d4f":"#999"})}),y.jsx(ZL,{onClick:()=>c(h),style:{background:"none",border:"none",cursor:"pointer",color:"#000000"},children:y.jsx(wb,{size:22})})]})]},`${h.id}-${p}`)})}),y.jsxs(JL,{children:[y.jsxs(eR,{children:[y.jsx("span",{children:"Всього в обраному:"}),y.jsxs("strong",{children:[o," шт."]}),y.jsx("span",{children:"На суму:"}),y.jsxs("strong",{children:[a," грн"]})]}),y.jsx(tR,{to:"/checkout",children:"Оформити замовлення"}),y.jsx(nR,{onClick:d,children:"Oчистити кошик"})]})]})]})})},pR=T.div`
  color: var(-black-color);
  font-family: var(--main-font);
  width: 100%;
  max-width: 750px;
