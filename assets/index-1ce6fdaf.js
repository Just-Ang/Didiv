 ...
 *
 * @license MIT
 */function Yc(){return Yc=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Yc.apply(this,arguments)}function JS(e,t){if(e==null)return{};var n={},r=Object.keys(e),i,o;for(o=0;o<r.length;o++)i=r[o],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}function e_(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function t_(e,t){return e.button===0&&(!t||t==="_self")&&!e_(e)}const n_=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset"],r_="startTransition",kh=Uc[r_];function i_(e){let{basename:t,children:n,future:r,window:i}=e,o=T.useRef();o.current==null&&(o.current=lS({window:i,v5Compat:!0}));let a=o.current,[l,s]=T.useState({action:a.action,location:a.location}),{v7_startTransition:u}=r||{},c=T.useCallback(d=>{u&&kh?kh(()=>s(d)):s(d)},[s,u]);return T.useLayoutEffect(()=>a.listen(c),[a,c]),T.createElement(QS,{basename:t,children:n,location:l.location,navigationType:l.action,navigator:a})}const o_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",a_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Be=T.forwardRef(function(t,n){let{onClick:r,relative:i,reloadDocument:o,replace:a,state:l,target:s,to:u,preventScrollReset:c}=t,d=JS(t,n_),{basename:g}=T.useContext(_i),h,v=!1;if(typeof u=="string"&&a_.test(u)&&(h=u,o_))try{let p=new URL(window.location.href),y=u.startsWith("//")?new URL(p.protocol+u):new URL(u),b=If(y.pathname,g);y.origin===p.origin&&b!=null?u=b+y.search+y.hash:v=!0}catch{}let x=DS(u,{relative:i}),w=s_(u,{replace:a,state:l,target:s,preventScrollReset:c,relative:i});function f(p){r&&r(p),p.defaultPrevented||w(p)}return T.createElement("a",Yc({},d,{href:h||x,onClick:v||o?r:f,ref:n,target:s}))});var Th;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher"})(Th||(Th={}));var Oh;(function(e){e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Oh||(Oh={}));function s_(e,t){let{target:n,replace:r,state:i,preventScrollReset:o,relative:a}=t===void 0?{}:t,l=gl(),s=Ci(),u=av(e,{relative:a});return T.useCallback(c=>{if(t_(c,n)){c.preventDefault();let d=r!==void 0?r:gs(s)===gs(u);l(e,{replace:d,state:i,preventScrollReset:o,relative:a})}},[s,l,u,r,i,n,e,o,a])}var qc={},uv={exports:{}},Et={},cv={exports:{}},dv={};/**
 * @license React
...
`,Xm="/Didiv/assets/logo-ec96fce3.png",ME=E.div`
 display: flex;
  align-items: center;
  background: #ffffff2b;
   border-radius: 12px;
...
`,qt="/Didiv/assets/symbol-defs-f1e4efb3.svg",RE=()=>{const[e,t]=T.useState("");return m.jsxs(ME,{children:[m.jsx(IE,{name:"site-search",value:e,onChange:n=>t(n.target.value),placeholder:"Пошук",autoComplete:"off"}),m.jsx($E,{className:"search-button",children:m.jsx(DE,{children:m.jsx("use",{href:`${qt}#icon-search`})})})]})};var Ly={exports:{}},Fy={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ea=T;function AE(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var LE=typeof Object.is=="function"?Object.is:AE,FE=ea.useSyncExternalStore,zE=ea.useRef,NE=ea.useEffect,BE=ea.useMemo,VE=ea.useDebugValue;Fy.useSyncExternalStoreWithSelector=function(e,t,n,r,i){var o=zE(null);if(o.current===null){var a={hasValue:!1,value:null};o.current=a}else a=o.current;o=BE(function(){function s(h){if(!u){if(u=!0,c=h,h=r(h),i!==void 0&&a.hasValue){var v=a.value;if(i(v,h))return d=v}return d=h}if(v=d,LE(c,h))return v;var x=r(h);return i!==void 0&&i(v,x)?(c=h,v):(c=h,d=x)}var u=!1,c,d,g=n===void 0?null:n;return[function(){return s(t())},g===null?void 0:function(){return s(g())}]},[t,n,r,i]);var l=FE(e,o[0],o[1]);return NE(function(){a.hasValue=!0,a.value=l},[l]),VE(l),l};Ly.exports=Fy;var HE=Ly.exports;function UE(e){e()}function WE(){let e=null,t=null;return{clear(){e=null,t=null},notify(){UE(()=>{let n=e;for(;n;)n.callback(),n=n.next})},get(){const n=[];let r=e;for(;r;)n.push(r),r=r.next;return n},subscribe(n){let r=!0;const i=t={callback:n,next:null,prev:t};return i.prev?i.prev.next=i:e=i,function(){!r||e===null||(r=!1,i.next?i.next.prev=i.prev:t=i.prev,i.prev?i.prev.next=i.next:e=i.next)}}}}var Km={notify(){},get:()=>[]};function GE(e,t){let n,r=Km,i=0,o=!1;function a(x){c();const w=r.subscribe(x);let f=!1;return()=>{f||(f=!0,w(),d())}}function l(){r.notify()}function s(){v.onStateChange&&v.onStateChange()}function u(){return o}function c(){i++,n||(n=t?t.addNestedSub(s):e.subscribe(s),r=WE())}function d(){i--,n&&i===0&&(n(),n=void 0,r.clear(),r=Km)}function g(){o||(o=!0,c())}function h(){o&&(o=!1,d())}const v={addNestedSub:a,notifyNestedSubs:l,handleChangeWrapper:s,isSubscribed:u,trySubscribe:g,tryUnsubscribe:h,getListeners:()=>r};return v}var YE=()=>typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",qE=YE(),XE=()=>typeof navigator<"u"&&navigator.product==="ReactNative",KE=XE(),QE=()=>qE||KE?T.useLayoutEffect:T.useEffect,ZE=QE(),rc=Symbol.for("react-redux-context"),ic=typeof globalThis<"u"?globalThis:{};function JE(){if(!T.createContext)return{};const e=ic[rc]??(ic[rc]=new Map);let t=e.get(T.createContext);return t||(t=T.createContext(null),e.set(T.createContext,t)),t}var ar=JE();function ek(e){const{children:t,context:n,serverState:r,store:i}=e,o=T.useMemo(()=>{const s=GE(i);return{store:i,subscription:s,getServerState:r?()=>r:void 0}},[i,r]),a=T.useMemo(()=>i.getState(),[i]);ZE(()=>{const{subscription:s}=o;return s.onStateChange=s.notifyNestedSubs,s.trySubscribe(),a!==i.getState()&&s.notifyNestedSubs(),()=>{s.tryUnsubscribe(),s.onStateChange=void 0}},[o,a]);const l=n||ar;return T.createElement(l.Provider,{value:o},t)}var tk=ek;function Ip(e=ar){return function(){return T.useContext(e)}}var zy=Ip();function Ny(e=ar){const t=e===ar?zy:Ip(e),n=()=>{const{store:r}=t();return r};return Object.assign(n,{withTypes:()=>n}),n}var nk=Ny();function rk(e=ar){const t=e===ar?nk:Ny(e),n=()=>t().dispatch;return Object.assign(n,{withTypes:()=>n}),n}var Oi=rk(),ik=(e,t)=>e===t;function ok(e=ar){const t=e===ar?zy:Ip(e),n=(r,i={})=>{const{equalityFn:o=ik}=typeof i=="function"?{equalityFn:i}:i,a=t(),{store:l,subscription:s,getServerState:u}=a;T.useRef(!0);const c=T.useCallback({[r.name](g){return r(g)}}[r.name],[r]),d=HE.useSyncExternalStoreWithSelector(s.addNestedSub,l.getState,u||l.getState,c,o);return T.useDebugValue(d),d};return Object.assign(n,{withTypes:()=>n}),n}var Sn=ok();const ak=E(Be)`
      display: flex;
    align-items: center;
    align-content: center;
    justify-content: center;
...
`,ck=({onClick:e})=>{const t=Sn(n=>n.cart.items.length);return m.jsx(ak,{to:"/cart",children:m.jsxs(lk,{onClick:e,children:[m.jsx(sk,{children:m.jsx("use",{href:`${qt}#icon-cart`})}),t>0&&m.jsx(uk,{children:t})]})})},dk=E.nav`
  display: flex;
  gap: 20px;
...
`,fk=()=>m.jsxs(dk,{children:[m.jsx(ka,{to:"/",children:"Головна"}),m.jsx(ka,{to:"/about",children:"Про нас"}),m.jsx(ka,{to:"/catalog",children:"Каталог"}),m.jsx(ka,{to:"/contacts",children:"Контакти"})]}),pk=E.svg`
  width: 24px;
  height: 24px;
  fill: var(--white-color);
`,hk=E(Be)`
...
`,gk=E.div`
  ...
  font-weight: 600;
  box-shadow: 0 0 1px rgba(0,0,0,0.3);
`,vk=({onClick:e})=>{const t=Sn(n=>n.favorites.items.length);return m.jsx(hk,{to:"/favorite",children:m.jsxs(mk,{onClick:e,children:[m.jsx(pk,{children:m.jsx("use",{href:`${qt}#icon-heart`})}),t>0&&m.jsx(gk,{children:t})]})})};/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xk=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(t,n,r)=>r?r.toUpperCase():n.toLowerCase());/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qm=e=>{const t=xk(e);return t.charAt(0).toUpperCase()+t.slice(1)};/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wk=e=>{for(const t in e)if(t.startsWith("aria-")||t==="role"||t==="title")return!0;return!1};/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Sk=T.forwardRef(({color:e="currentColor",size:t=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:i="",children:o,iconNode:a,...l},s)=>T.createElement("svg",{ref:s,...bk,width:t,height:t,stroke:e,strokeWidth:r?Number(n)*24/Number(t):n,className:By("lucide",i),...!o&&!wk(l)&&{"aria-hidden":"true"},...l},[...a.map(([u,c])=>T.createElement(u,c)),...Array.isArray(o)?o:[o]]));/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ln=(e,t)=>{const n=T.forwardRef(({className:r,...i},o)=>T.createElement(Sk,{ref:o,iconNode:t,className:By(`lucide-${yk(Qm(e))}`,`lucide-${e}`,r),...i}));return n.displayName=Qm(e),n};/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _k=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]],Ck=ln("arrow-right",_k);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ek=[["path",{d:"M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5",key:"mvr1a0"}]],Vy=ln("heart",Ek);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kk=[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8",key:"5wwlr5"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-6a2 2 0 0 1 2.582 0l7 6A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"r6nss1"}]],Tk=ln("house",kk);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ok=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]],Pk=ln("info",Ok);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jk=[["path",{d:"m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7",key:"132q7q"}],["rect",{x:"2",y:"4",width:"20",height:"16",rx:"2",key:"izxlao"}]],Mk=ln("mail",jk);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ik=[["path",{d:"M16 10a4 4 0 0 1-8 0",key:"1ltviw"}],["path",{d:"M3.103 6.034h17.794",key:"awc11p"}],["path",{d:"M3.4 5.467a2 2 0 0 0-.4 1.2V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.667a2 2 0 0 0-.4-1.2l-2-2.667A2 2 0 0 0 17 2H7a2 2 0 0 0-1.6.8z",key:"o988cm"}]],$k=ln("shopping-bag",Ik);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dk=[["circle",{cx:"8",cy:"21",r:"1",key:"jimo8o"}],["circle",{cx:"19",cy:"21",r:"1",key:"13723u"}],["path",{d:"M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57l1.65-7.43H5.12",key:"9zh506"}]],$p=ln("shopping-cart",Dk);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Rk=[["path",{d:"M10 5H3",key:"1qgfaw"}],["path",{d:"M12 19H3",key:"yhmn1j"}],["path",{d:"M14 3v4",key:"1sua03"}],["path",{d:"M16 17v4",key:"1q0r14"}],["path",{d:"M21 12h-9",key:"1o4lsq"}],["path",{d:"M21 19h-5",key:"1rlt1p"}],["path",{d:"M21 5h-7",key:"1oszz2"}],["path",{d:"M8 10v4",key:"tgpxqk"}],["path",{d:"M8 12H3",key:"a7s4jb"}]],Hy=ln("sliders-horizontal",Rk);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ak=[["path",{d:"M10 11v6",key:"nco0om"}],["path",{d:"M14 11v6",key:"outv1u"}],["path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6",key:"miytrc"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2",key:"e791ji"}]],Uy=ln("trash-2",Ak);/**
 * @license lucide-react v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Lk=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],Wy=ln("x",Lk),Fk=()=>{const[e,t]=T.useState(!1);return m.jsx(gE,{children:m.jsxs(vE,{children:[m.jsx(wE,{to:"/",children:m.jsx(_E,{src:Xm,alt:"logo"})}),m.jsxs(yE,{children:[m.jsxs(xE,{children:[m.jsx(Bi,{to:"/",children:m.jsx(SE,{src:Xm,alt:"logo"})}),m.jsxs(bE,{children:[m.jsx(ck,{}),m.jsx(vk,{}),m.jsx(fk,{}),m.jsx(EE,{onClick:()=>t(!e),children:m.jsx(CE,{children:m.jsx("use",{href:`${qt}#icon-menu`})})}),m.jsx(jE,{open:e,onClick:()=>t(!1)}),m.jsxs(kE,{open:e,children:[m.jsx(TE,{onClick:()=>t(!1),children:m.jsx(Wy,{size:28,strokeWidth:1.5})}),m.jsxs(OE,{children:[m.jsxs(Bi,{onClick:()=>t(!1),to:"/",children:[m.jsx(Tk,{size:22,strokeWidth:1.5})," Головна"]}),m.jsxs(Bi,{onClick:()=>t(!1),to:"/about",children:[m.jsx(Pk,{size:22,strokeWidth:1.5})," Про нас"]}),m.jsxs(Bi,{onClick:()=>t(!1),to:"/catalog",children:[m.jsx($k,{size:22,strokeWidth:1.5})," Каталог"]}),m.jsxs(Bi,{onClick:()=>t(!1),to:"/contacts",children:[m.jsx(Mk,{size:22,strokeWidth:1.5})," Контакти"]})]}),m.jsx(PE,{children:m.jsx("p",{children:"© 2020 Дідів Хлів"})})]})]})]}),m.jsx(RE,{})]})]})})},zk=E.footer`
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Up=cO,ji=60103,hx=60106;re.Fragment=60107;re.StrictMode=60108;re.Profiler=60114;var mx=60109,gx=60110,vx=60112;re.Suspense=60113;var yx=60115,xx=60116;if(typeof Symbol=="function"&&Symbol.for){var Lt=Symbol.for;ji=Lt("react.element"),hx=Lt("react.portal"),re.Fragment=Lt("react.fragment"),re.StrictMode=Lt("react.strict_mode"),re.Profiler=Lt("react.profiler"),mx=Lt("react.provider"),gx=Lt("react.context"),vx=Lt("react.forward_ref"),re.Suspense=Lt("react.suspense"),yx=Lt("react.memo"),xx=Lt("react.lazy")}var lg=typeof Symbol=="function"&&Symbol.iterator;function dO(e){return e===null||typeof e!="object"?null:(e=lg&&e[lg]||e["@@iterator"],typeof e=="function"?e:null)}function ra(e){for(var t="https://reactjs.org/docs/error-decoder.html?invariant="+e,n=1;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var bx={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},wx={};function Mi(e,t,n){this.props=e,this.context=t,this.refs=wx,this.updater=n||bx}Mi.prototype.isReactComponent={};Mi.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error(ra(85));this.updater.enqueueSetState(this,e,t,"setState")};Mi.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function Sx(){}Sx.prototype=Mi.prototype;function Wp(e,t,n){this.props=e,this.context=t,this.refs=wx,this.updater=n||bx}var Gp=Wp.prototype=new Sx;Gp.constructor=Wp;Up(Gp,Mi.prototype);Gp.isPureReactComponent=!0;var Yp={current:null},_x=Object.prototype.hasOwnProperty,Cx={key:!0,ref:!0,__self:!0,__source:!0};function Ex(e,t,n){var r,i={},o=null,a=null;if(t!=null)for(r in t.ref!==void 0&&(a=t.ref),t.key!==void 0&&(o=""+t.key),t)_x.call(t,r)&&!Cx.hasOwnProperty(r)&&(i[r]=t[r]);var l=arguments.length-2;if(l===1)i.children=n;else if(1<l){for(var s=Array(l),u=0;u<l;u++)s[u]=arguments[u+2];i.children=s}if(e&&e.defaultProps)for(r in l=e.defaultProps,l)i[r]===void 0&&(i[r]=l[r]);return{$$typeof:ji,type:e,key:o,ref:a,props:i,_owner:Yp.current}}function fO(e,t){return{$$typeof:ji,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function qp(e){return typeof e=="object"&&e!==null&&e.$$typeof===ji}function pO(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var ug=/\/+/g;function lc(e,t){return typeof e=="object"&&e!==null&&e.key!=null?pO(""+e.key):t.toString(36)}function us(e,t,n,r,i){var o=typeof e;(o==="undefined"||o==="boolean")&&(e=null);var a=!1;if(e===null)a=!0;else switch(o){case"string":case"number":a=!0;break;case"object":switch(e.$$typeof){case ji:case hx:a=!0}}if(a)return a=e,i=i(a),e=r===""?"."+lc(a,0):r,Array.isArray(i)?(n="",e!=null&&(n=e.replace(ug,"$&/")+"/"),us(i,t,n,"",function(u){return u})):i!=null&&(qp(i)&&(i=fO(i,n+(!i.key||a&&a.key===i.key?"":(""+i.key).replace(ug,"$&/")+"/")+e)),t.push(i)),1;if(a=0,r=r===""?".":r+":",Array.isArray(e))for(var l=0;l<e.length;l++){o=e[l];var s=r+lc(o,l);a+=us(o,t,n,s,i)}else if(s=dO(e),typeof s=="function")for(e=s.call(e),l=0;!(o=e.next()).done;)o=o.value,s=r+lc(o,l++),a+=us(o,t,n,s,i);else if(o==="object")throw t=""+e,Error(ra(31,t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t));return a}function Oa(e,t,n){if(e==null)return e;var r=[],i=0;return us(e,r,"","",function(o){return t.call(n,o,i++)}),r}function hO(e){if(e._status===-1){var t=e._result;t=t(),e._status=0,e._result=t,t.then(function(n){e._status===0&&(n=n.default,e._status=1,e._result=n)},function(n){e._status===0&&(e._status=2,e._result=n)})}if(e._status===1)return e._result;throw e._result}var kx={current:null};function Dn(){var e=kx.current;if(e===null)throw Error(ra(321));return e}var mO={ReactCurrentDispatcher:kx,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:Yp,IsSomeRendererActing:{current:!1},assign:Up};re.Children={map:Oa,forEach:function(e,t,n){Oa(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return Oa(e,function(){t++}),t},toArray:function(e){return Oa(e,function(t){return t})||[]},only:function(e){if(!qp(e))throw Error(ra(143));return e}};re.Component=Mi;re.PureComponent=Wp;re.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=mO;re.cloneElement=function(e,t,n){if(e==null)throw Error(ra(267,e));var r=Up({},e.props),i=e.key,o=e.ref,a=e._owner;if(t!=null){if(t.ref!==void 0&&(o=t.ref,a=Yp.current),t.key!==void 0&&(i=""+t.key),e.type&&e.type.defaultProps)var l=e.type.defaultProps;for(s in t)_x.call(t,s)&&!Cx.hasOwnProperty(s)&&(r[s]=t[s]===void 0&&l!==void 0?l[s]:t[s])}var s=arguments.length-2;if(s===1)r.children=n;else if(1<s){l=Array(s);for(var u=0;u<s;u++)l[u]=arguments[u+2];r.children=l}return{$$typeof:ji,type:e.type,key:i,ref:o,props:r,_owner:a}};re.createContext=function(e,t){return t===void 0&&(t=null),e={$$typeof:gx,_calculateChangedBits:t,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null},e.Provider={$$typeof:mx,_context:e},e.Consumer=e};re.createElement=Ex;re.createFactory=function(e){var t=Ex.bind(null,e);return t.type=e,t};re.createRef=function(){return{current:null}};re.forwardRef=function(e){return{$$typeof:vx,render:e}};re.isValidElement=qp;re.lazy=function(e){return{$$typeof:xx,_payload:{_status:-1,_result:e},_init:hO}};re.memo=function(e,t){return{$$typeof:yx,type:e,compare:t===void 0?null:t}};re.useCallback=function(e,t){return Dn().useCallback(e,t)};re.useContext=function(e,t){return Dn().useContext(e,t)};re.useDebugValue=function(){};re.useEffect=function(e,t){return Dn().useEffect(e,t)};re.useImperativeHandle=function(e,t,n){return Dn().useImperativeHandle(e,t,n)};re.useLayoutEffect=function(e,t){return Dn().useLayoutEffect(e,t)};re.useMemo=function(e,t){return Dn().useMemo(e,t)};re.useReducer=function(e,t,n){return Dn().useReducer(e,t,n)};re.useRef=function(e){return Dn().useRef(e)};re.useState=function(e){return Dn().useState(e)};re.version="17.0.2";px.exports=re;var gO=px.exports;/** @license React v17.0.2
 * react-jsx-runtime.production.min.js
 *
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
...
`,Ar=1340,Lr=100340,Yi=100,Qb=()=>{const[e,t]=T.useState([Ar,Lr]),n=(i,o)=>{const a=o===""?"":Number(o);t(l=>{const s=[...l];return s[i]=a,s})},r=i=>{t(o=>{const a=[...o];return i===0?((a[0]===""||a[0]<Ar)&&(a[0]=Ar),a[0]>o[1]-Yi&&(a[0]=o[1]-Yi)):((a[1]===""||a[1]>Lr)&&(a[1]=Lr),a[1]<o[0]+Yi&&(a[1]=o[0]+Yi)),a})};return m.jsxs(YM,{children:[m.jsxs(qM,{children:[m.jsx(Kg,{type:"number",value:e[0],min:Ar,max:e[1],onChange:i=>n(0,i.target.value),onBlur:()=>r(0)}),m.jsx(Kg,{type:"number",value:e[1],min:e[0],max:Lr,onChange:i=>n(1,i.target.value),onBlur:()=>r(1)})]}),m.jsx(gf.Range,{values:e,step:Yi,min:Ar,max:Lr,onChange:i=>t(i),renderTrack:({props:i,children:o})=>m.jsx(XM,{...i,background:gf.getTrackBackground({values:e,colors:["#ddd","#85683d","#ddd"],min:Ar,max:Lr}),children:o}),renderThumb:({props:i})=>m.jsx(KM,{...i})})]})},QM=({category:e,selectedFilters:t,setSelectedFilters:n})=>{const r=Kb[e]||[],[i,o]=T.useState({}),a=c=>{o(d=>({...d,[c]:!d[c]}))},l=(c,d)=>{n(g=>{const h=g[c]||[];return h.includes(d)?{...g,[c]:h.filter(v=>v!==d)}:{...g,[c]:[...h,d]}})},s=Object.values(t).some(c=>Array.isArray(c)&&c.length>0),u=()=>{s&&n({})};return console.log(s),m.jsxs(MM,{children:[m.jsxs(IM,{children:["Фільтри ",m.jsx(Hy,{size:20})]}),(r||[]).map(c=>{var g;const d=!!i[c.name];return m.jsxs($M,{children:[m.jsxs(DM,{onClick:()=>a(c.name),children:[m.jsx(RM,{children:c.label}),m.jsx(AM,{isOpen:d})]}),m.jsxs(LM,{isOpen:d,children:[c.type==="checkbox"&&((g=c.options)==null?void 0:g.map(h=>{var v;return m.jsxs(FM,{children:[m.jsx(mf,{checked:((v=t[c.name])==null?void 0:v.includes(h))||!1,onChange:()=>l(c.name,h)}),m.jsx(zM,{}),h]},h)})),c.type==="range"&&m.jsx(Qb,{})]})]},c.name)}),m.jsx(Xb,{onClick:u,disabled:!s,children:"Скинути обрані фільтри"})]})},ZM=E.aside`
  width: 100%;
  max-width: 400px;
  background: #ffffff;
  padding: 20px;
...
`,aI=({category:e,selectedFilters:t,setSelectedFilters:n})=>{const r=Kb[e]||[],[i,o]=T.useState({}),a=s=>{o(u=>({...u,[s]:!u[s]}))},l=(s,u)=>{n(c=>{const d=c[s]||[];return d.includes(u)?{...c,[s]:d.filter(g=>g!==u)}:{...c,[s]:[...d,u]}})};return m.jsx(ZM,{children:(r||[]).map(s=>{var c;const u=!!i[s.name];return m.jsxs(JM,{children:[m.jsxs(eI,{onClick:()=>a(s.name),children:[m.jsx(tI,{children:s.label}),m.jsx(nI,{isOpen:u})]}),m.jsxs(rI,{isOpen:u,children:[s.type==="checkbox"&&((c=s.options)==null?void 0:c.map(d=>{var g;return m.jsxs(iI,{children:[m.jsx(vf,{checked:((g=t[s.name])==null?void 0:g.includes(d))||!1,onChange:()=>l(s.name,d)}),m.jsx(oI,{}),d]},d)})),s.type==="range"&&m.jsx(Qb,{})]})]},s.name)})})};E.div``;const sI=E.div`
  flex: 1;
  display: grid;
  grid-template-columns: repeat(3, 1fr);
  align-items: start;
