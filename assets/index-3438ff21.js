...
`,ID=E.span`
  ...
  white-space: nowrap;
`,QS=rw({name:"favorites",initialState:{items:[]},reducers:{toggleFavorite:(e,t)=>{const n=t.payload;e.items.find(i=>i.id===n.id)?e.items=e.items.filter(i=>i.id!==n.id):e.items.push(n)},clearFavorite:e=>{e.items=[]}}}),{toggleFavorite:yo,clearFavorite:DD}=QS.actions,LD=QS.reducer,AD=({setValues:e,category:t,selectedFilters:n={},priceRange:r,sortType:i,setIsSortOpen:o,isSortOpen:a,setSortType:l,sortOrder:s,setSortOrder:u})=>{const[d,c]=b.useState([]),[y,p]=b.useState(!0),[m,v]=b.useState(1),w=24;let h=d;const g=b.useRef(null);b.useEffect(()=>{const O=R=>{g.current&&!g.current.contains(R.target)&&o(!1)};return document.addEventListener("mousedown",O),()=>{document.removeEventListener("mousedown",O)}},[o]),b.useEffect(()=>{(async()=>{try{p(!0);const A=await(await fetch(`https://backenddidiv-production.up.railway.app/api/products?populate=*&filters[category][title][$eq]=${encodeURIComponent(t)}&pagination[pageSize]=500`)).json();c(A.data);const F=A.data.map(j=>j.price);if(F.length>0){let j=Math.min(...F),P=Math.max(...F);e([j,P])}}catch(R){console.error("Error fetching products:",R)}finally{p(!1)}})()},[t,e]),b.useEffect(()=>{v(1)},[t,n,r]),b.useEffect(()=>{window.scrollTo({top:0,behavior:"smooth"})},[m]);const x=On(),S=jn(),T=st(O=>O.favorites.items),k=st(O=>O.cart.items),C=(O,R)=>{R.stopPropagation();const A=T.some(F=>F.id===O.id);S(yo(O)),A?K.warning(`${O.name} видалено з обраного`):K.info(`${O.name} додано в обране`)};if(Object.keys(n).forEach(O=>{const R=n[O];Array.isArray(R)&&R.length>0&&(h=h.filter(A=>{var j;const F=(j=A.attributes)==null?void 0:j.find(P=>P.label.toLowerCase()===O.toLowerCase());return F&&R.includes(F.value)}))}),r&&r.length===2){const[O,R]=r;console.log(O,R)}const _=b.useMemo(()=>{const O=[...h];switch(i){case"name":return O.sort((R,A)=>s==="asc"?R.name.localeCompare(A.name):A.name.localeCompare(R.name));case"price":return O.sort((R,A)=>s==="asc"?R.price-A.price:A.price-R.price);case"date":return O.sort((R,A)=>s==="asc"?new Date(R.createdAt)-new Date(A.createdAt):new Date(A.createdAt)-new Date(R.createdAt));default:return O}},[i,h,s]),$=m*w,M=$-w,L=_.slice(M,$),D=Math.ceil(h.length/w);return y?f.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:f.jsx(qa,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):(console.log(L),console.log("filteredProducts.length:",h.length),console.log("currentProducts.length:",L.length),f.jsxs(mD,{children:[f.jsxs(gD,{children:[f.jsx(vD,{children:t}),f.jsxs(kD,{ref:g,children:[f.jsxs(TD,{onClick:()=>o(O=>!O),children:["Сортування",f.jsx(Pu,{strokeWidth:.9,size:22})]}),a&&f.jsxs(PD,{children:[f.jsx(hi,{onClick:()=>{l("name"),u("asc"),o(!1)},children:"А-Я"}),f.jsx(hi,{onClick:()=>{l("name"),u("desc"),o(!1)},children:"Я-А"}),f.jsx(hi,{onClick:()=>{l("price"),u("asc"),o(!1)},children:"Ціна ↑"}),f.jsx(hi,{onClick:()=>{l("price"),u("desc"),o(!1)},children:"Ціна ↓"}),f.jsx(hi,{onClick:()=>{l("date"),u("desc"),o(!1)},children:"Спочатку новіші"}),f.jsx(hi,{onClick:()=>{l("date"),u("asc"),o(!1)},children:"Спочатку старіші"})]})]})]}),f.jsx(Or,{autoClose:1500}),h.length===0?f.jsx(yD,{children:f.jsx("p",{style:{textAlign:"center",fontSize:"30px",marginTop:"50px",marginLeft:"auto",marginRight:"auto"},children:"Нічого не знайдено 😢"})}):f.jsx(xD,{children:L.map(O=>{var N,U;const R=T.some(H=>H.id===O.id),A=k.find(H=>H.id===O.id),j=(A?A.quantity:0)>=(O.stock||0),P=O.new_price&&O.new_price<O.price,I=P?O.new_price:O.price,z=P?Math.round((O.price-O.new_price)/O.price*100):0,B=(H,q)=>{if(q.stopPropagation(),j){K.error("Товар уже у кошику");return}S(po({...H,quantity:1})),K.success(`${H.name} додано в кошик!`)};return f.jsxs(bD,{onClick:()=>x(`/product/${O.id}`),style:{cursor:"pointer"},children:[f.jsx(wD,{src:((U=(N=O.images)==null?void 0:N[0])==null?void 0:U.url)||"/placeholder.jpg",alt:O.name,onError:H=>{H.currentTarget.onerror=null,H.currentTarget.src=to}}),f.jsx(_D,{children:O.name}),f.jsxs(SD,{children:[f.jsx(OD,{children:f.jsxs(jD,{children:[f.jsxs(MD,{$discount:P,children:[(I*(O.quantity||1)).toLocaleString()," грн"]}),P&&f.jsxs(f.Fragment,{children:[f.jsxs($D,{children:[(O.price*(O.quantity||1)).toLocaleString()," грн"]}),f.jsxs(ID,{children:["-",z,"%"]})]})]})}),f.jsxs(CD,{children:[f.jsx(Pv,{onClick:H=>B(O,H),children:f.jsx(fo,{size:24,color:A?"var(--orange-color)":"black",strokeWidth:2})}),f.jsx(Pv,{onClick:H=>C(O,H),children:f.jsx(ju,{size:24,fill:R?"#ff4d4f":"none",color:R?"#ff4d4f":"#000000",strokeWidth:R?1:2})})]})]})]},O.id)})}),h.length>w&&f.jsxs(ED,{children:[f.jsx(Pd,{onClick:()=>v(O=>Math.max(O-1,1)),disabled:m===1,children:"Назад"}),Array.from({length:D},(O,R)=>f.jsx(Pd,{onClick:()=>v(R+1),active:m===R+1,children:R+1},R)),f.jsx(Pd,{onClick:()=>v(O=>Math.min(O+1,D)),disabled:m===D,children:"Вперед"})]})]}))},RD=()=>{const[e,t]=b.useState({});console.log(e);const{category:n}=oy(),[r,i]=b.useState(!1),[o,a]=b.useState(!1),[l,s]=b.useState("date"),[u,d]=b.useState("desc"),[c,y]=b.useState([]),[p,m]=b.useState([0,0]);console.log(c),console.log(n);const v=Object.values(e).some(h=>Array.isArray(h)&&h.length>0),w=()=>{v&&t({})};return f.jsxs(TI,{children:[f.jsxs(kI,{children:[f.jsxs(PI,{children:[f.jsxs(OI,{onClick:()=>i(!0),children:["Фільтр",f.jsx(jI,{children:f.jsx("use",{href:`${cn}#icon-filter`})})]}),f.jsxs(RI,{children:[f.jsxs(MI,{onClick:()=>a(h=>!h),children:["Сортування",f.jsx(Pu,{strokeWidth:.9,size:22})]}),o&&f.jsxs(FI,{children:[f.jsx(pi,{onClick:()=>{s("name"),d("asc"),a(!1)},children:"А-Я"}),f.jsx(pi,{onClick:()=>{s("name"),d("desc"),a(!1)},children:"Я-А"}),f.jsx(pi,{onClick:()=>{s("price"),d("asc"),a(!1)},children:"Ціна ↑"}),f.jsx(pi,{onClick:()=>{s("price"),d("desc"),a(!1)},children:"Ціна ↓"}),f.jsx(pi,{onClick:()=>{s("date"),d("desc"),a(!1)},children:"Спочатку новіші"}),f.jsx(pi,{onClick:()=>{s("date"),d("asc"),a(!1)},children:"Спочатку старіші"})]})]})]}),f.jsx(oD,{category:n,selectedFilters:e,setSelectedFilters:t,childValues:c,priceRange:p,setPriceRange:m}),f.jsx(AD,{priceRange:p,values:c,setValues:y,category:n,selectedFilters:e,sortType:l,setIsSortOpen:a,isSortOpen:o,setSortType:s,sortOrder:u,setSortOrder:d}),r&&f.jsx($I,{onClick:()=>i(!1),open:r,children:f.jsxs(II,{onClick:h=>h.stopPropagation(),open:r,children:[f.jsxs(DI,{children:[f.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[f.jsx(Bb,{size:20}),f.jsx("h2",{children:"Фільтри"})]}),f.jsx(Ub,{size:24,onClick:()=>i(!1),style:{cursor:"pointer"}})]}),f.jsx(hD,{childValues:c,category:n,selectedFilters:e,setSelectedFilters:t,priceRange:p,setPriceRange:m}),f.jsxs(LI,{children:[f.jsx(XS,{onClick:w,disabled:!v,children:"Скинути обрані фільтри"}),f.jsx(AI,{onClick:()=>i(!1),children:"Показати результати"})]})]})})]})," "]})},Ov=E.div`
  width: 100%;
  max-width: 750px;
  margin: 0 auto;
  padding: 20px;
...
`,e1=({productId:e,questions:t})=>{const[n,r]=b.useState(""),[i,o]=b.useState(""),a=async l=>{l.preventDefault();const u=await fetch("https://backenddidiv-production.up.railway.app/api/questions",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({data:{question:n,userName:i,product:e}})});console.log(e),u.ok&&(K.success("Запитання надіслано! Воно з’явиться після модерації."),r(""),o(""))};return f.jsxs(R6,{children:[f.jsx(Or,{autoClose:1500}),f.jsxs(F6,{onSubmit:a,children:[f.jsx(z6,{placeholder:"Ваше ім'я",value:i,onChange:l=>o(l.target.value),required:!0}),f.jsx(N6,{placeholder:"Запитайте нас про цей товар...",value:n,onChange:l=>r(l.target.value),required:!0}),f.jsx(B6,{children:"Надіслати запитання"})]}),f.jsx(V6,{children:t&&t.length>0?t.map(l=>l.answer?f.jsxs(U6,{children:[f.jsxs(H6,{children:[f.jsx(W6,{children:l.userName||"Гість"}),f.jsx(G6,{children:new Date(l.createdAt).toLocaleDateString()})]}),f.jsx(q6,{children:l.question}),f.jsxs(Y6,{children:[f.jsx(X6,{children:"Адміністратор"}),f.jsx("p",{children:l.answer})]})]},l.id):null):f.jsx("p",{style:{textAlign:"center",color:"#999"},children:"Запитань поки немає. Будьте першим!"})})]})},K6=()=>{var A,F;const{id:e}=oy(),[t,n]=b.useState([]),[r,i]=b.useState(1),[o,a]=b.useState("description"),[l,s]=b.useState(null),[u,d]=b.useState(!1),[c,y]=b.useState(0);console.log("products",t);const[p,m]=b.useState(!0),v=t.find(j=>j.id===Number(e)),w=v?Jv().diff(Jv(v.createdAt),"day")<7:!1,g=(j=>{const[P,I]=b.useState(!1);return b.useEffect(()=>{const z=window.matchMedia(j),B=()=>I(z.matches);return B(),z.addEventListener("change",B),()=>z.removeEventListener("change",B)},[j]),P})("(min-width: 768px)"),x=st(j=>j.cart.items),S=v?x.find(j=>j.id===v.id):null,T=(S==null?void 0:S.quantity)||0;b.useEffect(()=>{(async()=>{try{m(!0);const I=await(await fetch(`https://backenddidiv-production.up.railway.app/api/products?filters[id][$eq]=${e}&populate=*`)).json();n(I.data)}catch(P){console.error("Error fetching products:",P)}finally{m(!1)}})()},[e]),console.log(v),b.useEffect(()=>{var j,P;v&&v.images&&s((P=(j=v.images)==null?void 0:j[0])==null?void 0:P.url)},[v]);const k=((v==null?void 0:v.images)??[]).map(j=>({src:j.url})),C=()=>{const j=v.images.findIndex(P=>P.url===l);y(j>=0?j:0),d(!0)},_=jn(),M=st(j=>j.favorites.items).some(j=>j.id===(v==null?void 0:v.id)),L=()=>{if(T>=v.stock){K.warning("Товар вже в кошику (досягнуто максимум)");return}if(T+r>v.stock){K.warning(`Доступно лише ${v.stock} шт.`);return}_(po({...v,quantity:r})),K.success(`${v.name} додано в кошик!`)},D=(j,P)=>{P.stopPropagation(),_(yo(j)),M?K.warning(`${j.name} видалено з обраного`):K.info(`${j.name} додано в обране`)},O=(v==null?void 0:v.new_price)&&(v==null?void 0:v.new_price)<v.price,R=O?Math.round((v.price-v.new_price)/v.price*100):0;return p?f.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",width:"100vw",height:"100vh"},children:f.jsx(qa,{height:100,width:100,radius:5,color:"var(--orange-color)",ariaLabel:"ball-triangle-loading",wrapperStyle:{},wrapperClass:"",visible:!0})}):v?f.jsxs(Ov,{children:[" ",f.jsx(Or,{autoClose:1500}),f.jsxs(FD,{children:[f.jsx(Oe,{to:"/",children:"Головна"})," / ",f.jsx(Oe,{to:"/catalog",children:"Каталог"})," /"," ",v.name]}),f.jsxs(zD,{children:[f.jsxs(ND,{children:[f.jsx(BD,{src:l,alt:v.name,onClick:C}),f.jsx(VD,{children:(v.images??[]).map(j=>{const P=j.url;return f.jsx(UD,{src:P,onClick:()=>s(P),style:{cursor:"pointer",opacity:l===P?1:.4}},j.id)})})]}),f.jsx(y6,{open:u,close:()=>d(!1),index:c,slides:k,controller:{closeOnBackdropClick:!0},on:{view:({index:j})=>{var P,I;y(j),(I=(P=v==null?void 0:v.images)==null?void 0:P[j])!=null&&I.url&&s(v.images[j].url)}},plugins:[L6],zoom:{maxZoomPixelRatio:3,zoomInMultiplier:2,doubleTapDelay:300,doubleClickDelay:300,doubleClickEnabled:!0,pinchZoomDistanceFactor:100,scrollToZoom:!0}}),f.jsxs(HD,{children:[f.jsx(WD,{children:v.name}),f.jsx(GD,{children:w&&f.jsx(qD,{children:"● Новий товар"})}),f.jsxs(YD,{children:[f.jsx(XD,{children:O?f.jsxs(f.Fragment,{children:[f.jsxs(jv,{$discount:!0,children:[v.new_price.toLocaleString()," грн"]}),f.jsxs(KD,{children:[v.price.toLocaleString()," грн"]}),f.jsxs(QD,{children:["-",R,"%"]})]}):f.jsxs(jv,{children:[v.price.toLocaleString()," грн"]})}),f.jsxs(ZD,{children:[f.jsxs(JD,{children:[f.jsx("button",{onClick:()=>i(Math.max(1,r-1)),children:"-"}),f.jsx("span",{children:r}),f.jsxs(aL,{$active:r>=v.stock,children:[f.jsx("button",{onClick:()=>i(Math.min(v.stock,r+1)),disabled:r>=v.stock,children:"+"}),f.jsxs(ZS,{children:["Максимум: ",v.stock]})]})]}),f.jsxs(eL,{onClick:L,children:[" ",f.jsx(fo,{size:25}),f.jsx("span",{children:"В КОШИК"})]}),f.jsxs(iL,{$active:M,onClick:j=>D(v,j),children:[f.jsxs(oL,{$active:M,children:[" ",f.jsx("use",{href:`${cn}#icon-heart`})]}),f.jsx("span",{children:"В ОБРАНЕ"})]})]})]}),f.jsxs(nL,{children:[f.jsxs("p",{children:[f.jsx("strong",{children:"Ваше місто:"})," Київ"]}),f.jsx("p",{children:"🚚 Доставка по Україні (Розрахувати вартість)"})]})]})]}),!g&&f.jsxs(Iv,{children:[f.jsxs(Dv,{children:[f.jsx(Ro,{active:o==="description",onClick:()=>a("description"),children:"Опис"}),f.jsx(Ro,{active:o==="attributes",onClick:()=>a("attributes"),children:"Характеристики"}),f.jsx(Ro,{active:o==="FAQ",onClick:()=>a("FAQ"),children:"Питання та відповіді"})]}),f.jsxs(Lv,{children:[o==="description"&&f.jsx(Av,{children:v.description}),o==="attributes"&&f.jsx(Mv,{children:(A=v.attributes)!=null&&A.length?v.attributes.map(j=>f.jsxs($v,{children:[f.jsx("span",{children:j.label}),f.jsx("b",{children:j.value})]},j.id)):f.jsx("p",{children:"Характеристики відсутні"})}),o==="FAQ"&&f.jsx(e1,{productId:v.documentId,questions:v.questions})]})]}),g&&f.jsxs(rL,{children:[f.jsxs(Iv,{children:[f.jsxs(Dv,{children:[f.jsx(Ro,{active:o==="description",onClick:()=>a("description"),children:"Опис"}),f.jsx(Ro,{active:o==="FAQ",onClick:()=>a("FAQ"),children:"Питання та відповіді"})]}),f.jsxs(Lv,{children:[o==="description"&&f.jsx(Av,{children:v.description}),o==="FAQ"&&f.jsx(e1,{productId:v.documentId,questions:v.questions})]})]}),f.jsxs(Mv,{children:[f.jsx(tL,{children:" Характеристики"}),(F=v.attributes)!=null&&F.length?v.attributes.map(j=>f.jsxs($v,{children:[f.jsx("span",{children:j.label}),f.jsx("b",{children:j.value})]},j.id)):f.jsx("p",{children:"Характеристики відсутні"})]})]})]}):f.jsx(Ov,{children:"Товар не знайдено"})},Q6=E.div`
  font-family: var(--main-font);
  width: 100%;
  max-width: 750px;
  padding: 10px;
...
`;E.button`
`;const $z=({options:e,value:t,onChange:n,error:r})=>{const i=e.find(o=>o.value===t)||null;return f.jsxs("div",{style:{marginBottom:"20px"},children:[f.jsx("label",{style:{display:"block",marginBottom:"8px"},children:"Спосіб оплати"}),f.jsx(wc,{options:e,value:i,onChange:o=>n(o==null?void 0:o.value),placeholder:"Оберіть спосіб оплати",styles:{control:o=>({...o,borderColor:r?"red":o.borderColor})}}),r&&f.jsx("span",{style:{color:"red",fontSize:"12px"},children:"Оберіть спосіб оплати"})]})},Kd={}.VITE_NP_API_KEY,D1="https://api.novaposhta.ua/v2.0/json/",Iz=()=>{const e=st(F=>F.cart.items),t=On(),n=jn();console.log("апі",Kd);const[r,i]=b.useState({fullName:"",phone:"+38 (0",email:"",city:"",postOffice:""}),[o,a]=b.useState(""),[l,s]=b.useState(null),[u,d]=b.useState(null),[c,y]=b.useState(null),[p,m]=b.useState(null),[v,w]=b.useState([]),[h,g]=b.useState([]),[x,S]=b.useState(null),T=e.reduce((F,j)=>F+(j.new_price??j.price)*j.quantity,0),k=e.reduce((F,j)=>F+j.quantity,0),_=(()=>{const F=new Date().getFullYear().toString().slice(-2),j=Date.now().toString().slice(-4),P=Math.floor(100+Math.random()*900);return`${F}${j}${P}`})();console.log(_),b.useEffect(()=>{if(o.length<2)return;const F=setTimeout(async()=>{const P=await(await fetch(D1,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:Kd,modelName:"Address",calledMethod:"getCities",methodProperties:{FindByString:o}})})).json();w(P.data.map(I=>({value:I.Ref,label:I.Description})))},500);return()=>clearTimeout(F)},[o]),b.useEffect(()=>{if(!l||u!=="nova")return;(async()=>{const P=await(await fetch(D1,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({apiKey:Kd,modelName:"AddressGeneral",calledMethod:"getWarehouses",methodProperties:{CityRef:l.value}})})).json();g(P.data.map(I=>({value:I.Ref,label:I.Description})))})()},[l,u]);const $=F=>{s(F),i(j=>({...j,city:(F==null?void 0:F.label)||"",postOffice:""})),d(null),y(null),m(null)},M=()=>{const F={};return r.fullName.trim().split(" ").length<2&&(F.fullName="Введіть прізвище та ім'я"),/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r.email)||(F.email="Некоректний email"),r.phone.replace(/\D/g,"").length<12&&(F.phone="Номер неповний"),l||(F.city=!0),u==="nova"&&!c&&(F.postOffice=!0),u==="ukr"&&!p&&(F.postOffice=!0),u||(F.delivery=!0),x||(F.payment=!0),F},L=b.useMemo(M,[r,u,c,p,l,x]),D=Object.keys(L).length===0&&e.length>0,O=async F=>{if(F.preventDefault(),!x){alert("Оберіть спосіб оплати");return}try{if(await fetch("https://backenddidiv-production.up.railway.app/api/orders",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({data:{name:r.fullName,phone:r.phone,email:r.email,city:r.city,products:e==null?void 0:e.map(P=>({id:P.id,name:P.name,quantity:P.quantity,price:P.new_price??P.price})),status_order:"pending",order_number:_,payment_method:x==="liqpay"?"Онлайн (LiqPay)":x==="cod"?"Післяплата":x==="bank_transfer"?"Оплата за реквізитами":"",delivery_method:u==="nova"?"Нова Пошта":u==="ukr"?"УкрПошта":"Самовивіз",delivery_address:u==="nova"?c==null?void 0:c.label:u==="ukr"?p:"Самовивіз"}})}),x==="liqpay"){const P=await fetch("https://backenddidiv-production.up.railway.app/api/liqpay/create",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({amount:T,order_number:_})}),{data:I,signature:z}=await P.json(),B=document.createElement("form");B.method="POST",B.action="https://www.liqpay.ua/api/3/checkout",B.innerHTML=`
        <input type="hidden" name="data" value="${I}" />
        <input type="hidden" name="signature" value="${z}" />
      `,document.body.appendChild(B),B.requestSubmit();return}const j={...r,name:r.fullName,city:l.label,deliveryMethod:u==="nova"?"Нова Пошта":u==="ukr"?"УкрПошта":"Самовивіз",address:u==="nova"?c==null?void 0:c.label:u==="ukr"?p:"Самовивіз",products:e==null?void 0:e.map(P=>({id:P.id,name:P.name,quantity:P.quantity,price:P.new_price??P.price})),total:T,order_number:_,delivery_address:u==="nova"?c==null?void 0:c.label:u==="ukr"?p:"Самовивіз",payment_method:x==="liqpay"?"Онлайн (LiqPay)":x==="cod"?"Післяплата":x==="bank_transfer"?"Оплата за реквізитами":""};n(Jh()),t("/order-confirmation",{state:{order:j}})}catch(j){console.error(j),alert("Помилка оформлення")}},R=b.useMemo(()=>[{value:"nova",label:"Нова пошта"},{value:"ukr",label:"Укрпошта"}],[]),A=[{value:"liqpay",label:"Онлайн оплата (LiqPay)"},{value:"cod",label:"Післяплата"},{value:"bank_transfer",label:"Оплата за реквізитами"}];return f.jsx(Oz,{children:f.jsxs(jz,{children:[f.jsxs(Mz,{children:[f.jsx(Pz,{formData:r,setFormData:i,errors:L}),f.jsx(GF,{cityOptions:v,selectedCity:l,onChange:$,onInputChange:a}),f.jsx(XF,{options:R,value:u,onChange:d,selectedCity:l}),f.jsx(KF,{deliveryMethod:u,officeOptions:h,selectedOffice:c,selectedUkrOffice:p,setSelectedOffice:y,setSelectedUkrOffice:m}),f.jsx($z,{options:A,value:x,onChange:S,error:L.payment})]}),f.jsx(lz,{cartItems:e,totalAmount:T,totalQuantity:k,isFormValid:D,handleSubmit:O})]})})},Dz=E.div`
font-family: var(--main-font);
  max-width: 800px;
  margin: 40px auto;
  padding: 40px 20px;
